  ...
  real trunc_mean_mean;              // truncation mean of mean
  real trunc_mean_sd;                // truncation sd of mean
  real trunc_sd_mean;                // truncation mean of sd
  real trunc_sd_sd;                  // truncation sd of sd
  int max_truncation;                // maximum truncation supported
