...
knitr::include_graphics(here::here(file.path(summary_path, "infections_plot.png")))
```
...
```{r, fig.height = 12, fig.width = 8, layout="l-body-outset", out.width = "90%"}
knitr::include_graphics(here::here(file.path(summary_path, "reported_cases_plot.png")))
```
