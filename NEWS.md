...
- Added an option to compute growth rates using an estimator by Parag et al. based on total infectiousness rather than new infections, see `growth_method` argument in rt_opts().
