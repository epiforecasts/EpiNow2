...
* Growth rates are now calculated directly from the infection trajectory as `log I(t) - log I(t - 1)`. Origionally by @seabbs in #213, finishied by @sbfnk in # and reviewed by.
