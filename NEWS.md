...
- Updated the early dynamics calculation to use the full linear model if available. Also changd the prior for initial infections to be approximately Poisson. By @sbfnk in #903 and reviewed by @seabbs and @SamuelBrand1 
