...
- Added tests for input checks, helpers and plot methods of `estimate_secondary()`, `estimate_dist()`, `simulate_infections()`, `forecast_infections()` and the data preprocessing functions.
