...
- `update_Rt()` is now implemented in C++ with a hand-written gradient, which makes its gradient about 1.7 times faster than the rewritten Stan version with a non-stationary Gaussian process.
