...
- Centred the breakpoint random walk over the observation window, removing the `(R0, drift)` ridge in the joint posterior alongside the equivalent fix for the non-stationary Gaussian process.
