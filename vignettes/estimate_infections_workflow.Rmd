...
The _EpiNow2_ package contains functionality for estimating delay distributions from observed delays in the `estimate_delays()` function, which is a wrapper around the [primarycensored](https://primarycensored.epinowcast.org/index.html) R package.
