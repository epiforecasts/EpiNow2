...
#> ℹ Converting using a crude and very approximate method that is likely to produce biased
#>   results.
...
#> DEBUG [2024-09-20 13:57:07] estimate_infections: Running in exact mode for 2000 samples (across 4 chains each with a warm up of 250 iterations each) and 147 time steps of which 7 are a forecast
