...
Table: Summary of overall performance out-of-sample by model
...
Table: Summary of model performance (nowcasting Rt)
...
Table: Summary of model performance (real-time infections forecasting)
