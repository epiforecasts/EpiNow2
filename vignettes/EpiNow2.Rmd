...
Distributions can be supplied in two ways. First, one can supply delay data to `estimate_dist()`, which fits a distribution accounting for censoring and truncation (see `vignette("estimate_dist_workflow")`).
