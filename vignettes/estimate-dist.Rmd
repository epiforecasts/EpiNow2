...
Generation time estimation (infection to infection) typically requires known infection times for both infector and infectee, which often calls for more complex models.
...
For background on how EpiNow2 uses delay distributions internally, including discretisation and primary event censoring, see the [delays vignette](delays.html).
