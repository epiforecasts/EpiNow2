...
Generation time estimation (infection to infection) typically requires known infection times for both infector and infectee, which generally calls for more complex models.
...
A standard deviation of 0.5 on the log scale corresponds to roughly a factor of 1.6 uncertainty in the mean delay (since `exp(0.5) ≈ 1.6`), so the prior covers mean delays from about `5/1.6 ≈ 3` to `5 * 1.6 ≈ 8` days within one standard deviation.
