...
#>         warmup sample
#> chain:1 27.318 27.293
#> chain:2 33.723 19.092
#> chain:3 33.000 24.637
#> chain:4 34.012 29.278
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 17.769 27.696
#> chain:2 19.380 29.024
#> chain:3 17.692 27.595
#> chain:4 19.918 17.429
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 31.085 29.196
#> chain:2 26.708 20.342
#> chain:3 30.118 28.557
#> chain:4 23.809 29.380
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 29.909 21.057
#> chain:2 29.653 24.774
#> chain:3 29.488 20.977
#> chain:4 31.812 23.732
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 36.703 32.994
#> chain:2 36.759 32.855
#> chain:3 33.077 31.571
#> chain:4 38.266 33.406
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.303 15.771
#> chain:2  9.294 15.549
#> chain:3  7.402 16.271
#> chain:4  8.208 15.078
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 32.024 30.729
#> chain:2 38.673 33.334
#> chain:3 31.488 36.023
#> chain:4 33.715 31.673
# summary plot
plot(no_delay)
```
