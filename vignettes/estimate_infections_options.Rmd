...
#>         warmup sample
#> chain:1 23.588 33.357
#> chain:2 31.974 30.019
#> chain:3 33.247 19.243
#> chain:4 32.608 31.040
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 18.148 26.313
#> chain:2 22.781 32.361
#> chain:3 25.797 28.829
#> chain:4 19.938 31.206
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 37.260 19.498
#> chain:2 31.691 31.162
#> chain:3 35.677 22.486
#> chain:4 30.680 18.890
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 28.949 18.158
#> chain:2 28.162 21.281
#> chain:3 31.873 18.080
#> chain:4 25.260 20.474
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 36.002 32.781
#> chain:2 33.189 35.899
#> chain:3 37.420 33.857
#> chain:4 35.770 34.059
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.488  9.134
#> chain:2  9.222 15.859
#> chain:3 12.769 11.489
#> chain:4  8.820 15.642
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 37.143 30.756
#> chain:2 33.966 30.843
#> chain:3 36.808 42.416
#> chain:4 34.503 33.052
# summary plot
plot(no_delay)
```
