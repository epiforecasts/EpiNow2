...
#>         warmup sample
#> chain:1 23.594 32.195
#> chain:2 32.345 30.750
#> chain:3 33.282 19.416
#> chain:4 32.654 30.743
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 17.974 25.880
#> chain:2 22.227 32.639
#> chain:3 25.510 26.794
#> chain:4 19.574 33.028
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 48.172 30.330
#> chain:2 42.140 32.523
#> chain:3 45.167 32.720
#> chain:4 44.344 27.994
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 27.706 26.737
#> chain:2 23.989 26.283
#> chain:3 35.546 25.578
#> chain:4 28.837 23.791
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 36.337 24.118
#> chain:2 37.064 34.977
#> chain:3 34.053 34.631
#> chain:4 36.839 34.066
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  8.038 14.403
#> chain:2 10.241 14.978
#> chain:3  7.203 15.744
#> chain:4 33.711 32.360
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 36.098 24.822
#> chain:2 32.622 35.819
#> chain:3 21.064 30.369
#> chain:4 27.229 30.461
# summary plot
plot(no_delay)
```
