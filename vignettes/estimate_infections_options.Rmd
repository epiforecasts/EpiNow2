...
#>         warmup sample
#> chain:1 28.655 32.443
#> chain:2 32.632 24.314
#> chain:3 31.491 29.217
#> chain:4 28.347 32.054
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 20.544 22.891
#> chain:2 22.857 23.413
#> chain:3 17.898 32.303
#> chain:4 20.025 29.063
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 37.269 32.984
#> chain:2 40.063 27.476
#> chain:3 44.774 28.731
#> chain:4 36.443 23.514
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 29.728 18.356
#> chain:2 28.353 26.123
#> chain:3 32.144 25.135
#> chain:4 24.365 19.835
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 31.693 33.448
#> chain:2 34.874 29.112
#> chain:3 35.808 18.352
#> chain:4 34.844 32.695
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1 21.094  9.544
#> chain:2  6.495 13.665
#> chain:3  7.715 14.021
#> chain:4  7.719 10.902
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 40.354 31.755
#> chain:2 27.949 40.131
#> chain:3 35.600 29.607
#> chain:4 34.565 29.219
# summary plot
plot(no_delay)
```
