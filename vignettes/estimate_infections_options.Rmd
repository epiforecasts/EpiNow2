...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2258 (1392 -- 3684)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.72 -- 1.1)
#> 4:               Rate of growth -0.027 (-0.091 -- 0.035)
#> 5: Doubling/halving time (days)         -25 (20 -- -7.6)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 45.291 11.600
#> chain:2 44.270 19.491
#> chain:3 22.761 16.990
#> chain:4 43.600 10.589
# summary plot
plot(def)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2237 (1354 -- 3714)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.89 (0.71 -- 1.1)
#> 4:               Rate of growth -0.03 (-0.096 -- 0.037)
#> 5: Doubling/halving time (days)        -23 (19 -- -7.2)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 42.256 19.051
#> chain:2 43.924 16.892
#> chain:3 38.819 22.547
#> chain:4 34.964 15.101
# summary plot
plot(agp)
```
...
#>                         measure              estimate
#>                          <char>                <char>
#> 1:       New infections per day   2212 (1347 -- 3626)
#> 2:   Expected change in reports     Likely decreasing
#> 3:   Effective reproduction no.     0.89 (0.7 -- 1.1)
#> 4:               Rate of growth -0.03 (-0.1 -- 0.036)
#> 5: Doubling/halving time (days)      -23 (19 -- -6.8)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 66.551 19.946
#> chain:2 58.765 13.434
#> chain:3 55.826 19.673
#> chain:4 56.138 21.854
# summary plot
plot(dep)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    3615 (2189 -- 6191)
#> 2:   Expected change in reports      Likely increasing
#> 3:   Effective reproduction no.      1.1 (0.84 -- 1.3)
#> 4:               Rate of growth 0.018 (-0.05 -- 0.094)
#> 5: Doubling/halving time (days)        38 (7.3 -- -14)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 40.860 18.557
#> chain:2 44.517 12.329
#> chain:3 40.555 13.639
#> chain:4 39.348 16.493
# summary plot
plot(trunc)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2251 (1380 -- 3620)
#> 2:   Expected change in reports        Likely decreasing
...
#>         warmup sample
#> chain:1 44.044 23.422
#> chain:2 47.413 23.217
#> chain:3 51.150 13.101
#> chain:4 47.704 23.336
# summary plot
plot(project_rt)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day 18767 (10937 -- 34526)
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2314 (1938 -- 2779)
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    2036 (1071 -- 4000)
#> 2:   Expected change in reports      Likely decreasing
#> 3:   Effective reproduction no.     0.85 (0.62 -- 1.2)
#> 4:               Rate of growth -0.042 (-0.11 -- 0.04)
#> 5: Doubling/halving time (days)       -17 (17 -- -6.4)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1 13.442 12.037
#> chain:2 16.945 12.010
#> chain:3 16.079 11.261
#> chain:4 17.039 11.760
# summary plot
plot(rw)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2792 (2404 -- 3296)
#> 2:   Expected change in reports               Decreasing
#> 3:   Effective reproduction no.      0.89 (0.81 -- 0.97)
#> 4:               Rate of growth -0.031 (-0.063 -- 0.001)
#> 5: Doubling/halving time (days)         -22 (690 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 51.339 16.928
#> chain:2 44.689 20.008
#> chain:3 45.209 17.958
#> chain:4 42.393 20.914
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2543 (2501 -- 2585)
#> 2:   Expected change in reports                Decreasing
