...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2217 (1376 -- 3720)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.71 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.097 -- 0.038)
#> 5: Doubling/halving time (days)         -24 (18 -- -7.2)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 33.438 28.107
#> chain:2 30.398 22.867
#> chain:3 29.471 30.419
#> chain:4 29.939 20.437
# summary plot
plot(def)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2244 (1402 -- 3640)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.72 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.092 -- 0.036)
#> 5: Doubling/halving time (days)         -24 (19 -- -7.5)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 23.271 30.821
#> chain:2 22.195 33.581
#> chain:3 24.314 26.810
#> chain:4 24.378 30.179
# summary plot
plot(agp)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2257 (1377 -- 3655)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.71 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.095 -- 0.036)
#> 5: Doubling/halving time (days)         -24 (19 -- -7.3)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 37.605 20.728
#> chain:2 40.448 18.976
#> chain:3 51.204 25.263
#> chain:4 46.206 23.115
# summary plot
plot(dep)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     3631 (2180 -- 6024)
#> 2:   Expected change in reports       Likely increasing
#> 3:   Effective reproduction no.       1.1 (0.84 -- 1.3)
#> 4:               Rate of growth 0.019 (-0.052 -- 0.091)
#> 5: Doubling/halving time (days)         37 (7.7 -- -13)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 31.771 17.770
#> chain:2 31.655 28.438
#> chain:3 29.688 28.369
#> chain:4 29.791 29.815
# summary plot
plot(trunc)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    2246 (1344 -- 3799)
#> 2:   Expected change in reports      Likely decreasing
#> 3:   Effective reproduction no.      0.89 (0.7 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.1 -- 0.047)
#> 5: Doubling/halving time (days)       -24 (15 -- -6.9)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 33.050 34.503
#> chain:2 33.480 34.113
#> chain:3 31.547 34.771
#> chain:4 34.619 32.628
# summary plot
plot(project_rt)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day 18824 (10568 -- 33539)
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2300 (1941 -- 2749)
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2015 (1050 -- 3973)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.       0.85 (0.6 -- 1.2)
#> 4:               Rate of growth -0.041 (-0.11 -- 0.038)
#> 5: Doubling/halving time (days)        -17 (18 -- -6.2)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1  9.125 15.554
#> chain:2  8.118 14.078
#> chain:3  7.776 16.321
#> chain:4  8.279 17.320
# summary plot
plot(rw)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2801 (2416 -- 3280)
#> 2:   Expected change in reports                Decreasing
#> 3:   Effective reproduction no.        0.89 (0.8 -- 0.97)
#> 4:               Rate of growth -0.031 (-0.063 -- 0.0016)
#> 5: Doubling/halving time (days)          -23 (440 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 32.210 29.420
#> chain:2 38.071 28.094
#> chain:3 32.932 31.625
#> chain:4 25.845 28.904
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2543 (2506 -- 2579)
#> 2:   Expected change in reports                Decreasing
