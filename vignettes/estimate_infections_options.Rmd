...
#>                             measure                estimate
#>                              <char>                  <char>
#> 1:           New infections per day     2270 (1020 -- 4688)
#> 2: Expected change in daily reports       Likely decreasing
#> 3:       Effective reproduction no.       0.9 (0.61 -- 1.2)
#> 4:                   Rate of growth -0.029 (-0.14 -- 0.074)
#> 5:     Doubling/halving time (days)       -24 (9.3 -- -4.8)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 47.989 38.844
#> chain:2 26.315 39.191
#> chain:3 42.627 41.773
#> chain:4 34.611 37.219
# summary plot
plot(def)
```
...
#>                             measure               estimate
#>                              <char>                 <char>
#> 1:           New infections per day    2280 (1129 -- 4650)
#> 2: Expected change in daily reports      Likely decreasing
#> 3:       Effective reproduction no.      0.9 (0.64 -- 1.2)
#> 4:                   Rate of growth -0.03 (-0.13 -- 0.075)
#> 5:     Doubling/halving time (days)      -23 (9.3 -- -5.4)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 36.652 35.432
#> chain:2 29.557 37.987
#> chain:3 30.889 38.591
#> chain:4 22.731 45.381
# summary plot
plot(agp)
```
...
#>                             measure                estimate
#>                              <char>                  <char>
#> 1:           New infections per day     2272 (1033 -- 4572)
#> 2: Expected change in daily reports       Likely decreasing
#> 3:       Effective reproduction no.       0.9 (0.61 -- 1.2)
#> 4:                   Rate of growth -0.029 (-0.14 -- 0.069)
#> 5:     Doubling/halving time (days)        -24 (10 -- -4.8)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 47.941 38.544
#> chain:2 45.870 37.815
#> chain:3 46.765 38.715
#> chain:4 40.062 38.381
# summary plot
plot(dep)
```
...
#>                             measure                estimate
#>                              <char>                  <char>
#> 1:           New infections per day      2252 (980 -- 4902)
#> 2: Expected change in daily reports       Likely decreasing
#> 3:       Effective reproduction no.      0.89 (0.59 -- 1.3)
#> 4:                   Rate of growth -0.031 (-0.15 -- 0.084)
#> 5:     Doubling/halving time (days)       -23 (8.2 -- -4.6)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 42.195 40.163
#> chain:2 47.562 37.716
#> chain:3 53.558 35.468
#> chain:4 43.039 39.189
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  8.942 11.087
#> chain:2 10.970 14.426
#> chain:3 10.232 14.532
#> chain:4  9.392 11.796
# summary plot
plot(rw)
```
...
#>                             measure                  estimate
#>                              <char>                    <char>
#> 1:           New infections per day       2772 (2356 -- 3294)
#> 2: Expected change in daily reports                Decreasing
#> 3:       Effective reproduction no.       0.88 (0.78 -- 0.98)
#> 4:                   Rate of growth -0.035 (-0.082 -- 0.0029)
#> 5:     Doubling/halving time (days)         -20 (240 -- -8.5)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 61.617 99.600
#> chain:2 52.303 65.509
#> chain:3 58.237 61.843
#> chain:4 45.061 87.323
# summary plot
plot(no_delay)
```
...
#>                             measure                  estimate
#>                              <char>                    <char>
#> 1:           New infections per day       2548 (2085 -- 3129)
#> 2: Expected change in daily reports                Decreasing
#> 3:       Effective reproduction no.           0.92 (0.8 -- 1)
