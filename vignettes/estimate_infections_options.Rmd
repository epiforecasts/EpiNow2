...
#>         warmup sample
#> chain:1 28.695 18.063
#> chain:2 32.945 17.351
#> chain:3 30.765 22.520
#> chain:4 34.988 13.535
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 23.013 14.811
#> chain:2 18.794 10.543
#> chain:3 34.913 13.141
#> chain:4 25.195 18.938
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 39.995 10.500
#> chain:2 35.085 14.856
#> chain:3 39.112 17.341
#> chain:4 38.963 10.653
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 28.318 10.178
#> chain:2 27.533 10.611
#> chain:3 26.397 10.142
#> chain:4 23.130 17.241
# summary plot
plot(trunc)
```
...
#>         warmup  sample
#> chain:1 29.935 179.123
#> chain:2 32.793  11.224
#> chain:3 29.929  12.701
#> chain:4 30.211  12.882
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1 26.375 15.988
#> chain:2 34.154 15.145
#> chain:3 12.074 16.263
#> chain:4 29.711 14.543
# summary plot
plot(no_delay)
```
