...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2230 (1348 -- 3550)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.71 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.094 -- 0.034)
#> 5: Doubling/halving time (days)         -24 (20 -- -7.3)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 57.461 61.356
#> chain:2 60.888 54.728
#> chain:3 53.165 61.165
#> chain:4 54.822 58.316
# summary plot
plot(def)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2285 (1415 -- 3652)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.73 -- 1.1)
#> 4:               Rate of growth -0.027 (-0.087 -- 0.037)
#> 5: Doubling/halving time (days)           -25 (19 -- -8)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 41.364 53.526
#> chain:2 28.630 55.020
#> chain:3 35.637 47.802
#> chain:4 35.731 45.451
# summary plot
plot(agp)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2215 (1346 -- 3612)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.7 -- 1.1)
#> 4:               Rate of growth -0.03 (-0.099 -- 0.034)
#> 5: Doubling/halving time (days)          -23 (20 -- -7)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup  sample
#> chain:1 81.022 184.497
#> chain:2 62.938  51.301
#> chain:3 82.103  48.815
#> chain:4 68.360  34.209
# summary plot
plot(dep)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     3577 (2190 -- 6128)
#> 2:   Expected change in reports       Likely increasing
#> 3:   Effective reproduction no.         1 (0.84 -- 1.3)
#> 4:               Rate of growth 0.017 (-0.051 -- 0.093)
#> 5: Doubling/halving time (days)         41 (7.5 -- -14)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 54.198 63.135
#> chain:2 67.519 32.903
#> chain:3 56.318 62.065
#> chain:4 60.488 54.921
# summary plot
plot(trunc)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2256 (1344 -- 3688)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.7 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.099 -- 0.04)
#> 5: Doubling/halving time (days)          -24 (17 -- -7)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 56.052 32.436
#> chain:2 58.207 53.631
#> chain:3 55.218 57.744
#> chain:4 54.861 57.688
# summary plot
plot(project_rt)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day 19078 (10853 -- 34315)
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2307 (1940 -- 2751)
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    2032 (1056 -- 3972)
#> 2:   Expected change in reports      Likely decreasing
#> 3:   Effective reproduction no.     0.85 (0.61 -- 1.2)
#> 4:               Rate of growth -0.041 (-0.11 -- 0.04)
#> 5: Doubling/halving time (days)       -17 (17 -- -6.1)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1 19.917 28.642
#> chain:2 16.984 27.329
#> chain:3 17.989 29.503
#> chain:4 14.530 30.321
# summary plot
plot(rw)
```
...
#>                         measure                   estimate
#>                          <char>                     <char>
#> 1:       New infections per day        2810 (2413 -- 3250)
#> 2:   Expected change in reports                 Decreasing
#> 3:   Effective reproduction no.        0.89 (0.81 -- 0.97)
#> 4:               Rate of growth -0.031 (-0.062 -- 0.00056)
#> 5: Doubling/halving time (days)          -22 (1200 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 69.716 66.236
#> chain:2 66.528 58.876
#> chain:3 68.297 69.222
#> chain:4 61.732 53.741
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2544 (2503 -- 2587)
#> 2:   Expected change in reports                Decreasing
