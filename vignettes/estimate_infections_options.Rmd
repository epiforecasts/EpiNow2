...
#>         warmup sample
#> chain:1 28.070 27.748
#> chain:2 34.484 19.490
#> chain:3 33.872 25.768
#> chain:4 34.905 29.896
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 18.357 29.911
#> chain:2 20.246 29.629
#> chain:3 18.352 28.997
#> chain:4 20.807 18.468
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 32.591 28.560
#> chain:2 28.259 21.302
#> chain:3 31.607 30.948
#> chain:4 25.119 33.602
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 31.638 22.139
#> chain:2 31.289 26.401
#> chain:3 30.795 22.457
#> chain:4 33.163 25.051
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 37.886 34.585
#> chain:2 37.233 33.058
#> chain:3 33.983 32.335
#> chain:4 39.360 32.773
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.387 12.128
#> chain:2 10.325 15.011
#> chain:3  9.274 13.562
#> chain:4  9.863 15.371
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 32.999 33.190
#> chain:2 43.670 40.119
#> chain:3 35.868 34.857
#> chain:4 36.990 41.375
# summary plot
plot(no_delay)
```
