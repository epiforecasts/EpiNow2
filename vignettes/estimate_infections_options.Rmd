...
#>         warmup sample
#> chain:1 23.178 31.751
#> chain:2 31.662 30.028
#> chain:3 32.614 19.074
#> chain:4 32.165 30.373
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 17.696 25.534
#> chain:2 21.915 32.120
#> chain:3 25.103 26.480
#> chain:4 19.361 32.465
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 47.544 29.934
#> chain:2 41.550 32.274
#> chain:3 44.656 31.896
#> chain:4 43.471 27.362
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 27.272 26.108
#> chain:2 23.457 25.600
#> chain:3 35.071 25.087
#> chain:4 28.201 23.232
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 36.587 24.101
#> chain:2 37.307 37.065
#> chain:3 34.228 31.813
#> chain:4 37.046 33.138
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.941 14.150
#> chain:2  9.991 14.810
#> chain:3  7.076 15.447
#> chain:4 33.259 32.092
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 35.952 24.642
#> chain:2 32.105 35.080
#> chain:3 21.001 30.110
#> chain:4 26.740 29.746
# summary plot
plot(no_delay)
```
