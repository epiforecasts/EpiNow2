...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2268 (1359 -- 3720)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.72 -- 1.1)
#> 4:               Rate of growth -0.027 (-0.099 -- 0.042)
#> 5: Doubling/halving time (days)           -26 (17 -- -7)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 29.634 33.539
#> chain:2 34.203 25.302
#> chain:3 32.555 30.037
#> chain:4 29.701 33.391
# summary plot
plot(def)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2269 (1352 -- 3755)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.72 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.094 -- 0.039)
#> 5: Doubling/halving time (days)         -24 (18 -- -7.3)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 21.265 23.446
#> chain:2 23.473 24.072
#> chain:3 18.503 32.258
#> chain:4 20.570 30.824
# summary plot
plot(agp)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    2246 (1315 -- 3692)
#> 2:   Expected change in reports      Likely decreasing
...
#>         warmup sample
#> chain:1 38.417 31.452
#> chain:2 41.478 31.206
#> chain:3 46.093 29.358
#> chain:4 37.838 24.300
# summary plot
plot(dep)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     3610 (2194 -- 6209)
#> 2:   Expected change in reports       Likely increasing
#> 3:   Effective reproduction no.         1 (0.85 -- 1.3)
#> 4:               Rate of growth 0.018 (-0.048 -- 0.096)
#> 5: Doubling/halving time (days)         38 (7.2 -- -14)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 30.446 19.000
#> chain:2 29.335 27.066
#> chain:3 33.105 25.750
#> chain:4 25.154 20.620
# summary plot
plot(trunc)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2292 (1395 -- 3719)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.91 (0.72 -- 1.1)
#> 4:               Rate of growth -0.025 (-0.096 -- 0.045)
#> 5: Doubling/halving time (days)         -27 (15 -- -7.2)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 32.802 31.070
#> chain:2 36.105 32.880
#> chain:3 37.117 19.098
#> chain:4 35.957 32.970
# summary plot
plot(project_rt)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day 19049 (11215 -- 33100)
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2310 (1937 -- 2767)
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2009 (1046 -- 3901)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.85 (0.63 -- 1.2)
#> 4:               Rate of growth -0.042 (-0.11 -- 0.038)
#> 5: Doubling/halving time (days)        -17 (18 -- -6.2)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1 22.072  9.828
#> chain:2  6.738 14.549
#> chain:3  8.069 14.151
#> chain:4  8.045 11.326
# summary plot
plot(rw)
```
...
#>                         measure                   estimate
#>                          <char>                     <char>
#> 1:       New infections per day        2798 (2403 -- 3293)
#> 2:   Expected change in reports                 Decreasing
#> 3:   Effective reproduction no.         0.89 (0.8 -- 0.97)
#> 4:               Rate of growth -0.031 (-0.064 -- 0.00077)
#> 5: Doubling/halving time (days)           -22 (900 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 42.001 32.138
#> chain:2 28.885 41.913
#> chain:3 36.765 30.873
#> chain:4 35.644 30.006
# summary plot
plot(no_delay)
```
