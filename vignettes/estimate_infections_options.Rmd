...
#>         warmup sample
#> chain:1 29.030 32.931
#> chain:2 33.218 24.755
#> chain:3 31.753 29.469
#> chain:4 28.929 32.791
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 20.584 22.758
#> chain:2 23.064 23.735
#> chain:3 17.974 32.191
#> chain:4 20.190 29.381
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 37.442 30.251
#> chain:2 40.263 30.163
#> chain:3 44.978 28.588
#> chain:4 36.680 23.680
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 29.777 17.284
#> chain:2 28.260 26.844
#> chain:3 32.251 24.659
#> chain:4 24.310 19.775
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 31.657 29.790
#> chain:2 35.007 31.657
#> chain:3 35.572 18.331
#> chain:4 35.099 31.678
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1 21.358  9.496
#> chain:2  6.532 14.323
#> chain:3  7.754 13.639
#> chain:4  7.787 10.992
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 40.669 31.894
#> chain:2 28.106 40.236
#> chain:3 35.791 29.838
#> chain:4 34.658 29.325
# summary plot
plot(no_delay)
```
