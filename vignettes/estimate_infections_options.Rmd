...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2263 (1420 -- 3688)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.       0.9 (0.73 -- 1.1)
#> 4:               Rate of growth -0.028 (-0.09 -- 0.039)
#> 5: Doubling/halving time (days)        -24 (18 -- -7.7)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 39.107 23.380
#> chain:2 35.722 15.027
#> chain:3 39.308 17.821
#> chain:4 38.168 20.205
# summary plot
plot(def)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2254 (1387 -- 3697)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.71 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.091 -- 0.038)
#> 5: Doubling/halving time (days)         -24 (18 -- -7.6)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 33.900 23.465
#> chain:2 31.308 14.379
#> chain:3 31.639 26.503
#> chain:4 38.177 19.102
# summary plot
plot(agp)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2280 (1379 -- 3770)
#> 2:   Expected change in reports        Likely decreasing
...
#>         warmup sample
#> chain:1 55.827 18.943
#> chain:2 54.295 24.246
#> chain:3 52.028 17.284
#> chain:4 57.923 21.822
# summary plot
plot(dep)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     3640 (2192 -- 6309)
#> 2:   Expected change in reports       Likely increasing
#> 3:   Effective reproduction no.         1 (0.84 -- 1.3)
#> 4:               Rate of growth 0.018 (-0.048 -- 0.095)
#> 5: Doubling/halving time (days)         38 (7.3 -- -14)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 42.301 11.585
#> chain:2 34.143 14.208
#> chain:3 33.891 18.303
#> chain:4 30.521 18.825
# summary plot
plot(trunc)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day   2537 (1381 -- 170940)
#> 2:   Expected change in reports                  Stable
#> 3:   Effective reproduction no.       0.94 (0.72 -- 11)
#> 4:               Rate of growth -0.012 (-0.094 -- 0.17)
#> 5: Doubling/halving time (days)         -60 (4 -- -7.4)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>          warmup  sample
#> chain:1 125.899 215.963
#> chain:2  42.272  24.190
#> chain:3  40.785  22.610
#> chain:4  38.277  17.912
# summary plot
plot(project_rt)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day 19173 (10901 -- 34741)
...
#> Warning: There were 470 divergent transitions after warmup. See
#> https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#> to find out why this is a problem and how to eliminate them.
#> Warning: There were 30 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 12. See
#> https://mc-stan.org/misc/warnings.html#maximum-treedepth-exceeded
#> Warning: Examine the pairs() plot to diagnose sampling problems
#> Warning: The largest R-hat is NA, indicating chains have not mixed.
#> Running the chains for more iterations may help. See
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day      1725 (922 -- 3680)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.85 (0.64 -- 1.1)
#> 4:               Rate of growth -0.057 (-0.11 -- 0.032)
#> 5: Doubling/halving time (days)        -12 (22 -- -6.5)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1  8.414 15.223
#> chain:2  7.062 67.386
#> chain:3  8.033 13.393
#> chain:4 16.851 10.458
# summary plot
plot(rw)
```
...
#>                         measure                   estimate
#>                          <char>                     <char>
#> 1:       New infections per day        2804 (2413 -- 3272)
#> 2:   Expected change in reports                 Decreasing
#> 3:   Effective reproduction no.        0.89 (0.81 -- 0.98)
#> 4:               Rate of growth -0.031 (-0.061 -- 0.00095)
#> 5: Doubling/halving time (days)           -22 (730 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 45.843 17.594
#> chain:2 36.437 21.669
#> chain:3 37.393 17.539
#> chain:4 33.065 13.253
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2543 (2499 -- 2585)
#> 2:   Expected change in reports                Decreasing
