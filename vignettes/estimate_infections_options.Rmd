...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2212 (1368 -- 3691)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.72 -- 1.1)
#> 4:               Rate of growth -0.031 (-0.093 -- 0.041)
#> 5: Doubling/halving time (days)         -22 (17 -- -7.5)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 40.986 22.140
#> chain:2 42.038 21.989
#> chain:3 30.524 21.597
#> chain:4 37.919 21.726
# summary plot
plot(def)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2249 (1405 -- 3695)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.72 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.092 -- 0.042)
#> 5: Doubling/halving time (days)         -24 (17 -- -7.5)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 26.335 14.878
#> chain:2 37.211 19.004
#> chain:3 27.130 17.544
#> chain:4 32.621 20.138
# summary plot
plot(agp)
```
...
#> Warning: There were 986 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 12. See
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day   2566 (1445 -- 138726)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.95 (0.73 -- 4.7)
#> 4:               Rate of growth -0.012 (-0.086 -- 0.11)
#> 5: Doubling/halving time (days)       -58 (6.2 -- -8.1)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>          warmup  sample
#> chain:1  48.635  16.309
#> chain:2  73.584 256.642
#> chain:3  53.681  18.652
#> chain:4 112.436 199.099
# summary plot
plot(dep)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     3613 (2163 -- 6087)
#> 2:   Expected change in reports       Likely increasing
#> 3:   Effective reproduction no.       1.1 (0.84 -- 1.3)
#> 4:               Rate of growth 0.018 (-0.051 -- 0.095)
#> 5: Doubling/halving time (days)         39 (7.3 -- -14)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 38.341 16.486
#> chain:2 33.088 14.321
#> chain:3 37.941 11.633
#> chain:4 31.950 13.865
# summary plot
plot(trunc)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2223 (1347 -- 3696)
#> 2:   Expected change in reports        Likely decreasing
...
#>         warmup sample
#> chain:1 38.512 14.598
#> chain:2 34.432 23.374
#> chain:3 34.198 19.613
#> chain:4 38.538 18.918
# summary plot
plot(project_rt)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day 19372 (11096 -- 35037)
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2301 (1945 -- 2735)
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2001 (1055 -- 3892)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.84 (0.61 -- 1.2)
#> 4:               Rate of growth -0.042 (-0.11 -- 0.038)
#> 5: Doubling/halving time (days)        -16 (18 -- -6.3)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1  8.566 12.502
#> chain:2  9.403 12.209
#> chain:3  8.354 11.881
#> chain:4 10.152 12.933
# summary plot
plot(rw)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2793 (2407 -- 3300)
#> 2:   Expected change in reports               Decreasing
#> 3:   Effective reproduction no.      0.89 (0.81 -- 0.98)
#> 4:               Rate of growth -0.03 (-0.062 -- 0.0011)
#> 5: Doubling/halving time (days)         -23 (650 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 43.865 18.591
#> chain:2 39.666 19.914
#> chain:3 41.689 19.177
#> chain:4 37.752 20.903
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2543 (2505 -- 2584)
#> 2:   Expected change in reports                Decreasing
