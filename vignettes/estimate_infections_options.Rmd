...
#>                             measure                 estimate
#>                              <char>                   <char>
#> 1:           New infections per day      2264 (1308 -- 4005)
#> 2: Expected change in daily reports        Likely decreasing
#> 3:       Effective reproduction no.        0.9 (0.71 -- 1.1)
#> 4:                   Rate of growth -0.027 (-0.098 -- 0.047)
#> 5:     Doubling/halving time (days)         -26 (15 -- -7.1)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 26.545 16.601
#> chain:2 32.227 20.480
#> chain:3 29.332 16.284
#> chain:4 32.614 23.085
# summary plot
plot(def)
```
...
#>                             measure                 estimate
#>                              <char>                   <char>
#> 1:           New infections per day      2270 (1286 -- 3966)
#> 2: Expected change in daily reports        Likely decreasing
#> 3:       Effective reproduction no.        0.9 (0.71 -- 1.1)
#> 4:                   Rate of growth -0.027 (-0.097 -- 0.045)
#> 5:     Doubling/halving time (days)         -26 (15 -- -7.2)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 21.067 17.131
#> chain:2 23.868 14.431
#> chain:3 22.768 20.704
#> chain:4 22.066 16.321
# summary plot
plot(agp)
```
...
#>                             measure                 estimate
#>                              <char>                   <char>
#> 1:           New infections per day      2237 (1308 -- 4207)
#> 2: Expected change in daily reports        Likely decreasing
#> 3:       Effective reproduction no.        0.9 (0.72 -- 1.1)
#> 4:                   Rate of growth -0.029 (-0.095 -- 0.051)
#> 5:     Doubling/halving time (days)         -24 (14 -- -7.3)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 28.657 17.235
#> chain:2 29.799 16.871
#> chain:3 29.461 18.960
#> chain:4 32.941 22.939
# summary plot
plot(dep)
```
...
#>                             measure              estimate
#>                              <char>                <char>
#> 1:           New infections per day   4196 (2313 -- 8186)
#> 2: Expected change in daily reports     Likely increasing
#> 3:       Effective reproduction no.     1.1 (0.86 -- 1.4)
#> 4:                   Rate of growth 0.03 (-0.047 -- 0.12)
#> 5:     Doubling/halving time (days)       23 (5.7 -- -15)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 26.653 19.759
#> chain:2 30.216 16.568
#> chain:3 31.102 19.356
#> chain:4 28.357 17.450
# summary plot
plot(trunc)
```
...
#>                             measure               estimate
#>                              <char>                 <char>
#> 1:           New infections per day    2276 (1277 -- 4191)
#> 2: Expected change in daily reports      Likely decreasing
#> 3:       Effective reproduction no.      0.9 (0.71 -- 1.2)
#> 4:                   Rate of growth -0.026 (-0.1 -- 0.055)
#> 5:     Doubling/halving time (days)         -27 (13 -- -7)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 30.823 26.431
#> chain:2 30.742 22.618
#> chain:3 35.690 16.739
#> chain:4 30.136 17.700
# summary plot
plot(project_rt)
```
...
#>                             measure                 estimate
#>                              <char>                   <char>
#> 1:           New infections per day      2340 (1935 -- 2915)
...
#>                             measure               estimate
#>                              <char>                 <char>
#> 1:           New infections per day    2143 (1038 -- 4303)
#> 2: Expected change in daily reports      Likely decreasing
#> 3:       Effective reproduction no.     0.87 (0.62 -- 1.2)
#> 4:                   Rate of growth -0.036 (-0.11 -- 0.05)
#> 5:     Doubling/halving time (days)       -19 (14 -- -6.2)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1  7.907 14.162
#> chain:2  6.976 11.488
#> chain:3  8.596 13.254
#> chain:4  8.159 13.409
# summary plot
plot(rw)
```
...
#>                             measure                   estimate
#>                              <char>                     <char>
#> 1:           New infections per day        2786 (2404 -- 3256)
#> 2: Expected change in daily reports                 Decreasing
#> 3:       Effective reproduction no.        0.89 (0.81 -- 0.97)
#> 4:                   Rate of growth -0.032 (-0.062 -- 0.00052)
#> 5:     Doubling/halving time (days)          -22 (1300 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 33.359 28.416
#> chain:2 34.529 28.554
#> chain:3 39.087 26.948
#> chain:4 35.531 32.771
# summary plot
plot(no_delay)
```
...
#>                             measure                  estimate
#>                              <char>                    <char>
#> 1:           New infections per day       2730 (2690 -- 2778)
#> 2: Expected change in daily reports                Decreasing
