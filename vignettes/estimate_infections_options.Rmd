...
#>         warmup sample
#> chain:1 26.956 26.473
#> chain:2 33.343 18.977
#> chain:3 32.875 24.680
#> chain:4 33.802 28.918
# summary plot
plot(def)
```
...
# summarise results
summary(agp)
#>        Effective reproduction no.       0.91 (0.73 -- 1.1)
#> 4:                   Rate of growth -0.026 (-0.094 -- 0.036)
#> 5:     Doubling/halving time (days)         -26 (19 -- -7.4)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 17.620 29.978
#> chain:2 19.455 26.418
#> chain:4 19.997 17.656
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 31.174 30.436
#> chain:2 26.835 20.776
#> chain:3 30.382 26.736
#> chain:4 23.814 32.671
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 30.339 21.231
#> chain:2 29.944 25.365
#> chain:3 29.714 21.298
#> chain:4 32.160 23.888
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 36.775 32.624
#> chain:2 36.206 32.589
#> chain:3 32.815 31.271
#> chain:4 38.361 32.981
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.197 15.305
#> chain:2  9.171 14.980
#> chain:3  7.182 15.912
#> chain:4  7.820 14.456
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 32.002 30.715
#> chain:2 38.873 32.612
#> chain:3 31.184 36.027
#> chain:4 33.512 31.216
# summary plot
plot(no_delay)
```
