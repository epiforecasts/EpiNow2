...
#>         warmup sample
#> chain:1 23.304 33.535
#> chain:2 31.788 29.501
#> chain:3 33.002 19.083
#> chain:4 32.269 31.033
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 17.828 25.511
#> chain:2 22.394 31.348
#> chain:3 25.265 28.614
#> chain:4 19.730 29.731
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 36.965 19.353
#> chain:2 31.320 30.771
#> chain:3 35.348 22.521
#> chain:4 30.335 18.673
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 28.864 18.134
#> chain:2 28.068 21.343
#> chain:3 31.733 17.971
#> chain:4 25.179 20.368
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 35.164 32.040
#> chain:2 32.559 35.210
#> chain:3 36.377 33.125
#> chain:4 35.061 33.420
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.331  8.803
#> chain:2  9.050 15.384
#> chain:3 12.448 11.109
#> chain:4  8.647 15.208
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 36.777 30.423
#> chain:2 33.681 30.626
#> chain:3 36.428 41.270
#> chain:4 34.287 33.465
# summary plot
plot(no_delay)
```
