...
#>         warmup sample
#> chain:1 26.873 26.667
#> chain:2 33.417 18.862
#> chain:3 32.502 24.469
#> chain:4 33.828 28.258
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 17.677 27.766
#> chain:2 19.701 28.813
#> chain:3 17.688 27.802
#> chain:4 20.273 17.543
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 31.189 30.299
#> chain:2 26.782 20.417
#> chain:3 30.260 26.229
#> chain:4 23.944 32.641
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 29.997 21.079
#> chain:2 29.762 24.901
#> chain:3 29.592 21.305
#> chain:4 31.857 23.764
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 36.617 32.773
#> chain:2 36.347 32.337
#> chain:3 32.904 31.262
#> chain:4 38.219 33.053
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.391 11.991
#> chain:2 10.357 14.852
#> chain:3  9.204 13.292
#> chain:4  9.747 15.009
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 31.595 31.667
#> chain:2 42.210 39.122
#> chain:3 34.855 33.147
#> chain:4 35.873 40.045
# summary plot
plot(no_delay)
```
