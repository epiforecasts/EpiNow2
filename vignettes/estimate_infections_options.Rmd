...
#>         warmup sample
#> chain:1 27.759 27.407
#> chain:2 34.138 19.178
#> chain:3 33.489 24.952
#> chain:4 34.485 29.159
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 18.136 31.173
#> chain:2 20.112 27.139
#> chain:3 18.135 28.456
#> chain:4 20.738 18.234
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 31.742 30.678
#> chain:2 27.178 20.551
#> chain:3 30.777 27.033
#> chain:4 24.301 32.471
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 30.561 21.532
#> chain:2 30.561 25.491
#> chain:3 30.318 21.739
#> chain:4 32.286 24.302
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 37.485 34.882
#> chain:2 37.392 33.353
#> chain:3 33.712 31.840
#> chain:4 39.499 32.163
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.357 15.456
#> chain:2  9.298 15.462
#> chain:3  7.357 15.984
#> chain:4  8.153 14.984
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 31.347 30.355
#> chain:2 38.770 32.990
#> chain:3 31.108 35.373
#> chain:4 33.514 31.689
# summary plot
plot(no_delay)
```
