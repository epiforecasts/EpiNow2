...
#>         warmup sample
#> chain:1 27.169 27.048
#> chain:2 33.265 19.075
#> chain:3 32.776 24.497
#> chain:4 33.829 29.263
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 17.597 29.232
#> chain:2 19.558 27.875
#> chain:4 20.116 17.661
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 31.326 30.236
#> chain:2 27.003 20.333
#> chain:3 30.184 27.203
#> chain:4 24.240 32.723
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 30.162 21.376
#> chain:2 30.083 25.228
#> chain:3 29.438 21.224
#> chain:4 31.972 23.829
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 37.255 33.523
#> chain:2 36.596 31.209
#> chain:3 33.344 31.687
#> chain:4 38.203 32.816
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.164 15.117
#> chain:2  9.276 15.376
#> chain:3  7.254 15.931
#> chain:4  7.945 14.819
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 32.016 31.029
#> chain:2 38.833 32.161
#> chain:3 31.612 35.853
#> chain:4 32.728 31.385
# summary plot
plot(no_delay)
```
