...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2207 (1415 -- 3769)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.72 -- 1.1)
#> 4:               Rate of growth -0.031 (-0.093 -- 0.038)
#> 5: Doubling/halving time (days)         -22 (18 -- -7.5)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 26.273 34.348
#> chain:2 30.626 34.649
#> chain:3 31.135 32.914
#> chain:4 34.248 32.890
# summary plot
plot(def)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2277 (1397 -- 3788)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.71 -- 1.1)
#> 4:               Rate of growth -0.027 (-0.096 -- 0.039)
#> 5: Doubling/halving time (days)         -25 (18 -- -7.2)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 20.834 17.073
#> chain:2 19.381 27.396
#> chain:3 20.326 19.978
#> chain:4 23.623 26.187
# summary plot
plot(agp)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2232 (1373 -- 3617)
#> 2:   Expected change in reports       Likely decreasing
...
#>         warmup sample
#> chain:1 32.951 25.579
#> chain:2 40.914 29.599
#> chain:3 47.753 22.282
#> chain:4 39.156 24.780
# summary plot
plot(dep)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     3615 (2186 -- 6282)
#> 2:   Expected change in reports       Likely increasing
#> 3:   Effective reproduction no.         1 (0.84 -- 1.3)
#> 4:               Rate of growth 0.016 (-0.047 -- 0.096)
#> 5: Doubling/halving time (days)         44 (7.3 -- -15)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 17.815 30.403
#> chain:2 29.712 26.697
#> chain:3 31.020 28.974
#> chain:4 30.664 24.030
# summary plot
plot(trunc)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2219 (1359 -- 3793)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.89 (0.7 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.099 -- 0.043)
#> 5: Doubling/halving time (days)           -24 (16 -- -7)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 32.971 35.008
#> chain:2 38.144 30.641
#> chain:3 36.925 33.441
#> chain:4 30.059 33.537
# summary plot
plot(project_rt)
```
...
#> Warning: There were 441 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 12. See
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2317 (1928 -- 2729)
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2011 (1085 -- 3828)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.85 (0.61 -- 1.1)
#> 4:               Rate of growth -0.042 (-0.11 -- 0.033)
#> 5: Doubling/halving time (days)        -16 (21 -- -6.3)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1  9.138 15.484
#> chain:2  8.103 16.319
#> chain:3  8.920 16.543
#> chain:4 29.621 65.282
# summary plot
plot(rw)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2784 (2408 -- 3277)
#> 2:   Expected change in reports                Decreasing
#> 3:   Effective reproduction no.        0.88 (0.8 -- 0.98)
#> 4:               Rate of growth -0.032 (-0.063 -- 0.0017)
#> 5: Doubling/halving time (days)          -22 (400 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 33.912 39.159
#> chain:2 35.046 30.021
#> chain:3 34.705 30.374
#> chain:4 36.301 29.656
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2543 (2506 -- 2581)
#> 2:   Expected change in reports                Decreasing
