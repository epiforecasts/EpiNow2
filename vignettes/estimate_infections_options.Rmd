...
summary(def)
#>                                  measure                estimate
#> 1: New confirmed cases by infection date     2261 (1099 -- 4448)
#> 2:        Expected change in daily cases       Likely decreasing
#> 3:            Effective reproduction no.      0.88 (0.61 -- 1.2)
#> 4:                        Rate of growth -0.027 (-0.096 -- 0.04)
#> 5:          Doubling/halving time (days)        -26 (17 -- -7.2)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 35.330 32.297
#> chain:2 39.418 54.855
#> chain:3 39.610 39.884
#> chain:4 34.486 32.182
# summary plot
plot(def)
```
...
summary(agp)
#>                                  measure                estimate
#> 1: New confirmed cases by infection date     2366 (1220 -- 4583)
#> 2:        Expected change in daily cases       Likely decreasing
#> 3:            Effective reproduction no.      0.89 (0.65 -- 1.2)
#> 4:                        Rate of growth -0.024 (-0.086 -- 0.04)
#> 5:          Doubling/halving time (days)          -29 (17 -- -8)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 27.499 31.038
#> chain:2 23.096 40.688
#> chain:3 25.129 46.259
#> chain:4 21.050 26.049
# summary plot
plot(agp)
```
...
summary(dep)
#>                                  measure                 estimate
#> 1: New confirmed cases by infection date      2322 (1162 -- 4382)
#> 2:        Expected change in daily cases        Likely decreasing
#> 3:            Effective reproduction no.       0.89 (0.62 -- 1.2)
#> 4:                        Rate of growth -0.025 (-0.095 -- 0.038)
#> 5:          Doubling/halving time (days)         -27 (18 -- -7.3)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 39.387 27.190
#> chain:2 32.756 26.621
#> chain:3 31.918 28.095
#> chain:4 30.689 26.735
# summary plot
plot(dep)
```
...
summary(trunc)
#>                                  measure                estimate
#> 1: New confirmed cases by infection date     2490 (1315 -- 4925)
#> 2:        Expected change in daily cases       Likely decreasing
#> 3:            Effective reproduction no.      0.91 (0.66 -- 1.3)
#> 4:                        Rate of growth -0.019 (-0.085 -- 0.05)
#> 5:          Doubling/halving time (days)        -37 (14 -- -8.2)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 38.588 26.820
#> chain:2 38.403 24.647
#> chain:3 41.815 49.189
#> chain:4 35.495 28.319
# summary plot
plot(trunc)
```
...
summary(project_rt)
#>                                  measure              estimate
#> 1: New confirmed cases by infection date   2314 (1088 -- 4542)
#> 2:        Expected change in daily cases     Likely decreasing
#> 3:            Effective reproduction no.     0.89 (0.6 -- 1.2)
#> 4:                        Rate of growth -0.025 (-0.1 -- 0.04)
#> 5:          Doubling/halving time (days)      -28 (17 -- -6.9)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 35.698 35.492
#> chain:2 40.701 27.915
#> chain:3 34.761 27.982
#> chain:4 43.075 26.794
# summary plot
plot(project_rt)
```
...
summary(fixed)
#>                                  measure              estimate
#> 1: New confirmed cases by infection date 15657 (8824 -- 28878)
...
summary(rw)
#>                                  measure                estimate
#> 1: New confirmed cases by infection date     2164 (1144 -- 4158)
#> 2:        Expected change in daily cases       Likely decreasing
#> 3:            Effective reproduction no.      0.86 (0.63 -- 1.1)
#> 4:                        Rate of growth -0.032 (-0.094 -- 0.03)
#> 5:          Doubling/halving time (days)        -22 (23 -- -7.4)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1  7.931  9.961
#> chain:2  8.007 12.656
#> chain:3  8.219 11.543
#> chain:4  7.988 10.539
# summary plot
plot(rw)
```
...
summary(no_delay)
#>                                  measure                    estimate
#> 1: New confirmed cases by infection date         2792 (2338 -- 3331)
#> 2:        Expected change in daily cases                  Decreasing
#> 3:            Effective reproduction no.            0.88 (0.77 -- 1)
#> 4:                        Rate of growth -0.026 (-0.054 -- -0.00063)
#> 5:          Doubling/halving time (days)          -26 (-1100 -- -13)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 33.957 32.806
#> chain:2 26.216 35.115
#> chain:3 29.836 33.585
#> chain:4 28.293 34.279
# summary plot
plot(no_delay)
```
...
#>                                  measure                   estimate
#> 1: New confirmed cases by infection date        2353 (1761 -- 3058)
#> 2:        Expected change in daily cases                 Decreasing
#> 3:            Effective reproduction no.        0.89 (0.79 -- 0.99)
#> 4:                        Rate of growth -0.023 (-0.048 -- -0.0027)
#> 5:          Doubling/halving time (days)          -30 (-250 -- -15)
# elapsed time (in seconds)
