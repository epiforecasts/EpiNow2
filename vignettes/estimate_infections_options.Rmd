...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2252 (1381 -- 3613)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.71 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.095 -- 0.034)
#> 5: Doubling/halving time (days)         -24 (20 -- -7.3)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 30.503 19.737
#> chain:2 33.312 26.321
#> chain:3 35.170 24.384
#> chain:4 30.624 22.161
# summary plot
plot(def)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    2234 (1416 -- 3730)
#> 2:   Expected change in reports      Likely decreasing
#> 3:   Effective reproduction no.     0.89 (0.72 -- 1.1)
#> 4:               Rate of growth -0.03 (-0.09 -- 0.039)
#> 5: Doubling/halving time (days)       -23 (18 -- -7.7)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 20.242 31.989
#> chain:2 21.593 32.538
#> chain:3 21.991 31.392
#> chain:4 18.661 33.125
# summary plot
plot(agp)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2260 (1377 -- 3653)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.72 -- 1.1)
#> 4:               Rate of growth -0.028 (-0.092 -- 0.035)
#> 5: Doubling/halving time (days)         -24 (20 -- -7.6)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 45.654 29.959
#> chain:2 47.829 19.092
#> chain:3 30.575 35.263
#> chain:4 42.507 27.042
# summary plot
plot(dep)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day   4015 (2293 -- 46931)
#> 2:   Expected change in reports      Likely increasing
#> 3:   Effective reproduction no.      1.1 (0.86 -- 4.1)
#> 4:               Rate of growth 0.033 (-0.047 -- 0.72)
#> 5: Doubling/halving time (days)       21 (0.96 -- -15)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup  sample
#> chain:1  9.565 191.520
#> chain:2 28.829  32.381
#> chain:3 29.901  29.556
#> chain:4 36.055  24.031
# summary plot
plot(trunc)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2253 (1348 -- 3739)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.7 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.097 -- 0.04)
#> 5: Doubling/halving time (days)        -24 (17 -- -7.1)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 32.608 34.878
#> chain:2 33.052 34.835
#> chain:3 33.831 33.213
#> chain:4 32.580 34.326
# summary plot
plot(project_rt)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day 19069 (10894 -- 34610)
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2311 (1930 -- 2764)
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     1995 (1029 -- 3786)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.       0.85 (0.6 -- 1.1)
#> 4:               Rate of growth -0.042 (-0.11 -- 0.035)
#> 5: Doubling/halving time (days)        -17 (20 -- -6.1)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1 10.498 15.188
#> chain:2  9.819 15.137
#> chain:3  8.190 15.745
#> chain:4  7.773 15.059
# summary plot
plot(rw)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2796 (2410 -- 3271)
#> 2:   Expected change in reports                Decreasing
#> 3:   Effective reproduction no.       0.89 (0.81 -- 0.98)
#> 4:               Rate of growth -0.031 (-0.061 -- 0.0016)
#> 5: Doubling/halving time (days)          -22 (430 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 30.659 39.824
#> chain:2 30.804 43.326
#> chain:3 32.234 32.703
#> chain:4 28.745 29.780
# summary plot
plot(no_delay)
```
