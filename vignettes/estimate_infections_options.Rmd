...
#>         warmup sample
#> chain:1 27.024 27.015
#> chain:2 33.672 19.006
#> chain:3 32.800 24.527
#> chain:4 33.769 29.120
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 17.556 29.461
#> chain:2 19.392 27.338
#> chain:4 20.053 17.569
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 31.586 27.114
#> chain:2 26.707 20.670
#> chain:3 30.679 30.079
#> chain:4 24.258 33.156
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 30.362 21.356
#> chain:2 29.977 24.761
#> chain:3 29.246 21.235
#> chain:4 32.047 24.091
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 36.325 34.102
#> chain:2 36.438 32.717
#> chain:3 33.171 31.209
#> chain:4 37.939 31.877
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.134 15.287
#> chain:2  9.196 15.181
#> chain:3  7.261 15.849
#> chain:4  7.882 15.030
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 31.291 29.836
#> chain:2 38.516 32.161
#> chain:3 31.023 34.733
#> chain:4 32.624 31.254
# summary plot
plot(no_delay)
```
