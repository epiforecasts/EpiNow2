...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2231 (1399 -- 3633)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.89 (0.71 -- 1.1)
#> 4:               Rate of growth -0.03 (-0.095 -- 0.037)
#> 5: Doubling/halving time (days)        -23 (19 -- -7.3)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 32.444 13.865
#> chain:2 33.171 23.338
#> chain:3 35.275 17.521
#> chain:4 44.299 13.724
# summary plot
plot(def)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    2263 (1384 -- 3810)
#> 2:   Expected change in reports      Likely decreasing
#> 3:   Effective reproduction no.     0.89 (0.72 -- 1.1)
#> 4:               Rate of growth -0.028 (-0.09 -- 0.04)
#> 5: Doubling/halving time (days)       -25 (17 -- -7.7)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 28.231 26.663
#> chain:2 29.054 27.404
#> chain:3 32.399 18.782
#> chain:4 32.631 23.447
# summary plot
plot(agp)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2254 (1376 -- 3667)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.71 -- 1.1)
#> 4:               Rate of growth -0.027 (-0.095 -- 0.035)
#> 5: Doubling/halving time (days)         -26 (20 -- -7.3)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 56.346 23.104
#> chain:2 48.118 24.578
#> chain:3 56.997 25.381
#> chain:4 56.268 25.318
# summary plot
plot(dep)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     3592 (2176 -- 6103)
#> 2:   Expected change in reports       Likely increasing
#> 3:   Effective reproduction no.         1 (0.84 -- 1.3)
#> 4:               Rate of growth 0.016 (-0.052 -- 0.095)
#> 5: Doubling/halving time (days)         42 (7.3 -- -13)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 43.575 23.328
#> chain:2 38.749 24.138
#> chain:3 43.810 15.663
#> chain:4 70.940 20.400
# summary plot
plot(trunc)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2240 (1349 -- 3702)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.89 (0.7 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.099 -- 0.042)
#> 5: Doubling/halving time (days)           -24 (16 -- -7)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 41.168 21.916
#> chain:2 44.464 15.368
#> chain:3 42.240 23.490
#> chain:4 47.103 20.517
# summary plot
plot(project_rt)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2231 (1943 -- 2755)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.       0.9 (0.87 -- 6.1)
#> 4:               Rate of growth -0.026 (-0.034 -- 0.19)
#> 5: Doubling/halving time (days)        -26 (3.7 -- -20)
# elapsed time (in seconds)
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2016 (1065 -- 4015)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.85 (0.61 -- 1.2)
#> 4:               Rate of growth -0.042 (-0.11 -- 0.042)
#> 5: Doubling/halving time (days)        -17 (16 -- -6.3)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1  9.257 13.385
#> chain:2  9.408 13.909
#> chain:3  9.051 13.919
#> chain:4  8.492 13.357
# summary plot
plot(rw)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2799 (2399 -- 3276)
#> 2:   Expected change in reports                Decreasing
#> 3:   Effective reproduction no.        0.89 (0.8 -- 0.98)
#> 4:               Rate of growth -0.031 (-0.065 -- 0.0014)
#> 5: Doubling/halving time (days)          -22 (490 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 38.325 21.282
#> chain:2 34.393 22.778
#> chain:3 39.286 22.131
#> chain:4 45.806 19.831
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2543 (2503 -- 2582)
#> 2:   Expected change in reports                Decreasing
