...
#>         warmup sample
#> chain:1 23.392 33.605
#> chain:2 31.802 29.245
#> chain:3 32.994 19.101
#> chain:4 32.548 31.127
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 17.961 25.784
#> chain:2 22.337 29.290
#> chain:3 25.562 29.649
#> chain:4 19.710 32.554
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 37.265 19.501
#> chain:2 31.595 28.363
#> chain:3 35.580 25.068
#> chain:4 30.460 18.791
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 28.876 18.168
#> chain:2 28.136 20.916
#> chain:3 31.813 18.250
#> chain:4 25.053 20.369
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 35.141 32.098
#> chain:2 32.358 35.219
#> chain:3 36.385 33.197
#> chain:4 35.189 33.431
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.366  8.834
#> chain:2  9.050 12.813
#> chain:3 12.548 12.962
#> chain:4  8.682 14.549
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 36.586 30.383
#> chain:2 33.325 30.432
#> chain:3 35.946 40.889
#> chain:4 33.990 33.775
# summary plot
plot(no_delay)
```
