...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2230 (1395 -- 3664)
...
#>         warmup sample
#> chain:1 25.514 12.577
#> chain:2 24.208 18.257
#> chain:3 29.887 17.612
#> chain:4 25.463 16.695
# summary plot
plot(def)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2207 (1358 -- 3582)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.89 (0.71 -- 1.1)
...
#>         warmup sample
#> chain:1 20.467 13.737
#> chain:2 20.986 13.113
#> chain:3 21.534 17.620
#> chain:4 19.953 12.453
# summary plot
plot(agp)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2275 (1403 -- 3750)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.71 -- 1.1)
#> 4:               Rate of growth -0.027 (-0.093 -- 0.041)
#> 5: Doubling/halving time (days)         -26 (17 -- -7.5)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 39.826 14.493
#> chain:2 31.791 17.371
#> chain:3 38.023 13.165
#> chain:4 30.485 10.513
# summary plot
plot(dep)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     3585 (2189 -- 6168)
#> 2:   Expected change in reports       Likely increasing
#> 3:   Effective reproduction no.         1 (0.84 -- 1.3)
#> 4:               Rate of growth 0.018 (-0.051 -- 0.096)
#> 5: Doubling/halving time (days)         39 (7.2 -- -14)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 23.452 10.725
#> chain:2 22.309  9.497
#> chain:3 30.304 15.933
#> chain:4 25.343 12.133
# summary plot
plot(trunc)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day         1939 (1 -- 3551)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.94 (0.71 -- 1.2)
#> 4:               Rate of growth -0.012 (-0.099 -- 0.037)
#> 5: Doubling/halving time (days)           -58 (19 -- -7)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup  sample
#> chain:1 96.890 246.901
#> chain:2 30.757  11.628
#> chain:3 23.250   9.655
#> chain:4 29.473  10.049
# summary plot
plot(project_rt)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day 19426 (11165 -- 34893)
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2307 (1958 -- 2751)
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    2007 (1028 -- 4009)
#> 2:   Expected change in reports      Likely decreasing
#> 3:   Effective reproduction no.      0.84 (0.6 -- 1.2)
#> 4:               Rate of growth -0.043 (-0.11 -- 0.04)
#> 5: Doubling/halving time (days)       -16 (17 -- -6.1)
# elapsed time (in seconds)
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2797 (2419 -- 3263)
#> 2:   Expected change in reports                Decreasing
#> 3:   Effective reproduction no.       0.89 (0.81 -- 0.98)
#> 4:               Rate of growth -0.031 (-0.063 -- 0.0014)
#> 5: Doubling/halving time (days)          -22 (480 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 23.716 12.876
#> chain:2 25.666 14.998
#> chain:3 28.409 12.994
#> chain:4 24.229 16.675
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2543 (2502 -- 2581)
#> 2:   Expected change in reports                Decreasing
