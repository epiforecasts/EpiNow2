...
#> '/tmp/Rtmpubrqvj/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to the console and:
#> '/tmp/Rtmpubrqvj/epinow/2020-04-21.log'.
res$plots$R
```
...
#> INFO [2025-06-01 00:38:29] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmpubrqvj/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmpubrqvj/epinow/2020-04-21.log'.
#> INFO [2025-06-01 00:38:29] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-06-01 00:38:29] No target directory specified so returning output
#> INFO [2025-06-01 00:38:29] Producing estimates for: testland, realland
#> INFO [2025-06-01 00:38:29] Regions excluded: none
#> INFO [2025-06-01 00:41:27] Completed estimates for: testland
#> INFO [2025-06-01 00:42:35] Completed estimates for: realland
#> INFO [2025-06-01 00:42:35] Completed regional estimates
#> INFO [2025-06-01 00:42:35] Regions with estimates: 2
#> INFO [2025-06-01 00:42:35] Regions with runtime errors: 0
#> INFO [2025-06-01 00:42:35] Producing summary
#> INFO [2025-06-01 00:42:35] No summary directory specified so returning summary output
#> INFO [2025-06-01 00:42:35] No target directory specified so returning timings
## summary
...
#> INFO [2025-06-01 00:42:36] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmpubrqvj/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmpubrqvj/epinow/2020-04-21.log'.
#> INFO [2025-06-01 00:42:36] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-06-01 00:42:36] No target directory specified so returning output
#> INFO [2025-06-01 00:42:36] Producing estimates for: testland, realland
#> INFO [2025-06-01 00:42:36] Regions excluded: none
#> INFO [2025-06-01 00:43:44] Completed estimates for: testland
#> INFO [2025-06-01 00:44:15] Completed estimates for: realland
#> INFO [2025-06-01 00:44:15] Completed regional estimates
#> INFO [2025-06-01 00:44:15] Regions with estimates: 2
#> INFO [2025-06-01 00:44:15] Regions with runtime errors: 0
#> INFO [2025-06-01 00:44:15] Producing summary
#> INFO [2025-06-01 00:44:15] No summary directory specified so returning summary output
#> INFO [2025-06-01 00:44:16] No target directory specified so returning timings
## summary
