...
#>      <char>                 <char>                     <fctr>
#> 1: realland    2261 (1377 -- 3695)          Likely decreasing
#> 2: testland    2253 (1371 -- 3720)          Likely decreasing
#>    Effective reproduction no.           Rate of growth
#>                        <char>                   <char>
#> 1:          0.9 (0.71 -- 1.1) -0.027 (-0.096 -- 0.038)
#> 2:          0.9 (0.71 -- 1.1)  -0.028 (-0.099 -- 0.04)
...
#>      Region New infections per day Expected change in reports
#>      <char>                 <char>                     <fctr>
#> 1: realland    1991 (1024 -- 4061)          Likely decreasing
#> 2: testland    2240 (1358 -- 3658)          Likely decreasing
#>    Effective reproduction no.           Rate of growth
#>                        <char>                   <char>
#> 1:          0.84 (0.6 -- 1.2)  -0.043 (-0.11 -- 0.042)
#> 2:         0.89 (0.71 -- 1.1) -0.029 (-0.095 -- 0.037)
#>    Doubling/halving time (days)
#>                          <char>
#> 1:             -16 (17 -- -6.1)
#> 2:             -24 (19 -- -7.3)
