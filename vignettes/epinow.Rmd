...
#> '/tmp/RtmpovkQm4/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to the console and:
#> '/tmp/RtmpovkQm4/epinow/2020-04-21.log'.
res$plots$R
```
...
#> INFO [2025-02-01 00:29:29] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/RtmpovkQm4/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/RtmpovkQm4/epinow/2020-04-21.log'.
#> INFO [2025-02-01 00:29:29] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-02-01 00:29:29] No target directory specified so returning output
#> INFO [2025-02-01 00:29:29] Producing estimates for: testland, realland
#> INFO [2025-02-01 00:29:29] Regions excluded: none
#> INFO [2025-02-01 00:32:20] Completed estimates for: testland
#> INFO [2025-02-01 00:33:27] Completed estimates for: realland
#> INFO [2025-02-01 00:33:27] Completed regional estimates
#> INFO [2025-02-01 00:33:27] Regions with estimates: 2
#> INFO [2025-02-01 00:33:27] Regions with runtime errors: 0
#> INFO [2025-02-01 00:33:27] Producing summary
#> INFO [2025-02-01 00:33:27] No summary directory specified so returning summary output
#> INFO [2025-02-01 00:33:27] No target directory specified so returning timings
## summary
...
#> INFO [2025-02-01 00:33:28] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/RtmpovkQm4/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/RtmpovkQm4/epinow/2020-04-21.log'.
#> INFO [2025-02-01 00:33:28] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-02-01 00:33:28] No target directory specified so returning output
#> INFO [2025-02-01 00:33:28] Producing estimates for: testland, realland
#> INFO [2025-02-01 00:33:28] Regions excluded: none
#> INFO [2025-02-01 00:34:33] Completed estimates for: testland
#> INFO [2025-02-01 00:35:03] Completed estimates for: realland
#> INFO [2025-02-01 00:35:03] Completed regional estimates
#> INFO [2025-02-01 00:35:03] Regions with estimates: 2
#> INFO [2025-02-01 00:35:03] Regions with runtime errors: 0
#> INFO [2025-02-01 00:35:03] Producing summary
#> INFO [2025-02-01 00:35:03] No summary directory specified so returning summary output
#> INFO [2025-02-01 00:35:03] No target directory specified so returning timings
## summary
