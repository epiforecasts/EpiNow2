...
#> '/tmp/Rtmpd8yKjK/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to the console and:
#> '/tmp/Rtmpd8yKjK/epinow/2020-04-21.log'.
res$plots$R
...
#> INFO [2026-02-01 00:42:28] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmpd8yKjK/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmpd8yKjK/epinow/2020-04-21.log'.
#> INFO [2026-02-01 00:42:28] Reporting estimates using data up to: 2020-04-21
#> 
#> INFO [2026-02-01 00:42:28] No target directory specified so returning output
#> 
#> INFO [2026-02-01 00:42:28] Producing estimates for: testland, realland
#> 
#> INFO [2026-02-01 00:42:28] Regions excluded: none
...
#> Call `lifecycle::last_lifecycle_warnings()` to see where this warning was
#> generated.
#> INFO [2026-02-01 00:43:38] Completed estimates for: testland
#> INFO [2026-02-01 00:44:39] Completed estimates for: realland
#> INFO [2026-02-01 00:44:39] Completed regional estimates
#> INFO [2026-02-01 00:44:39] Regions with estimates: 2
#> INFO [2026-02-01 00:44:39] Regions with runtime errors: 0
#> INFO [2026-02-01 00:44:39] Producing summary
#> INFO [2026-02-01 00:44:39] No summary directory specified so returning summary output
#> INFO [2026-02-01 00:44:42] No target directory specified so returning timings
## summary
...
#> INFO [2026-02-01 00:44:43] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmpd8yKjK/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmpd8yKjK/epinow/2020-04-21.log'.
#> INFO [2026-02-01 00:44:43] Reporting estimates using data up to: 2020-04-21
#> 
#> INFO [2026-02-01 00:44:43] No target directory specified so returning output
#> 
#> INFO [2026-02-01 00:44:43] Producing estimates for: testland, realland
#> 
#> INFO [2026-02-01 00:44:43] Regions excluded: none
#> 
#> INFO [2026-02-01 00:45:50] Completed estimates for: testland
#> 
#> INFO [2026-02-01 00:47:02] Completed estimates for: realland
#> 
#> INFO [2026-02-01 00:47:02] Completed regional estimates
#> 
#> INFO [2026-02-01 00:47:02] Regions with estimates: 2
#> 
#> INFO [2026-02-01 00:47:02] Regions with runtime errors: 0
#> 
#> INFO [2026-02-01 00:47:02] Producing summary
#> 
#> INFO [2026-02-01 00:47:02] No summary directory specified so returning summary output
#> 
#> INFO [2026-02-01 00:47:05] No target directory specified so returning timings
## summary
