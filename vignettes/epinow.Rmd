...
#> '/tmp/RtmpFO3sUz/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to the console and:
#> '/tmp/RtmpFO3sUz/epinow/2020-04-21.log'.
#> WARN [2025-10-01 00:35:07] epinow: There were 3 divergent transitions after warmup. See
#> https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#> to find out why this is a problem and how to eliminate them. - 
#> WARN [2025-10-01 00:35:07] epinow: Examine the pairs() plot to diagnose sampling problems
#>  -
res$plots$R
```
...
#> INFO [2025-10-01 00:35:11] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/RtmpFO3sUz/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/RtmpFO3sUz/epinow/2020-04-21.log'.
#> INFO [2025-10-01 00:35:11] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-10-01 00:35:11] No target directory specified so returning output
#> INFO [2025-10-01 00:35:11] Producing estimates for: testland, realland
#> INFO [2025-10-01 00:35:11] Regions excluded: none
#> INFO [2025-10-01 00:36:15] Completed estimates for: testland
#> INFO [2025-10-01 00:37:17] Completed estimates for: realland
#> INFO [2025-10-01 00:37:17] Completed regional estimates
#> INFO [2025-10-01 00:37:17] Regions with estimates: 2
#> INFO [2025-10-01 00:37:17] Regions with runtime errors: 0
#> INFO [2025-10-01 00:37:17] Producing summary
#> INFO [2025-10-01 00:37:17] No summary directory specified so returning summary output
#> INFO [2025-10-01 00:37:18] No target directory specified so returning timings
## summary
...
#> INFO [2025-10-01 00:37:18] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/RtmpFO3sUz/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/RtmpFO3sUz/epinow/2020-04-21.log'.
#> INFO [2025-10-01 00:37:18] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-10-01 00:37:18] No target directory specified so returning output
#> INFO [2025-10-01 00:37:18] Producing estimates for: testland, realland
#> INFO [2025-10-01 00:37:18] Regions excluded: none
#> INFO [2025-10-01 00:38:24] Completed estimates for: testland
#> INFO [2025-10-01 00:38:54] Completed estimates for: realland
#> INFO [2025-10-01 00:38:54] Completed regional estimates
#> INFO [2025-10-01 00:38:54] Regions with estimates: 2
#> INFO [2025-10-01 00:38:54] Regions with runtime errors: 0
#> INFO [2025-10-01 00:38:54] Producing summary
#> INFO [2025-10-01 00:38:54] No summary directory specified so returning summary output
#> INFO [2025-10-01 00:38:55] No target directory specified so returning timings
## summary
