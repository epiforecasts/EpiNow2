...
#> '/tmp/Rtmp5U6QD8/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to the console and:
#> '/tmp/Rtmp5U6QD8/epinow/2020-04-21.log'.
res$plots$R
```
...
#> INFO [2025-03-01 00:31:20] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmp5U6QD8/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmp5U6QD8/epinow/2020-04-21.log'.
#> INFO [2025-03-01 00:31:20] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-03-01 00:31:20] No target directory specified so returning output
#> INFO [2025-03-01 00:31:20] Producing estimates for: testland, realland
#> INFO [2025-03-01 00:31:20] Regions excluded: none
#> INFO [2025-03-01 00:34:09] Completed estimates for: testland
#> INFO [2025-03-01 00:35:14] Completed estimates for: realland
#> INFO [2025-03-01 00:35:14] Completed regional estimates
#> INFO [2025-03-01 00:35:14] Regions with estimates: 2
#> INFO [2025-03-01 00:35:14] Regions with runtime errors: 0
#> INFO [2025-03-01 00:35:14] Producing summary
#> INFO [2025-03-01 00:35:14] No summary directory specified so returning summary output
#> INFO [2025-03-01 00:35:15] No target directory specified so returning timings
## summary
...
#> INFO [2025-03-01 00:35:15] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmp5U6QD8/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmp5U6QD8/epinow/2020-04-21.log'.
#> INFO [2025-03-01 00:35:15] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-03-01 00:35:15] No target directory specified so returning output
#> INFO [2025-03-01 00:35:15] Producing estimates for: testland, realland
#> INFO [2025-03-01 00:35:15] Regions excluded: none
#> INFO [2025-03-01 00:36:19] Completed estimates for: testland
#> INFO [2025-03-01 00:36:49] Completed estimates for: realland
#> INFO [2025-03-01 00:36:49] Completed regional estimates
#> INFO [2025-03-01 00:36:49] Regions with estimates: 2
#> INFO [2025-03-01 00:36:49] Regions with runtime errors: 0
#> INFO [2025-03-01 00:36:49] Producing summary
#> INFO [2025-03-01 00:36:49] No summary directory specified so returning summary output
#> INFO [2025-03-01 00:36:50] No target directory specified so returning timings
## summary
