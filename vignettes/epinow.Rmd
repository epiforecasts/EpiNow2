...
#>      <char>                 <char>                     <fctr>
#> 1: realland    2314 (1389 -- 3754)          Likely decreasing
#> 2: testland    2221 (1355 -- 3806)          Likely decreasing
#>    Effective reproduction no.           Rate of growth
#>                        <char>                   <char>
#> 1:          0.9 (0.72 -- 1.1) -0.027 (-0.094 -- 0.037)
#> 2:          0.89 (0.7 -- 1.1) -0.029 (-0.096 -- 0.041)
...
#>      Region New infections per day Expected change in reports
#>      <char>                 <char>                     <fctr>
#> 1: realland    2000 (1066 -- 3850)          Likely decreasing
#> 2: testland    2255 (1357 -- 3770)          Likely decreasing
#>    Effective reproduction no.          Rate of growth
#>                        <char>                  <char>
#> 1:         0.85 (0.61 -- 1.1) -0.041 (-0.11 -- 0.035)
#> 2:           0.9 (0.7 -- 1.1) -0.028 (-0.096 -- 0.04)
#>    Doubling/halving time (days)
#>                          <char>
#> 1:             -17 (20 -- -6.2)
#> 2:             -25 (17 -- -7.2)
