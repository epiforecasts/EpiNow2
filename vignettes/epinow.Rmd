...
#> '/tmp/Rtmpzk63q4/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to the console and:
#> '/tmp/Rtmpzk63q4/epinow/2020-04-21.log'.
res$plots$R
```
...
#> INFO [2025-01-31 17:33:05] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmpzk63q4/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmpzk63q4/epinow/2020-04-21.log'.
#> INFO [2025-01-31 17:33:05] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-01-31 17:33:05] No target directory specified so returning output
#> INFO [2025-01-31 17:33:05] Producing estimates for: testland, realland
#> INFO [2025-01-31 17:33:05] Regions excluded: none
#> INFO [2025-01-31 17:36:01] Completed estimates for: testland
#> INFO [2025-01-31 17:37:08] Completed estimates for: realland
#> INFO [2025-01-31 17:37:08] Completed regional estimates
#> INFO [2025-01-31 17:37:08] Regions with estimates: 2
#> INFO [2025-01-31 17:37:08] Regions with runtime errors: 0
#> INFO [2025-01-31 17:37:08] Producing summary
#> INFO [2025-01-31 17:37:08] No summary directory specified so returning summary output
#> INFO [2025-01-31 17:37:08] No target directory specified so returning timings
## summary
...
#> INFO [2025-01-31 17:37:09] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmpzk63q4/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmpzk63q4/epinow/2020-04-21.log'.
#> INFO [2025-01-31 17:37:09] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-01-31 17:37:09] No target directory specified so returning output
#> INFO [2025-01-31 17:37:09] Producing estimates for: testland, realland
#> INFO [2025-01-31 17:37:09] Regions excluded: none
#> INFO [2025-01-31 17:38:15] Completed estimates for: testland
#> INFO [2025-01-31 17:38:45] Completed estimates for: realland
#> INFO [2025-01-31 17:38:45] Completed regional estimates
#> INFO [2025-01-31 17:38:45] Regions with estimates: 2
#> INFO [2025-01-31 17:38:45] Regions with runtime errors: 0
#> INFO [2025-01-31 17:38:45] Producing summary
#> INFO [2025-01-31 17:38:45] No summary directory specified so returning summary output
#> INFO [2025-01-31 17:38:45] No target directory specified so returning timings
## summary
