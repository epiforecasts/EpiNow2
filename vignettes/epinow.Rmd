...
#> '/tmp/Rtmp8za5TM/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to the console and:
#> '/tmp/Rtmp8za5TM/epinow/2020-04-21.log'.
#> WARN [2025-08-01 00:38:17] epinow: There were 3 divergent transitions after warmup. See
#> https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#> to find out why this is a problem and how to eliminate them. - 
#> WARN [2025-08-01 00:38:17] epinow: Examine the pairs() plot to diagnose sampling problems
#>  -
res$plots$R
```
...
#> INFO [2025-08-01 00:38:21] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmp8za5TM/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmp8za5TM/epinow/2020-04-21.log'.
#> INFO [2025-08-01 00:38:21] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-08-01 00:38:21] No target directory specified so returning output
#> INFO [2025-08-01 00:38:21] Producing estimates for: testland, realland
#> INFO [2025-08-01 00:38:21] Regions excluded: none
#> INFO [2025-08-01 00:39:26] Completed estimates for: testland
#> INFO [2025-08-01 00:40:27] Completed estimates for: realland
#> INFO [2025-08-01 00:40:27] Completed regional estimates
#> INFO [2025-08-01 00:40:27] Regions with estimates: 2
#> INFO [2025-08-01 00:40:27] Regions with runtime errors: 0
#> INFO [2025-08-01 00:40:27] Producing summary
#> INFO [2025-08-01 00:40:27] No summary directory specified so returning summary output
#> INFO [2025-08-01 00:40:28] No target directory specified so returning timings
## summary
...
#> INFO [2025-08-01 00:40:28] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/Rtmp8za5TM/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/Rtmp8za5TM/epinow/2020-04-21.log'.
#> INFO [2025-08-01 00:40:28] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-08-01 00:40:28] No target directory specified so returning output
#> INFO [2025-08-01 00:40:28] Producing estimates for: testland, realland
#> INFO [2025-08-01 00:40:28] Regions excluded: none
#> INFO [2025-08-01 00:41:27] Completed estimates for: testland
#> INFO [2025-08-01 00:41:57] Completed estimates for: realland
#> INFO [2025-08-01 00:41:57] Completed regional estimates
#> INFO [2025-08-01 00:41:57] Regions with estimates: 2
#> INFO [2025-08-01 00:41:57] Regions with runtime errors: 0
#> INFO [2025-08-01 00:41:57] Producing summary
#> INFO [2025-08-01 00:41:57] No summary directory specified so returning summary output
#> INFO [2025-08-01 00:41:57] No target directory specified so returning timings
## summary
