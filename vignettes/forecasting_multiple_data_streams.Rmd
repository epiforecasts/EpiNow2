...
#> ℹ To silence this message, specify delay distributions with `max` or `default_cdf_cutoff`.
```
...
![plot of chunk show-data](forecasting_multiple_data_streams-show-data-1.png)
...
![plot of chunk combined-plot](forecasting_multiple_data_streams-combined-plot-1.png)
