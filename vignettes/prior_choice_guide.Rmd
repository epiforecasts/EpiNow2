...
- You're analyzing a well-characterized pathogen (e.g., measles with $R_0$ typically 12-18)
...
- **Warning**: This is a less epidemiologically informed model than the renewal equation model and may lead to undesired behavior, particularly when extrapolating or forecasting
