...
| **Observation model** |
| Scaling | `obs_opts()` | `scale` | `Fixed(1)` | Fraction of primary events leading to secondary (shared parameter with `estimate_infections()`) |
...
**Example:**
```{r scaling-examples}
# estimate_infections(): Estimating with informative prior based on serology study
