...
#>  1 params[1]              1.02 
#>  2 params[2]              1.07 
#>  3 initial_infections[1]  1.06 
#>  4 delay_params[1]        0.999
#>  5 delay_params[2]        1.01 
#>  6 delay_params[3]        1.03 
#>  7 delay_params[4]        1.13 
#>  8 day_of_week_simplex[1] 1.02 
#>  9 day_of_week_simplex[2] 0.995
#> 10 day_of_week_simplex[3] 1.01 
#> # ℹ 588 more rows
...
#>    <chr>                     <dbl>    <dbl>
#>  1 params[1]                  91.2     96.2
#>  2 params[2]                  42.9    120. 
#>  3 initial_infections[1]      45.2     57.2
#>  4 delay_params[1]            93.4     46.0
#>  5 delay_params[2]           115.      79.9
#>  6 delay_params[3]            71.2     46.0
#>  7 delay_params[4]            78.9     24.5
#>  8 day_of_week_simplex[1]    135.      82.0
#>  9 day_of_week_simplex[2]     99.4     65.6
#> 10 day_of_week_simplex[3]     83.5     60.3
#> # ℹ 588 more rows
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2140 (1254 -- 3446)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.      0.88 (0.68 -- 1.1)
#> 4:               Rate of growth -0.033 (-0.11 -- 0.048)
#> 5: Doubling/halving time (days)        -21 (14 -- -6.5)
```
