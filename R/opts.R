...
#' 'matern_order = Inf'), 3 over 2 Matern ' kernel ("matern", with
#' `matern_order = 3/2` (default)), or Orstein-Uhlenbeck ("ou", or "matern"
#' with 'matern_order = 1/2'). Defaulting to the Matern 3 over
#' 2 kernel for a balance of smoothness and discontinuities.
#'
