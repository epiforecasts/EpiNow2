...
#'
#' @description \lifecycle{stable} 
#' Takes the output of `obs_opts` and convrts it into a list understood by `stan`.
...
#'
#' @description \lifecycle{stable} 
#' Generates a list of arguments as required by `rstan::sampling` (when `stan_args$method = "sampling`) 
#' or `rstan::vb` (when `stan_args$method = "vb`) by combining the required options, with data, and type of 
#' initilisation. Initialisation defaults to random but it is expected that `create_initial_conditions` will
#' be used.
