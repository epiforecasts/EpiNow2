...
#'
#' @description \code{r lifecycle::badge("experimental")}
#' Returns parameter summary statistics for the fitted delay
#' distribution model.
#'
#' @param object A fitted model object from \code{estimate_dist()}
#' @inheritParams calc_summary_measures
#' @param ... Additional arguments (currently unused)
#'
#' @return A \code{<data.table>} with summary statistics for the delay
#'   distribution parameters.
