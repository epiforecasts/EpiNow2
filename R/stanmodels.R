...
stanmodels <- c("dist_fit", "estimate_dist", "estimate_infections", "estimate_secondary", "estimate_truncation", "simulate_infections", "simulate_secondary")

# load each stan module
Rcpp::loadModule("stan_fit4dist_fit_mod", what = TRUE)
Rcpp::loadModule("stan_fit4estimate_dist_mod", what = TRUE)
