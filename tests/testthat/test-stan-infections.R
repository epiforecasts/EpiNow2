...
test_that("generate_infections works as expected", {
  ...
  expect_equal(round(generate_infections(c(1, rep(1.1, 9)), 10, 3, 2, 15, log(100), 0, 0 ,0), 0),
               c(rep(100, 11), 110, 113, 116, 120, 125, 129, 133, 138, 143))
  expect_equal(round(generate_infections(c(1, rep(1, 9)), 4, 3, 2, 15, log(500), -0.02, 0 ,0), 0),
               c(500, 490, 480, 471, 402, 413, 417, 417, rep(418, 6)))
  expect_equal(round(generate_infections(c(1, rep(1.1, 9)), 4, 3, 2, 15, log(500), 0, 0 ,0), 0),
               c(rep(500, 4), 416, 472, 490, 507, 524, 543, 562, 581, 601, 622))
  expect_equal(round(generate_infections(c(1, rep(1, 9)), 1, 3, 2, 15, log(40), numeric(0), 0 ,0), 0),
               c(40, 11, 13, rep(14, 8)))
