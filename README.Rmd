...
A pre-built [docker](https://www.docker.com/) image is also available For simple deployment/development (see documentation [here](https://github.com/epiforecasts/EpiNow2/wiki/Docker)).
