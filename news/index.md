...
- [`estimate_truncation()`](https://epiforecasts.io/EpiNow2/reference/estimate_truncation.md)
  now warns via
  [`check_truncation_obs_opts()`](https://epiforecasts.io/EpiNow2/reference/check_truncation_obs_opts.md)
  when
  [`obs_opts()`](https://epiforecasts.io/EpiNow2/reference/obs_opts.md)
...
- Added
  [`Exp()`](https://epiforecasts.io/EpiNow2/reference/Distributions.md),
  [`Weibull()`](https://epiforecasts.io/EpiNow2/reference/Distributions.md),
  and
  [`Normal()`](https://epiforecasts.io/EpiNow2/reference/Distributions.md)
  distribution constructors.
- Added
  [`Dirichlet()`](https://epiforecasts.io/EpiNow2/reference/Distributions.md)
  and updated
...
- Added a shared internal helper
  [`check_simulation_input()`](https://epiforecasts.io/EpiNow2/reference/check_simulation_input.md)
...
- Added
  [`as_forecast_sample()`](https://epiforecasts.io/EpiNow2/reference/as_forecast_sample.md)
...
- Changed the non-stationary Gaussian process used to model Rt to sample
  ...
  `prior` argument in
  [`rt_opts()`](https://epiforecasts.io/EpiNow2/reference/rt_opts.md) is
  still the prior on the initial Rt. Implemented by sampling the
...
- Fixed a bug where the `target_date` argument to
  [`epinow()`](https://epiforecasts.io/EpiNow2/reference/epinow.md) was
  silently ignored: the recomputed forecast horizon from
