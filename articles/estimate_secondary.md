...
cumulative mass function for time $`t`$ minus the cumulative mass
...
reporting overdispersion via $`\varphi`$ and adjust expected counts
using an optional day of the week effect based on a simplex
