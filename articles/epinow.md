...
definitions](https://epiforecasts.io/EpiNow2/articles/estimate_infections.md)
vignette
...
#>      <char>                 <char>                     <fctr>
#> 1: realland    2249 (1388 -- 3630)          Likely decreasing
#> 2: testland    2250 (1378 -- 3720)          Likely decreasing
#>    Effective reproduction no.           Rate of growth
#>                        <char>                   <char>
#> 1:         0.89 (0.71 -- 1.1) -0.028 (-0.093 -- 0.036)
#> 2:         0.89 (0.71 -- 1.1) -0.029 (-0.095 -- 0.042)
...
#>      Region New infections per day Expected change in reports
#>      <char>                 <char>                     <fctr>
#> 1: realland    2037 (1024 -- 3864)          Likely decreasing
#> 2: testland      1975 (46 -- 3612)          Likely decreasing
#>    Effective reproduction no.           Rate of growth
#>                        <char>                   <char>
#> 1:         0.85 (0.62 -- 1.2)   -0.04 (-0.11 -- 0.038)
#> 2:         0.95 (0.74 -- 1.7) -0.011 (-0.086 -- 0.049)
#>    Doubling/halving time (days)
#>                          <char>
#> 1:             -17 (18 -- -6.2)
#> 2:               -60 (14 -- -8)
