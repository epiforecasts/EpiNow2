...
[`vignette("EpiNow2")`](https://epiforecasts.io/EpiNow2/articles/EpiNow2.md))
...
[`vignette("estimate_infections_workflow")`](https://epiforecasts.io/EpiNow2/articles/estimate_infections_workflow.md))
...
[`vignette("model_overview")`](https://epiforecasts.io/EpiNow2/articles/model_overview.md).
A quick reference to all modelling options is in
[`vignette("model_features")`](https://epiforecasts.io/EpiNow2/articles/model_features.md).
Mathematical definitions of each model are in their own vignettes, e.g.
[`vignette("estimate_infections")`](https://epiforecasts.io/EpiNow2/articles/estimate_infections.md).
