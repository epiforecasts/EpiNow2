...
- [`as_forecast_sample(`*`<estimate_infections>`*`)`](https://epiforecasts.io/EpiNow2/reference/as_forecast_sample.md)
  [`as_forecast_sample(`*`<epinow>`*`)`](https://epiforecasts.io/EpiNow2/reference/as_forecast_sample.md)
  [`as_forecast_sample(`*`<forecast_secondary>`*`)`](https://epiforecasts.io/EpiNow2/reference/as_forecast_sample.md)
  [`as_forecast_sample(`*`<estimate_truncation>`*`)`](https://epiforecasts.io/EpiNow2/reference/as_forecast_sample.md)
  **\[experimental\]** :
...
- [`summary(`*`<epinow>`*`)`](https://epiforecasts.io/EpiNow2/reference/summary.epinow.md)
  : Summary output from epinow
- [`summary(`*`<estimate_dist>`*`)`](https://epiforecasts.io/EpiNow2/reference/summary.estimate_dist.md)
...
- [`build_np_est_data()`](https://epiforecasts.io/EpiNow2/reference/build_np_est_data.md)
...
- [`dist_id_to_name()`](https://epiforecasts.io/EpiNow2/reference/dist_id_to_name.md)
  : Get distribution name from primarycensored Stan dist_id

- [`.extract_to_dist_spec()`](https://epiforecasts.io/EpiNow2/reference/dot-extract_to_dist_spec.md)
  : Extract parameters and convert to dist_spec

- [`.get_dist_id()`](https://epiforecasts.io/EpiNow2/reference/dot-get_dist_id.md)
  : Map distribution name to primarycensored ID

- [`.get_param_names()`](https://epiforecasts.io/EpiNow2/reference/dot-get_param_names.md)
  : Map distribution name to parameter names

- [`.prepare_linelist_data()`](https://epiforecasts.io/EpiNow2/reference/dot-prepare_linelist_data.md)
...
- [`get_accumulate()`](https://epiforecasts.io/EpiNow2/reference/get_accumulate.md)
...
- [`make_init_priors()`](https://epiforecasts.io/EpiNow2/reference/make_init_priors.md)
...
- [`nonparametric_pmf_data()`](https://epiforecasts.io/EpiNow2/reference/nonparametric_pmf_data.md)
  :

  Build PMF data for the nonparametric branch of `plot.dist_spec`

- [`pack_init_prior()`](https://epiforecasts.io/EpiNow2/reference/pack_init_prior.md)
...
- [`rdirichlet()`](https://epiforecasts.io/EpiNow2/reference/rdirichlet.md)
