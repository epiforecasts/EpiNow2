...
Sets up default logging. Usage of logging is currently being explored as
the current setup cannot log stan errors or progress.
...
- mirror_epinow:
  ...
  [`epinow()`](https://epiforecasts.io/EpiNow2/reference/epinow.md) to
  the console.
...
#> /tmp/RtmpSo3E8N/regional-epinow/latest.log.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: /tmp/RtmpSo3E8N/epinow/latest.log.
```
