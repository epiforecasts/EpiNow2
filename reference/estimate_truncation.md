...
#> /tmp/Rtmp7Yu1RB/regional-epinow/2020-04-21.log.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to the console and:
#> /tmp/Rtmp7Yu1RB/epinow/2020-04-21.log.
#> WARN [2026-02-05 11:39:12] epinow: There were 1 divergent transitions after warmup. See
#> https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#> to find out why this is a problem and how to eliminate them. - 
#> WARN [2026-02-05 11:39:12] epinow: Examine the pairs() plot to diagnose sampling problems
#>  - 
plot(out)
