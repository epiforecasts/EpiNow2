...
- [Infection
  ...
  [`estimate_infections()`](https://epiforecasts.io/EpiNow2/dev/reference/estimate_infections.md)
  - [Gaussian process
    implementation](https://epiforecasts.io/EpiNow2/dev/articles/gaussian_process_implementation_details.md)
...
- [Distribution
  ...
  [`estimate_dist()`](https://epiforecasts.io/EpiNow2/dev/reference/estimate_dist.md)
  - [Understanding delay
    distributions](https://epiforecasts.io/EpiNow2/dev/articles/delays.md)
...
- [epinow() and
  regional_epinow()](https://epiforecasts.io/EpiNow2/dev/articles/epinow.md)
  — wrappers for production runs

**Case studies**

- [External case
  studies](https://epiforecasts.io/EpiNow2/dev/articles/case-studies.md)
