...
variants](https://epiforecasts.io/EpiNow2/dev/articles/estimate_infections_options.md)
and [theoretical
background](https://epiforecasts.io/EpiNow2/dev/articles/estimate_infections.md).
...
or the [delays
vignette](https://epiforecasts.io/EpiNow2/dev/articles/delays.md) for
background on how EpiNow2 handles delay distributions.
...
options](https://epiforecasts.io/EpiNow2/dev/articles/estimate_infections_options.md)
...
forecast horizons. *EpiNow2* provides an
[`as_forecast_sample()`](https://epiforecasts.io/EpiNow2/dev/reference/as_forecast_sample.md)
method that converts the output of
[`estimate_infections()`](https://epiforecasts.io/EpiNow2/dev/reference/estimate_infections.md)
(and related functions) directly into a `forecast_sample` object from
...
score the 7-day forecast against the full dataset. By default the
forecast classes only keep horizons `>= 0` (i.e. the forecast period);
pass a numeric `horizon` argument to set a different lower bound,
e.g. `horizon = -Inf` to include the in-sample period.

``` r

library(scoringutils)

forecast_obj <- as_forecast_sample(def, observations = example_confirmed)
forecast_obj
#> Forecast type: sample
#> Forecast unit:
#> forecast_date, date, and horizon
#> 
#> Key: <date>
#>        sample_id predicted observed forecast_date       date horizon
#>            <int>     <num>    <num>        <Date>     <Date>   <num>
#>     1:         1      4125     2256    2020-04-21 2020-04-21       0
#>     2:         2      2998     2256    2020-04-21 2020-04-21       0
#>     3:         3      3046     2256    2020-04-21 2020-04-21       0
#>     4:         4      1955     2256    2020-04-21 2020-04-21       0
#>     5:         5      2405     2256    2020-04-21 2020-04-21       0
#>    ---                                                              
#> 15996:      1996      2076     1739    2020-04-21 2020-04-28       7
#> 15997:      1997      2030     1739    2020-04-21 2020-04-28       7
#> 15998:      1998      2262     1739    2020-04-21 2020-04-28       7
#> 15999:      1999      2466     1739    2020-04-21 2020-04-28       7
#> 16000:      2000      1879     1739    2020-04-21 2020-04-28       7
score(forecast_obj)
...
#> 1:    2020-04-21 2020-04-21       0  0.4850 13.04661 198.3709         76.512
#> 2:    2020-04-21 2020-04-22       1 -0.6490 13.18881 280.7676          0.000
#> 3:    2020-04-21 2020-04-23       2 -0.8765 15.32767 644.1193          0.000
#> 4:    2020-04-21 2020-04-24       3  0.2455 13.46619 199.1018         25.889
#> 5:    2020-04-21 2020-04-25       4 -0.5185 13.48990 300.4347          0.000
#> 6:    2020-04-21 2020-04-26       5  0.4220 13.93565 277.3292         89.420
#> 7:    2020-04-21 2020-04-27       6  0.2085 13.70210 208.8598         20.366
#> 8:    2020-04-21 2020-04-28       7  0.4455 13.85165 268.4963         93.588
#>    underprediction dispersion log_score      mad ae_median  se_mean
#>              <num>      <num>     <num>    <num>     <num>    <num>
#> 1:           0.000   121.8589  7.290212 521.8752     312.0 133115.2
#> 2:         169.877   110.8906  7.644723 484.8102     493.0 191953.1
#> 3:         515.757   128.3623  8.563567 541.1490     981.5 839623.1
#> 4:           0.000   173.2128  7.499891 727.2153     227.0 101155.5
#> 5:         144.663   155.7717  7.833351 684.9612     505.0 187393.8
#> 6:           0.000   187.9092  7.620466 779.8476     426.5 294898.4
#> 7:           0.000   188.4938  7.569638 793.1910     195.0 107901.4
#> 8:           0.000   174.9083  7.567015 747.9717     417.0 285137.3
```
