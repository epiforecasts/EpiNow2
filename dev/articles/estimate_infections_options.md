...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2251 (1414 -- 3706)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.73 -- 1.1)
#> 4:               Rate of growth -0.029 (-0.089 -- 0.037)
#> 5: Doubling/halving time (days)         -24 (19 -- -7.8)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 23.207 15.103
#> chain:2 24.366 15.002
#> chain:3 24.205 14.943
#> chain:4 28.651 11.716
# summary plot
plot(def)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2245 (1370 -- 3707)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.71 -- 1.1)
#> 4:               Rate of growth -0.028 (-0.094 -- 0.039)
#> 5: Doubling/halving time (days)         -25 (18 -- -7.4)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 19.110 12.892
#> chain:2 15.982  9.130
#> chain:3 27.181 11.229
#> chain:4 21.628 16.345
# summary plot
plot(agp)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2237 (1362 -- 3628)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.       0.89 (0.7 -- 1.1)
#> 4:               Rate of growth -0.03 (-0.098 -- 0.037)
#> 5: Doubling/halving time (days)        -23 (19 -- -7.1)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 34.608  9.113
#> chain:2 30.547 12.955
#> chain:3 33.781 14.857
#> chain:4 33.949  9.299
# summary plot
plot(dep)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     3543 (2113 -- 6198)
#> 2:   Expected change in reports       Likely increasing
#> 3:   Effective reproduction no.         1 (0.83 -- 1.3)
#> 4:               Rate of growth 0.015 (-0.055 -- 0.096)
#> 5: Doubling/halving time (days)         46 (7.2 -- -13)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 24.740  8.814
#> chain:2 23.796  9.215
#> chain:3 22.946  8.801
#> chain:4 20.044 14.918
# summary plot
plot(trunc)
```
...
#> https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#> to find out why this is a problem and how to eliminate them.
#> Warning: There were 12 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 12. See
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2268 (1345 -- 3720)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.71 -- 1.1)
#> 4:               Rate of growth -0.026 (-0.097 -- 0.042)
#> 5: Doubling/halving time (days)         -26 (16 -- -7.1)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup  sample
#> chain:1 25.907 149.357
#> chain:2 28.896   9.798
#> chain:3 26.595  11.023
#> chain:4 26.153  11.122
# summary plot
plot(project_rt)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day 18911 (10947 -- 34488)
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2308 (1941 -- 2783)
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    2036 (1068 -- 3789)
#> 2:   Expected change in reports      Likely decreasing
#> 3:   Effective reproduction no.     0.85 (0.62 -- 1.1)
#> 4:               Rate of growth -0.04 (-0.11 -- 0.036)
#> 5: Doubling/halving time (days)       -17 (19 -- -6.5)
# elapsed time (in seconds)
...
#>                         measure                   estimate
#>                          <char>                     <char>
#> 1:       New infections per day        2795 (2409 -- 3246)
#> 2:   Expected change in reports                 Decreasing
#> 3:   Effective reproduction no.        0.88 (0.81 -- 0.97)
#> 4:               Rate of growth -0.032 (-0.062 -- -0.0015)
#> 5: Doubling/halving time (days)          -22 (-450 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 23.287 14.003
#> chain:2 30.413 13.213
#> chain:3 10.672 14.402
#> chain:4 26.273 12.781
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2543 (2504 -- 2581)
#> 2:   Expected change in reports                Decreasing
