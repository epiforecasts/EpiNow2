...
[`vignette("model_overview")`](https://epiforecasts.io/EpiNow2/dev/articles/model_overview.md).
A quick reference to all modelling options is in
[`vignette("model_features")`](https://epiforecasts.io/EpiNow2/dev/articles/model_features.md).
...
[jackUKHSA](https://github.com/epiforecasts/EpiNow2/issues?q=is%3Aissue+commenter%3AjackUKHSA)
