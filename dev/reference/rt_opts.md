...
- pop:
  ...
  floor used when population adjustment is enabled.
...
- pop_period:
  ...
  adjustment to forecasts while "all" applies it to both data and
  forecasts. Note that with "all" and "forecast", Rt estimates are
  unadjusted for susceptible depletion but posterior predictions of
  infections and reports are adjusted.
