...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      3413 (1900 -- 5048)
#> 2:   Expected change in reports               Decreasing
#> 3:   Effective reproduction no.       0.8 (0.64 -- 0.95)
#> 4:               Rate of growth -0.069 (-0.13 -- -0.014)
#> 5: Doubling/halving time (days)        -10 (-49 -- -5.3)
# summary plot
plot(def)
