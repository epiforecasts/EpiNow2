...
- weigh_delay_priors:
  ...
  Deprecated; this is now specified at the distribution level in
  [`generation_time_opts()`](https://epiforecasts.io/EpiNow2/dev/reference/generation_time_opts.md),
  [`delay_opts()`](https://epiforecasts.io/EpiNow2/dev/reference/delay_opts.md)
  and
  [`trunc_opts()`](https://epiforecasts.io/EpiNow2/dev/reference/trunc_opts.md)
  using the `weight_prior` argument.
...
An `<estimate_infections>` object which is a list of outputs including:
...
to access predicted reported cases.
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day       1872 (808 -- 4135)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.72 -- 1.1)
#> 4:               Rate of growth -0.028 (-0.082 -- 0.024)
#> 5: Doubling/halving time (days)         -24 (29 -- -8.4)
# summary plot
plot(def)
