...
- [`apply_tolerance()`](https://epiforecasts.io/EpiNow2/dev/reference/apply_tolerance.md)
  **\[deprecated\]** : Applies a threshold to all nonparametric
  distributions in a \<dist_spec\>
...
- [`default_fill_missing_obs()`](https://epiforecasts.io/EpiNow2/dev/reference/default_fill_missing_obs.md)
...
- [`dist_skel()`](https://epiforecasts.io/EpiNow2/dev/reference/dist_skel.md)
...
- [`extract_parameter()`](https://epiforecasts.io/EpiNow2/dev/reference/extract_parameter.md)
