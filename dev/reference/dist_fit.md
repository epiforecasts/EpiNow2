...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Dec 12 10:55:51 2025.
...
#> Chain 1: Iteration: 1500 / 1500 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.669 seconds (Warm-up)
#> Chain 1:                1.111 seconds (Sampling)
#> Chain 1:                3.78 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'dist_fit' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2:                1.231 seconds (Sampling)
#> Chain 2:                3.792 seconds (Total)
#> Chain 2: 
#> Inference for Stan model: dist_fit.
#> 2 chains, each with iter=1500; warmup=1000; thin=1; 
#> post-warmup draws per chain=500, total post-warmup draws=1000.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Dec 12 10:55:59 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Dec 12 10:56:00 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
# }
