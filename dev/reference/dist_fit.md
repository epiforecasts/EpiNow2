...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Dec  5 19:52:12 2025.
...
#> Chain 2: Iteration: 1500 / 1500 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.527 seconds (Warm-up)
#> Chain 2:                1.209 seconds (Sampling)
...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Dec  5 19:52:20 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Dec  5 19:52:21 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
# }
