...
- output:
  ...
  the stan fit of the underlying model ("fit"), and an overall summary
  across regions ("summary"). The default is to return samples and plots
...
#> INFO [2025-11-19 13:41:13] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> /tmp/Rtmp5qooV2/regional-epinow/2020-04-21.log.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: /tmp/Rtmp5qooV2/epinow/2020-04-21.log.
#> INFO [2025-11-19 13:41:13] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-11-19 13:41:13] No target directory specified so returning output
#> INFO [2025-11-19 13:41:13] Producing estimates for: testland, realland
#> INFO [2025-11-19 13:41:13] Regions excluded: none
#> INFO [2025-11-19 13:42:20] Completed estimates for: testland
#> INFO [2025-11-19 13:43:26] Completed estimates for: realland
#> INFO [2025-11-19 13:43:26] Completed regional estimates
#> INFO [2025-11-19 13:43:26] Regions with estimates: 2
#> INFO [2025-11-19 13:43:26] Regions with runtime errors: 0
#> INFO [2025-11-19 13:43:26] Producing summary
#> INFO [2025-11-19 13:43:26] No summary directory specified so returning summary output
#> INFO [2025-11-19 13:43:27] No target directory specified so returning timings
options(old_opts)
# }
```
