...
Returns generation time parameters in a format for lower level model
use.
...
for how to specify the probability distributions (e.g.
...
provided by the distspec package and attached automatically with
EpiNow2.
...
[`distspec::Fixed()`](https://epiforecasts.io/distspec/reference/Fixed.html)
