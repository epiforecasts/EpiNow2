...
class model_lnorm : public stan::model::model_base_crtp<model_lnorm> {
 private:
  int N;
  vector_d low;
  vector_d up;
 ...
 public:
  model_lnorm(stan::io::var_context& context__, std::ostream* pstream__ = 0)
      : model_base_crtp(0) {
    ctor_body(context__, 0, pstream__);
  }
  model_lnorm(stan::io::var_context& context__, unsigned int random_seed__,
  ...
  void transform_inits(const stan::io::var_context& context__,
    ...
    if (!(context__.contains_r("mu")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable mu missing")),
    ...
    try {
      ...
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Error transforming variable mu: ") +
                             e.what()),
          current_statement_begin__, prog_reader__());
    }
    current_statement_begin__ = 12;
    if (!(context__.contains_r("sigma")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable sigma missing")),
          current_statement_begin__, prog_reader__());
  ...
  T__ log_prob(std::vector<T__>& params_r__, std::vector<int>& params_i__,
    ...
    try {
      ...
      if (sigma < 0)
        ...
        lp_accum__.add(-normal_ccdf_log(0, prior_sd, 10));
      current_statement_begin__ = 19;
      for (int i = 1; i <= N; ++i) {
        current_statement_begin__ = 20;
        lp_accum__.add(stan::math::log(
            (lognormal_cdf(get_base1(up, i, "up", 1), mu, sigma) -
             lognormal_cdf(get_base1(low, i, "low", 1), mu, sigma))));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, current_statement_begin__,
                                  prog_reader__());
  ...
  std::string model_name() const { return "model_lnorm"; }
