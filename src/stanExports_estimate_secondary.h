...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(327, 13, "end", "data/observation_model.stan");
    reader.add_event(327, 15, "restart", "model_estimate_secondary");
    reader.add_event(379, 65, "end", "model_estimate_secondary");
    return reader;
}
