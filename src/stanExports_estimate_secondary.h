...
stan::io::program_reader prog_reader__() {
  ...
  reader.add_event(239, 4, "restart", "model_estimate_secondary");
...
calculate_secondary(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& reports,
                    ...
                    const std::vector<int>& max_delay, const int& cumulative,
  ...
  try {
    {
      ...
      if (as_bool(obs_scale)) {
        ...
        stan::math::assign(
            scaled_reports,
            scale_obs(reports, get_base1(frac_obs, 1, "frac_obs", 1),
                      pstream__));
      } else {
      ...
      stan::math::assign(
          conv_reports,
          add(conv_reports,
              convolve_to_report(scaled_reports, delay_mean, delay_sd,
                                 max_delay, 0, pstream__)));
      current_statement_begin__ = 262;
      for (int i = 1; i <= t; ++i) {
        current_statement_begin__ = 264;
        if (as_bool((primitive_value(cumulative) &&
                     primitive_value(logical_gt(i, 1))))) {
            ...
            stan::model::assign(
                ...
                (stan::model::rvalue(
                     ...
                     stan::model::cons_list(stan::model::index_uni(i),
                                            stan::model::nil_index_list()),
                     "secondary_reports") +
                 get_base1(conv_reports, i, "conv_reports", 1)),
                "assigning variable secondary_reports");
          } else {
            current_statement_begin__ = 276;
            if (as_bool(logical_gt(
                    get_base1(conv_reports, i, "conv_reports", 1),
            ...
            stan::model::assign(
                ...
                (stan::model::rvalue(
                     ...
                     stan::model::cons_list(stan::model::index_uni(i),
                                            stan::model::nil_index_list()),
                     "secondary_reports") +
                 get_base1(scaled_reports, i, "scaled_reports", 1)),
                "assigning variable secondary_reports");
          } else {
        ...
        stan::model::assign(
            ...
            stan::model::cons_list(stan::model::index_uni(i),
                                   stan::model::nil_index_list()),
            (logical_lte(
                 get_base1(secondary_reports, i, "secondary_reports", 1), 0)
                 ? stan::math::promote_scalar<local_scalar_t__>(1e-5)
                 : stan::math::promote_scalar<local_scalar_t__>(get_base1(
                       secondary_reports, i, "secondary_reports", 1))),
            "assigning variable secondary_reports");
      }
...
struct calculate_secondary_functor__ {
  ...
  Eigen::Matrix<
      ...
      Eigen::Dynamic, 1>
  operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& reports,
             const std::vector<int>& obs, const std::vector<T2__>& frac_obs,
             const std::vector<T3__>& delay_mean,
             const std::vector<T4__>& delay_sd,
             const std::vector<int>& max_delay, const int& cumulative,
             const int& historic, const int& primary_hist_additive,
    ...
    return calculate_secondary(reports, obs, frac_obs, delay_mean, delay_sd,
                               max_delay, cumulative, historic,
                               primary_hist_additive, current,
                               primary_current_additive, predict, pstream__);
  }
};
 ...
 public:
  ...
  void ctor_body(stan::io::var_context& context__, unsigned int random_seed__,
    ...
    try {
      ...
      context__.validate_dims("data initialization", "primary", "vector_d",
                              context__.to_vec(t));
      ...
      context__.validate_dims("data initialization", "primary_current_additive",
                              "int", context__.to_vec());
    ...
    try {
      ...
      stan::math::assign(
          secondary, calculate_secondary(
                         primary, obs, frac_obs, delay_mean, delay_sd,
                         max_delay, cumulative, historic, primary_hist_additive,
                         current, primary_current_additive, t, pstream__));
      current_statement_begin__ = 347;
      if (as_bool(week_effect)) {
        current_statement_begin__ = 348;
        stan::math::assign(secondary,
                           day_of_week_effect(secondary, day_of_week,
                                              day_of_week_simplex, pstream__));
      }
      current_statement_begin__ = 351;
      stan::math::assign(secondary,
                         truncate(secondary, truncation_mean, truncation_sd,
                                  max_truncation, 0, pstream__));
      ...
      for (size_t j_1__ = 0; j_1__ < secondary_j_1_max__; ++j_1__) {
        if (stan::math::is_uninitialized(secondary(j_1__))) {
          ...
          msg__ << "Undefined transformed parameter: secondary"
                << "(" << j_1__ << ")";
          stan::lang::rethrow_located(
              std::runtime_error(
                  std::string("Error initializing variable secondary: ") +
                  msg__.str()),
              current_statement_begin__, prog_reader__());
        }
      }
      ...
      delays_lp(delay_mean, delay_mean_mean, delay_mean_sd, delay_sd,
                delay_sd_mean, delay_sd_sd, 1, lp__, lp_accum__, pstream__);
      ...
      report_lp(
          stan::model::rvalue(obs,
                              stan::model::cons_list(
                                  stan::model::index_min_max((burn_in + 1), t),
                                  stan::model::nil_index_list()),
                              "obs"),
          stan::model::rvalue(secondary,
                              stan::model::cons_list(
                                  stan::model::index_min_max((burn_in + 1), t),
                                  stan::model::nil_index_list()),
                              "secondary"),
          rep_phi, 1, model_type, 1, lp__, lp_accum__, pstream__);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, current_statement_begin__,
                                  prog_reader__());
      // Next line prevents compiler griping about no return
  ...
  void write_array(RNG& base_rng__, std::vector<double>& params_r__,
    ...
    try {
      ...
      stan::math::assign(
          sim_secondary,
          report_rng(stan::model::rvalue(
                         secondary,
                         stan::model::cons_list(
                             stan::model::index_min_max((burn_in + 1), t),
                             stan::model::nil_index_list()),
                         "secondary"),
                     rep_phi, model_type, base_rng__, pstream__));
      current_statement_begin__ = 374;
      stan::math::assign(
          log_lik,
          report_log_lik(stan::model::rvalue(
                             obs,
                             stan::model::cons_list(
                                 stan::model::index_min_max((burn_in + 1), t),
                                 stan::model::nil_index_list()),
                         ...
                         stan::model::rvalue(
                             ...
                             stan::model::cons_list(
                                 ...
                                 stan::model::nil_index_list()),
                             "secondary"),
                         rep_phi, model_type, obs_weight, pstream__));
  ...
  std::string model_name() const { return "model_estimate_secondary"; }
