...
namespace model_exp_fit_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_exp_fit");
    reader.add_event(25, 23, "end", "model_exp_fit");
    return reader;
}
#include <stan_meta_header.hpp>
class model_exp_fit : public prob_grad {
private:
        int N;
        vector_d low;
        vector_d up;
        double lam_mean;
public:
    model_exp_fit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exp_fit_namespace::model_exp_fit";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "lam_mean", "double", context__.to_vec());
            lam_mean = double(0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(uniform_log<propto__>(lambda, (1 / (5 * lam_mean)), (1 / (0.2 * lam_mean))));
            current_statement_begin__ = 13;
            for (int i = 1; i <= N; ++i) {
                current_statement_begin__ = 14;
                lp_accum__.add(stan::math::log((exponential_cdf(get_base1(up, i, "up", 1), lambda) - exponential_cdf(get_base1(low, i, "low", 1), lambda))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exp_fit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            stan::math::log((exponential_cdf(get_base1(up, n, "up", 1), lambda) - exponential_cdf(get_base1(low, n, "low", 1), lambda))), 
...
typedef model_exp_fit_namespace::model_exp_fit stan_model;
#endif
