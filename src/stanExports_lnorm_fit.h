...
namespace model_lnorm_fit_namespace {
using std::istream;
using std::string;
...
class model_lnorm_fit : public prob_grad {
private:
        int N;
        vector_d low;
        vector_d up;
        ...
        double prior_sd;
public:
    model_lnorm_fit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lnorm_fit_namespace::model_lnorm_fit";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(mu, prior_mean, 1));
            current_statement_begin__ = 17;
            lp_accum__.add(normal_log<propto__>(sigma, prior_sd, 1));
            if (sigma < 0) lp_accum__.add(-std::numeric_limits<double>::infinity());
            else lp_accum__.add(-normal_ccdf_log(0, prior_sd, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lnorm_fit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lnorm_fit_namespace::model_lnorm_fit stan_model;
#endif
