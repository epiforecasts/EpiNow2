...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(245, 5, "restart", "model_simulate_infections");
    ...
    reader.add_event(342, 6, "restart", "model_simulate_infections");
    ...
    reader.add_event(475, 7, "restart", "model_simulate_infections");
    ...
    reader.add_event(521, 8, "restart", "model_simulate_infections");
    reader.add_event(530, 17, "include", "data/simulation_rt.stan");
    reader.add_event(530, 0, "start", "data/simulation_rt.stan");
    reader.add_event(537, 7, "end", "data/simulation_rt.stan");
    reader.add_event(537, 18, "restart", "model_simulate_infections");
    reader.add_event(538, 19, "include", "data/simulation_delays.stan");
    reader.add_event(538, 0, "start", "data/simulation_delays.stan");
    reader.add_event(542, 4, "end", "data/simulation_delays.stan");
    reader.add_event(542, 20, "restart", "model_simulate_infections");
    reader.add_event(543, 21, "include", "data/simulation_observation_model.stan");
    reader.add_event(543, 0, "start", "data/simulation_observation_model.stan");
    reader.add_event(550, 7, "end", "data/simulation_observation_model.stan");
    reader.add_event(550, 22, "restart", "model_simulate_infections");
    reader.add_event(583, 53, "end", "model_simulate_infections");
    return reader;
}
...
public:
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            validate_non_negative_index("r", "n", n);
            validate_non_negative_index("r", "(t - seeding_time)", (t - seeding_time));
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> r(n, (t - seeding_time));
            stan::math::initialize(r, DUMMY_VAR__);
            stan::math::fill(r, DUMMY_VAR__);
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                stan::model::assign(infections, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            to_row_vector(generate_infections(to_vector(get_base1(R, i, "R", 1)), seeding_time, get_base1(gt_mean, i, "gt_mean", 1), get_base1(gt_sd, i, "gt_sd", 1), max_gt, get_base1(initial_infections, i, "initial_infections", 1), get_base1(initial_growth, i, "initial_growth", 1), pop, future_time, 0, pstream__)), 
                            "assigning variable infections");
                ...
                stan::model::assign(r, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            to_row_vector(R_to_growth(to_vector(get_base1(R, i, "R", 1)), get_base1(get_base1(gt_mean, i, "gt_mean", 1), 1, "gt_mean", 2), get_base1(get_base1(gt_sd, i, "gt_sd", 1), 1, "gt_sd", 2), pstream__)), 
                            "assigning variable r");
            }
