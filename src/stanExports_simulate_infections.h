...
stan::io::program_reader prog_reader__() {
  ...
  reader.add_event(460, 7, "restart", "model_simulate_infections");
  ...
  reader.add_event(506, 8, "restart", "model_simulate_infections");
  reader.add_event(515, 17, "include", "data/simulation_rt.stan");
  reader.add_event(515, 0, "start", "data/simulation_rt.stan");
  reader.add_event(522, 7, "end", "data/simulation_rt.stan");
  reader.add_event(522, 18, "restart", "model_simulate_infections");
  reader.add_event(523, 19, "include", "data/simulation_delays.stan");
  reader.add_event(523, 0, "start", "data/simulation_delays.stan");
  reader.add_event(527, 4, "end", "data/simulation_delays.stan");
  reader.add_event(527, 20, "restart", "model_simulate_infections");
  reader.add_event(528, 21, "include",
                   "data/simulation_observation_model.stan");
  reader.add_event(528, 0, "start", "data/simulation_observation_model.stan");
  reader.add_event(535, 7, "end", "data/simulation_observation_model.stan");
  reader.add_event(535, 22, "restart", "model_simulate_infections");
  reader.add_event(568, 53, "end", "model_simulate_infections");
  return reader;
}
 ...
 public:
  ...
  void ctor_body(stan::io::var_context& context__, unsigned int random_seed__,
    ...
    try {
      ...
      context__.validate_dims("data initialization", "initial_infections",
                              "double",
                              context__.to_vec((seeding_time ? n : 0), 1));
      initial_infections = std::vector<std::vector<double> >(
          (seeding_time ? n : 0), std::vector<double>(1, double(0)));
      ...
      context__.validate_dims("data initialization", "gt_mean", "double",
                              context__.to_vec(n, 1));
      gt_mean = std::vector<std::vector<double> >(
          n, std::vector<double>(1, double(0)));
      ...
      for (size_t i_0__ = 0; i_0__ < gt_mean_i_0_max__; ++i_0__) {
        for (size_t i_1__ = 0; i_1__ < gt_mean_i_1_max__; ++i_1__) {
          check_greater_or_equal(function__, "gt_mean[i_0__][i_1__]",
                                 gt_mean[i_0__][i_1__], 0);
        }
      }
      current_statement_begin__ = 519;
      validate_non_negative_index("gt_sd", "n", n);
      validate_non_negative_index("gt_sd", "1", 1);
      context__.validate_dims("data initialization", "gt_sd", "double",
                              context__.to_vec(n, 1));
      gt_sd = std::vector<std::vector<double> >(
          n, std::vector<double>(1, double(0)));
      ...
      for (size_t i_0__ = 0; i_0__ < gt_sd_i_0_max__; ++i_0__) {
        for (size_t i_1__ = 0; i_1__ < gt_sd_i_1_max__; ++i_1__) {
          check_greater_or_equal(function__, "gt_sd[i_0__][i_1__]",
                                 gt_sd[i_0__][i_1__], 0);
        }
      }
      ...
      validate_non_negative_index("R", "(t - seeding_time)",
                                  (t - seeding_time));
      context__.validate_dims("data initialization", "R", "matrix_d",
                              context__.to_vec(n, (t - seeding_time)));
      R = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(
          n, (t - seeding_time));
      ...
      context__.validate_dims("data initialization", "delay_mean", "double",
                              context__.to_vec(n, delays));
      delay_mean = std::vector<std::vector<double> >(
          n, std::vector<double>(delays, double(0)));
      ...
      context__.validate_dims("data initialization", "delay_sd", "double",
                              context__.to_vec(n, delays));
      delay_sd = std::vector<std::vector<double> >(
          n, std::vector<double>(delays, double(0)));
      ...
      context__.validate_dims("data initialization", "day_of_week_simplex",
                              "double",
                              context__.to_vec(n, (week_effect ? 7 : 1)));
      day_of_week_simplex = std::vector<std::vector<double> >(
          n, std::vector<double>((week_effect ? 7 : 1), double(0)));
      ...
      for (size_t i_0__ = 0; i_0__ < day_of_week_simplex_i_0_max__; ++i_0__) {
        for (size_t i_1__ = 0; i_1__ < day_of_week_simplex_i_1_max__; ++i_1__) {
          check_greater_or_equal(function__,
                                 ...
                                 day_of_week_simplex[i_0__][i_1__], 0);
        }
      }
      ...
      frac_obs = std::vector<std::vector<double> >(
          n, std::vector<double>(obs_scale, double(0)));
      ...
      rep_phi = std::vector<std::vector<double> >(
          n, std::vector<double>(model_type, double(0)));
      ...
      for (size_t i_0__ = 0; i_0__ < rep_phi_i_0_max__; ++i_0__) {
        for (size_t i_1__ = 0; i_1__ < rep_phi_i_1_max__; ++i_1__) {
          check_greater_or_equal(function__, "rep_phi[i_0__][i_1__]",
                                 rep_phi[i_0__][i_1__], 0);
        }
      }
  ...
  void write_array(RNG& base_rng__, std::vector<double>& params_r__,
    ...
    try {
      ...
      validate_non_negative_index("reports", "(t - seeding_time)",
                                  (t - seeding_time));
      Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> reports(
          n, (t - seeding_time));
      stan::math::initialize(reports, DUMMY_VAR__);
      stan::math::fill(reports, DUMMY_VAR__);
      ...
      std::vector<std::vector<int> > imputed_reports(
          n, std::vector<int>((t - seeding_time), int(0)));
      ...
      std::vector<std::vector<double> > r(
          n, std::vector<double>((t - seeding_time), double(0)));
      stan::math::initialize(r, DUMMY_VAR__);
      stan::math::fill(r, DUMMY_VAR__);
      ...
      for (int i = 1; i <= n; ++i) {
        ...
        stan::model::assign(
            ...
            stan::model::cons_list(stan::model::index_uni(i),
                                   stan::model::nil_index_list()),
            to_row_vector(generate_infections(
                to_vector(get_base1(R, i, "R", 1)), seeding_time,
                get_base1(gt_mean, i, "gt_mean", 1),
                get_base1(gt_sd, i, "gt_sd", 1), max_gt,
                get_base1(initial_infections, i, "initial_infections", 1),
                get_base1(initial_growth, i, "initial_growth", 1), pop,
        ...
        stan::model::assign(
            ...
            stan::model::cons_list(stan::model::index_uni(i),
                                   stan::model::nil_index_list()),
            to_row_vector(convolve_to_report(
                to_vector(get_base1(infections, i, "infections", 1)),
                get_base1(delay_mean, i, "delay_mean", 1),
                get_base1(delay_sd, i, "delay_sd", 1), max_delay, seeding_time,
                pstream__)),
        ...
        if (as_bool(week_effect)) {
          ...
          stan::model::assign(
              ...
              stan::model::cons_list(stan::model::index_uni(i),
                                     stan::model::nil_index_list()),
              to_row_vector(day_of_week_effect(
                  to_vector(get_base1(reports, i, "reports", 1)), day_of_week,
                  to_vector(get_base1(day_of_week_simplex, i,
                                      "day_of_week_simplex", 1)),
                  pstream__)),
              "assigning variable reports");
        }
        ...
        if (as_bool(obs_scale)) {
          ...
          stan::model::assign(
              ...
              stan::model::cons_list(stan::model::index_uni(i),
                                     stan::model::nil_index_list()),
              to_row_vector(
                  scale_obs(to_vector(get_base1(reports, i, "reports", 1)),
                            get_base1(get_base1(frac_obs, i, "frac_obs", 1), 1,
                                      "frac_obs", 2),
                            pstream__)),
              "assigning variable reports");
        }
        ...
        stan::model::assign(
            ...
            stan::model::cons_list(stan::model::index_uni(i),
                                   stan::model::nil_index_list()),
            report_rng(to_vector(get_base1(reports, i, "reports", 1)),
                       get_base1(rep_phi, i, "rep_phi", 1), model_type,
        ...
        stan::model::assign(
            ...
            stan::model::cons_list(stan::model::index_uni(i),
                                   stan::model::nil_index_list()),
            R_to_growth(
                to_vector(get_base1(R, i, "R", 1)),
                get_base1(get_base1(gt_mean, i, "gt_mean", 1), 1, "gt_mean", 2),
                get_base1(get_base1(gt_sd, i, "gt_sd", 1), 1, "gt_sd", 2),
                pstream__),
            "assigning variable r");
      }
  ...
  std::string model_name() const { return "model_simulate_infections"; }
...
typedef model_simulate_infections_namespace::model_simulate_infections
    stan_model;
#ifndef USING_R
