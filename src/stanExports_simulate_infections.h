...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(308, 32, "end", "functions/observation_model.stan");
    reader.add_event(308, 7, "restart", "model_simulate_infections");
    reader.add_event(308, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(308, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(359, 51, "end", "functions/generated_quantities.stan");
    reader.add_event(359, 8, "restart", "model_simulate_infections");
    reader.add_event(412, 59, "end", "model_simulate_infections");
    return reader;
}
