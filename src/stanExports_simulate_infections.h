...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(454, 7, "restart", "model_simulate_infections");
    ...
    reader.add_event(524, 8, "restart", "model_simulate_infections");
    reader.add_event(586, 68, "end", "model_simulate_infections");
    return reader;
}
