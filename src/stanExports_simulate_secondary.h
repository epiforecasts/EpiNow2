...
stan::io::program_reader prog_reader__() {
  ...
  reader.add_event(316, 20, "include",
 ...
 public:
  ...
  void ctor_body(stan::io::var_context& context__, unsigned int random_seed__,
    ...
    try {
      ...
      context__.validate_dims("data initialization", "primary", "matrix_d",
  ...
  void write_array(RNG& base_rng__, std::vector<double>& params_r__,
    ...
    try {
      ...
      std::vector<std::vector<int> > sim_secondary(
          n, std::vector<int>((all_dates ? t : h), int(0)));
      ...
      for (int i = 1; i <= n; ++i) {
        {
          ...
          stan::math::assign(
              secondary,
              calculate_secondary(
                  to_vector(get_base1(primary, i, "primary", 1)), obs,
                  get_base1(frac_obs, i, "frac_obs", 1),
                  get_base1(delay_mean, i, "delay_mean", 1),
                  get_base1(delay_sd, i, "delay_sd", 1), max_delay, cumulative,
                  historic, primary_hist_additive, current,
          ...
          stan::model::assign(
              ...
              stan::model::cons_list(stan::model::index_uni(i),
                                     stan::model::nil_index_list()),
              report_rng(tail(secondary, (all_dates ? t : h)),
  ...
  std::string model_name() const { return "model_simulate_secondary"; }
