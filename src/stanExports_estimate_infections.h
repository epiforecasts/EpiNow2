...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(148, 75, "end", "functions/gaussian_process.stan");
    reader.add_event(148, 4, "restart", "model_estimate_infections");
    reader.add_event(148, 4, "include", "functions/rt.stan");
    reader.add_event(148, 0, "start", "functions/rt.stan");
    reader.add_event(222, 74, "end", "functions/rt.stan");
    reader.add_event(222, 5, "restart", "model_estimate_infections");
    reader.add_event(222, 5, "include", "functions/infections.stan");
    reader.add_event(222, 0, "start", "functions/infections.stan");
    reader.add_event(276, 54, "end", "functions/infections.stan");
    ...
    reader.add_event(310, 34, "end", "functions/observation_model.stan");
    reader.add_event(310, 7, "restart", "model_estimate_infections");
    reader.add_event(310, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(310, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(363, 53, "end", "functions/generated_quantities.stan");
    reader.add_event(363, 8, "restart", "model_estimate_infections");
    reader.add_event(367, 12, "include", "data/observations.stan");
    reader.add_event(367, 0, "start", "data/observations.stan");
    reader.add_event(372, 5, "end", "data/observations.stan");
    reader.add_event(372, 13, "restart", "model_estimate_infections");
    reader.add_event(372, 13, "include", "data/delays.stan");
    reader.add_event(372, 0, "start", "data/delays.stan");
    reader.add_event(378, 6, "end", "data/delays.stan");
    reader.add_event(378, 14, "restart", "model_estimate_infections");
    reader.add_event(378, 14, "include", "data/gaussian_process.stan");
    reader.add_event(378, 0, "start", "data/gaussian_process.stan");
    reader.add_event(388, 10, "end", "data/gaussian_process.stan");
    reader.add_event(388, 15, "restart", "model_estimate_infections");
    reader.add_event(388, 15, "include", "data/generation_time.stan");
    reader.add_event(388, 0, "start", "data/generation_time.stan");
    reader.add_event(393, 5, "end", "data/generation_time.stan");
    reader.add_event(393, 16, "restart", "model_estimate_infections");
    reader.add_event(393, 16, "include", "data/rt.stan");
    reader.add_event(393, 0, "start", "data/rt.stan");
    reader.add_event(402, 9, "end", "data/rt.stan");
    reader.add_event(402, 17, "restart", "model_estimate_infections");
    reader.add_event(402, 17, "include", "data/observation_model.stan");
    reader.add_event(402, 0, "start", "data/observation_model.stan");
    reader.add_event(405, 3, "end", "data/observation_model.stan");
    reader.add_event(405, 18, "restart", "model_estimate_infections");
    reader.add_event(514, 125, "end", "model_estimate_infections");
    return reader;
}
...
setup_gp(const int& M,
    ...
    try {
        ...
        stan::math::assign(time, subtract(time, (dimension / 2.0)));
    ...
    try {
        ...
        if (as_bool(logical_eq(type, 0))) {
            ...
            for (int m = 1; m <= M; ++m) {
                ...
                stan::model::assign(diagSPD, 
                            stan::model::cons_list(stan::model::index_uni(m), stan::model::nil_index_list()), 
                            stan::math::sqrt(spd_matern(alpha, rho, stan::math::sqrt(lambda(L, m, pstream__)), pstream__)), 
                            "assigning variable diagSPD");
            }
        }
