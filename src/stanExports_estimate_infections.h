...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(514, 54, "end", "functions/generated_quantities.stan");
    reader.add_event(514, 8, "restart", "model_estimate_infections");
    reader.add_event(518, 12, "include", "data/observations.stan");
    reader.add_event(518, 0, "start", "data/observations.stan");
    reader.add_event(524, 6, "end", "data/observations.stan");
    reader.add_event(524, 13, "restart", "model_estimate_infections");
    reader.add_event(524, 13, "include", "data/delays.stan");
    reader.add_event(524, 0, "start", "data/delays.stan");
    reader.add_event(530, 6, "end", "data/delays.stan");
    reader.add_event(530, 14, "restart", "model_estimate_infections");
    reader.add_event(530, 14, "include", "data/gaussian_process.stan");
    reader.add_event(530, 0, "start", "data/gaussian_process.stan");
    reader.add_event(540, 10, "end", "data/gaussian_process.stan");
    reader.add_event(540, 15, "restart", "model_estimate_infections");
    reader.add_event(540, 15, "include", "data/generation_time.stan");
    reader.add_event(540, 0, "start", "data/generation_time.stan");
    reader.add_event(545, 5, "end", "data/generation_time.stan");
    reader.add_event(545, 16, "restart", "model_estimate_infections");
    reader.add_event(545, 16, "include", "data/rt.stan");
    reader.add_event(545, 0, "start", "data/rt.stan");
    reader.add_event(555, 10, "end", "data/rt.stan");
    reader.add_event(555, 17, "restart", "model_estimate_infections");
    reader.add_event(555, 17, "include", "data/backcalc.stan");
    reader.add_event(555, 0, "start", "data/backcalc.stan");
    reader.add_event(557, 2, "end", "data/backcalc.stan");
    reader.add_event(557, 18, "restart", "model_estimate_infections");
    reader.add_event(557, 18, "include", "data/observation_model.stan");
    reader.add_event(557, 0, "start", "data/observation_model.stan");
    reader.add_event(570, 13, "end", "data/observation_model.stan");
    reader.add_event(570, 19, "restart", "model_estimate_infections");
    reader.add_event(690, 137, "end", "model_estimate_infections");
    return reader;
}
...
calculate_growth(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& infections,
                     const int& seeding_time, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    ...
    try {
        ...
        validate_non_negative_index("log_inf", "t", t);
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> log_inf(t);
        stan::math::initialize(log_inf, DUMMY_VAR__);
        stan::math::fill(log_inf, DUMMY_VAR__);
        stan::math::assign(log_inf,stan::math::log(infections));
        current_statement_begin__ = 512;
        validate_non_negative_index("growth", "ot", ot);
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> growth(ot);
        stan::math::initialize(growth, DUMMY_VAR__);
        stan::math::fill(growth, DUMMY_VAR__);
        stan::math::assign(growth,subtract(stan::model::rvalue(log_inf, stan::model::cons_list(stan::model::index_min_max((seeding_time + 1), t), stan::model::nil_index_list()), "log_inf"), stan::model::rvalue(log_inf, stan::model::cons_list(stan::model::index_min_max(seeding_time, (t - 1)), stan::model::nil_index_list()), "log_inf")));
        current_statement_begin__ = 513;
        return stan::math::promote_scalar<fun_return_scalar_t__>(to_array_1d(growth));
        }
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
...
struct calculate_growth_functor__ {
    template <typename T0__>
        std::vector<typename boost::math::tools::promote_args<T0__>::type>
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& infections,
                     const int& seeding_time, std::ostream* pstream__) const {
        return calculate_growth(infections, seeding_time, pstream__);
    }
};
...
public:
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            validate_non_negative_index("r", "(ot_h - 1)", (ot_h - 1));
            std::vector<double> r((ot_h - 1), double(0));
            stan::math::initialize(r, DUMMY_VAR__);
            stan::math::fill(r, DUMMY_VAR__);
            ...
            stan::math::assign(r, calculate_growth(infections, (seeding_time + 1), pstream__));
