...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(429, 84, "end", "functions/observation_model.stan");
    reader.add_event(429, 7, "restart", "model_estimate_infections");
    reader.add_event(429, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(429, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(499, 70, "end", "functions/generated_quantities.stan");
    reader.add_event(499, 8, "restart", "model_estimate_infections");
    reader.add_event(503, 12, "include", "data/observations.stan");
    reader.add_event(503, 0, "start", "data/observations.stan");
    reader.add_event(509, 6, "end", "data/observations.stan");
    reader.add_event(509, 13, "restart", "model_estimate_infections");
    reader.add_event(509, 13, "include", "data/delays.stan");
    reader.add_event(509, 0, "start", "data/delays.stan");
    reader.add_event(515, 6, "end", "data/delays.stan");
    reader.add_event(515, 14, "restart", "model_estimate_infections");
    reader.add_event(515, 14, "include", "data/gaussian_process.stan");
    reader.add_event(515, 0, "start", "data/gaussian_process.stan");
    reader.add_event(525, 10, "end", "data/gaussian_process.stan");
    reader.add_event(525, 15, "restart", "model_estimate_infections");
    reader.add_event(525, 15, "include", "data/generation_time.stan");
    reader.add_event(525, 0, "start", "data/generation_time.stan");
    reader.add_event(530, 5, "end", "data/generation_time.stan");
    reader.add_event(530, 16, "restart", "model_estimate_infections");
    reader.add_event(530, 16, "include", "data/rt.stan");
    reader.add_event(530, 0, "start", "data/rt.stan");
    reader.add_event(541, 11, "end", "data/rt.stan");
    reader.add_event(541, 17, "restart", "model_estimate_infections");
    reader.add_event(541, 17, "include", "data/observation_model.stan");
    reader.add_event(541, 0, "start", "data/observation_model.stan");
    reader.add_event(554, 13, "end", "data/observation_model.stan");
    reader.add_event(554, 18, "restart", "model_estimate_infections");
    reader.add_event(674, 136, "end", "model_estimate_infections");
    return reader;
}
