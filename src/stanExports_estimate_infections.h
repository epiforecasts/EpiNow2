...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(459, 132, "end", "functions/observation_model.stan");
    reader.add_event(459, 7, "restart", "model_estimate_infections");
    reader.add_event(459, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(459, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(505, 46, "end", "functions/generated_quantities.stan");
    reader.add_event(505, 8, "restart", "model_estimate_infections");
    reader.add_event(509, 12, "include", "data/observations.stan");
    reader.add_event(509, 0, "start", "data/observations.stan");
    reader.add_event(515, 6, "end", "data/observations.stan");
    reader.add_event(515, 13, "restart", "model_estimate_infections");
    reader.add_event(515, 13, "include", "data/delays.stan");
    reader.add_event(515, 0, "start", "data/delays.stan");
    reader.add_event(521, 6, "end", "data/delays.stan");
    reader.add_event(521, 14, "restart", "model_estimate_infections");
    reader.add_event(521, 14, "include", "data/gaussian_process.stan");
    reader.add_event(521, 0, "start", "data/gaussian_process.stan");
    reader.add_event(531, 10, "end", "data/gaussian_process.stan");
    reader.add_event(531, 15, "restart", "model_estimate_infections");
    reader.add_event(531, 15, "include", "data/generation_time.stan");
    reader.add_event(531, 0, "start", "data/generation_time.stan");
    reader.add_event(536, 5, "end", "data/generation_time.stan");
    reader.add_event(536, 16, "restart", "model_estimate_infections");
    reader.add_event(536, 16, "include", "data/rt.stan");
    reader.add_event(536, 0, "start", "data/rt.stan");
    reader.add_event(546, 10, "end", "data/rt.stan");
    reader.add_event(546, 17, "restart", "model_estimate_infections");
    reader.add_event(546, 17, "include", "data/backcalc.stan");
    reader.add_event(546, 0, "start", "data/backcalc.stan");
    reader.add_event(548, 2, "end", "data/backcalc.stan");
    reader.add_event(548, 18, "restart", "model_estimate_infections");
    reader.add_event(548, 18, "include", "data/observation_model.stan");
    reader.add_event(548, 0, "start", "data/observation_model.stan");
    reader.add_event(561, 13, "end", "data/observation_model.stan");
    reader.add_event(561, 19, "restart", "model_estimate_infections");
    reader.add_event(684, 140, "end", "model_estimate_infections");
    return reader;
}
