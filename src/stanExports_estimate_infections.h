...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(462, 7, "restart", "model_estimate_infections");
    ...
    reader.add_event(508, 8, "restart", "model_estimate_infections");
    reader.add_event(512, 12, "include", "data/observations.stan");
    reader.add_event(512, 0, "start", "data/observations.stan");
    reader.add_event(518, 6, "end", "data/observations.stan");
    reader.add_event(518, 13, "restart", "model_estimate_infections");
    reader.add_event(518, 13, "include", "data/delays.stan");
    reader.add_event(518, 0, "start", "data/delays.stan");
    reader.add_event(524, 6, "end", "data/delays.stan");
    reader.add_event(524, 14, "restart", "model_estimate_infections");
    reader.add_event(524, 14, "include", "data/gaussian_process.stan");
    reader.add_event(524, 0, "start", "data/gaussian_process.stan");
    reader.add_event(534, 10, "end", "data/gaussian_process.stan");
    reader.add_event(534, 15, "restart", "model_estimate_infections");
    reader.add_event(534, 15, "include", "data/generation_time.stan");
    reader.add_event(534, 0, "start", "data/generation_time.stan");
    reader.add_event(539, 5, "end", "data/generation_time.stan");
    reader.add_event(539, 16, "restart", "model_estimate_infections");
    reader.add_event(539, 16, "include", "data/rt.stan");
    reader.add_event(539, 0, "start", "data/rt.stan");
    reader.add_event(549, 10, "end", "data/rt.stan");
    reader.add_event(549, 17, "restart", "model_estimate_infections");
    reader.add_event(549, 17, "include", "data/backcalc.stan");
    reader.add_event(549, 0, "start", "data/backcalc.stan");
    reader.add_event(551, 2, "end", "data/backcalc.stan");
    reader.add_event(551, 18, "restart", "model_estimate_infections");
    reader.add_event(551, 18, "include", "data/observation_model.stan");
    reader.add_event(551, 0, "start", "data/observation_model.stan");
    reader.add_event(566, 15, "end", "data/observation_model.stan");
    reader.add_event(566, 19, "restart", "model_estimate_infections");
    reader.add_event(695, 146, "end", "model_estimate_infections");
    return reader;
}
...
public:
    ...
    void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
        ...
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back((logical_gt(return_likelihood, 1) ? ot : 0 ));
        dimss__.push_back(dims__);
    }
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            validate_non_negative_index("log_lik", "(logical_gt(return_likelihood, 1) ? ot : 0 )", (logical_gt(return_likelihood, 1) ? ot : 0 ));
            Eigen::Matrix<double, Eigen::Dynamic, 1> log_lik((logical_gt(return_likelihood, 1) ? ot : 0 ));
            stan::math::initialize(log_lik, DUMMY_VAR__);
            stan::math::fill(log_lik, DUMMY_VAR__);
            ...
            current_statement_begin__ = 672;
            size_t log_lik_j_1_max__ = (logical_gt(return_likelihood, 1) ? ot : 0 );
