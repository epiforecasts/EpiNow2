...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(253, 74, "end", "functions/rt.stan");
    reader.add_event(253, 5, "restart", "model_estimate_infections");
    reader.add_event(253, 5, "include", "functions/infections.stan");
    reader.add_event(253, 0, "start", "functions/infections.stan");
    reader.add_event(311, 58, "end", "functions/infections.stan");
    reader.add_event(311, 6, "restart", "model_estimate_infections");
    reader.add_event(311, 6, "include", "functions/observation_model.stan");
    reader.add_event(311, 0, "start", "functions/observation_model.stan");
    reader.add_event(352, 41, "end", "functions/observation_model.stan");
    reader.add_event(352, 7, "restart", "model_estimate_infections");
    reader.add_event(352, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(352, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(407, 55, "end", "functions/generated_quantities.stan");
    reader.add_event(407, 8, "restart", "model_estimate_infections");
    reader.add_event(411, 12, "include", "data/observations.stan");
    reader.add_event(411, 0, "start", "data/observations.stan");
    reader.add_event(416, 5, "end", "data/observations.stan");
    reader.add_event(416, 13, "restart", "model_estimate_infections");
    reader.add_event(416, 13, "include", "data/delays.stan");
    reader.add_event(416, 0, "start", "data/delays.stan");
    reader.add_event(422, 6, "end", "data/delays.stan");
    reader.add_event(422, 14, "restart", "model_estimate_infections");
    reader.add_event(422, 14, "include", "data/gaussian_process.stan");
    reader.add_event(422, 0, "start", "data/gaussian_process.stan");
    reader.add_event(432, 10, "end", "data/gaussian_process.stan");
    reader.add_event(432, 15, "restart", "model_estimate_infections");
    reader.add_event(432, 15, "include", "data/generation_time.stan");
    reader.add_event(432, 0, "start", "data/generation_time.stan");
    reader.add_event(437, 5, "end", "data/generation_time.stan");
    reader.add_event(437, 16, "restart", "model_estimate_infections");
    reader.add_event(437, 16, "include", "data/rt.stan");
    reader.add_event(437, 0, "start", "data/rt.stan");
    reader.add_event(446, 9, "end", "data/rt.stan");
    reader.add_event(446, 17, "restart", "model_estimate_infections");
    reader.add_event(446, 17, "include", "data/observation_model.stan");
    reader.add_event(446, 0, "start", "data/observation_model.stan");
    reader.add_event(453, 7, "end", "data/observation_model.stan");
    reader.add_event(453, 18, "restart", "model_estimate_infections");
    reader.add_event(570, 133, "end", "model_estimate_infections");
    return reader;
}
