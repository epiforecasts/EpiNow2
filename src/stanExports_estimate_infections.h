...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(329, 76, "end", "functions/infections.stan");
    reader.add_event(329, 6, "restart", "model_estimate_infections");
    reader.add_event(329, 6, "include", "functions/observation_model.stan");
    reader.add_event(329, 0, "start", "functions/observation_model.stan");
    reader.add_event(370, 41, "end", "functions/observation_model.stan");
    reader.add_event(370, 7, "restart", "model_estimate_infections");
    reader.add_event(370, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(370, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(425, 55, "end", "functions/generated_quantities.stan");
    reader.add_event(425, 8, "restart", "model_estimate_infections");
    reader.add_event(429, 12, "include", "data/observations.stan");
    reader.add_event(429, 0, "start", "data/observations.stan");
    reader.add_event(434, 5, "end", "data/observations.stan");
    reader.add_event(434, 13, "restart", "model_estimate_infections");
    reader.add_event(434, 13, "include", "data/delays.stan");
    reader.add_event(434, 0, "start", "data/delays.stan");
    reader.add_event(440, 6, "end", "data/delays.stan");
    reader.add_event(440, 14, "restart", "model_estimate_infections");
    reader.add_event(440, 14, "include", "data/gaussian_process.stan");
    reader.add_event(440, 0, "start", "data/gaussian_process.stan");
    reader.add_event(450, 10, "end", "data/gaussian_process.stan");
    reader.add_event(450, 15, "restart", "model_estimate_infections");
    reader.add_event(450, 15, "include", "data/generation_time.stan");
    reader.add_event(450, 0, "start", "data/generation_time.stan");
    reader.add_event(455, 5, "end", "data/generation_time.stan");
    reader.add_event(455, 16, "restart", "model_estimate_infections");
    reader.add_event(455, 16, "include", "data/rt.stan");
    reader.add_event(455, 0, "start", "data/rt.stan");
    reader.add_event(465, 10, "end", "data/rt.stan");
    reader.add_event(465, 17, "restart", "model_estimate_infections");
    reader.add_event(465, 17, "include", "data/observation_model.stan");
    reader.add_event(465, 0, "start", "data/observation_model.stan");
    reader.add_event(472, 7, "end", "data/observation_model.stan");
    reader.add_event(472, 18, "restart", "model_estimate_infections");
    reader.add_event(593, 137, "end", "model_estimate_infections");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            ft = int(0);
            stan::math::fill(ft, std::numeric_limits<int>::min());
            stan::math::assign(ft,(horizon - fixed_from));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(estimate_r)) {
                ...
                stan::math::assign(infections, generate_infections(R, seeding_time, gt_mean, gt_sd, max_gt, initial_infections, initial_growth, pop, ft, pstream__));
            } else {
