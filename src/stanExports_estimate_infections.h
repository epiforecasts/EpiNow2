...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(252, 73, "end", "functions/rt.stan");
    reader.add_event(252, 5, "restart", "model_estimate_infections");
    reader.add_event(252, 5, "include", "functions/infections.stan");
    reader.add_event(252, 0, "start", "functions/infections.stan");
    reader.add_event(328, 76, "end", "functions/infections.stan");
    reader.add_event(328, 6, "restart", "model_estimate_infections");
    reader.add_event(328, 6, "include", "functions/observation_model.stan");
    reader.add_event(328, 0, "start", "functions/observation_model.stan");
    reader.add_event(369, 41, "end", "functions/observation_model.stan");
    reader.add_event(369, 7, "restart", "model_estimate_infections");
    reader.add_event(369, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(369, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(439, 70, "end", "functions/generated_quantities.stan");
    reader.add_event(439, 8, "restart", "model_estimate_infections");
    reader.add_event(443, 12, "include", "data/observations.stan");
    reader.add_event(443, 0, "start", "data/observations.stan");
    reader.add_event(449, 6, "end", "data/observations.stan");
    reader.add_event(449, 13, "restart", "model_estimate_infections");
    reader.add_event(449, 13, "include", "data/delays.stan");
    reader.add_event(449, 0, "start", "data/delays.stan");
    reader.add_event(455, 6, "end", "data/delays.stan");
    reader.add_event(455, 14, "restart", "model_estimate_infections");
    reader.add_event(455, 14, "include", "data/gaussian_process.stan");
    reader.add_event(455, 0, "start", "data/gaussian_process.stan");
    reader.add_event(465, 10, "end", "data/gaussian_process.stan");
    reader.add_event(465, 15, "restart", "model_estimate_infections");
    reader.add_event(465, 15, "include", "data/generation_time.stan");
    reader.add_event(465, 0, "start", "data/generation_time.stan");
    reader.add_event(470, 5, "end", "data/generation_time.stan");
    reader.add_event(470, 16, "restart", "model_estimate_infections");
    reader.add_event(470, 16, "include", "data/rt.stan");
    reader.add_event(470, 0, "start", "data/rt.stan");
    reader.add_event(481, 11, "end", "data/rt.stan");
    reader.add_event(481, 17, "restart", "model_estimate_infections");
    reader.add_event(481, 17, "include", "data/observation_model.stan");
