...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(245, 63, "end", "functions/rt.stan");
    reader.add_event(245, 5, "restart", "model_estimate_infections");
    reader.add_event(245, 5, "include", "functions/infections.stan");
    reader.add_event(245, 0, "start", "functions/infections.stan");
    reader.add_event(342, 97, "end", "functions/infections.stan");
    reader.add_event(342, 6, "restart", "model_estimate_infections");
    reader.add_event(342, 6, "include", "functions/observation_model.stan");
    reader.add_event(342, 0, "start", "functions/observation_model.stan");
    reader.add_event(475, 133, "end", "functions/observation_model.stan");
    reader.add_event(475, 7, "restart", "model_estimate_infections");
    reader.add_event(475, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(475, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(521, 46, "end", "functions/generated_quantities.stan");
    reader.add_event(521, 8, "restart", "model_estimate_infections");
    reader.add_event(525, 12, "include", "data/observations.stan");
    reader.add_event(525, 0, "start", "data/observations.stan");
    reader.add_event(531, 6, "end", "data/observations.stan");
    reader.add_event(531, 13, "restart", "model_estimate_infections");
    reader.add_event(531, 13, "include", "data/delays.stan");
    reader.add_event(531, 0, "start", "data/delays.stan");
    reader.add_event(537, 6, "end", "data/delays.stan");
    reader.add_event(537, 14, "restart", "model_estimate_infections");
    reader.add_event(537, 14, "include", "data/gaussian_process.stan");
    reader.add_event(537, 0, "start", "data/gaussian_process.stan");
    reader.add_event(547, 10, "end", "data/gaussian_process.stan");
    reader.add_event(547, 15, "restart", "model_estimate_infections");
    reader.add_event(547, 15, "include", "data/generation_time.stan");
    reader.add_event(547, 0, "start", "data/generation_time.stan");
    reader.add_event(552, 5, "end", "data/generation_time.stan");
    reader.add_event(552, 16, "restart", "model_estimate_infections");
    reader.add_event(552, 16, "include", "data/rt.stan");
    reader.add_event(552, 0, "start", "data/rt.stan");
    reader.add_event(562, 10, "end", "data/rt.stan");
    reader.add_event(562, 17, "restart", "model_estimate_infections");
    reader.add_event(562, 17, "include", "data/backcalc.stan");
    reader.add_event(562, 0, "start", "data/backcalc.stan");
    reader.add_event(564, 2, "end", "data/backcalc.stan");
    reader.add_event(564, 18, "restart", "model_estimate_infections");
    reader.add_event(564, 18, "include", "data/observation_model.stan");
    reader.add_event(564, 0, "start", "data/observation_model.stan");
    reader.add_event(577, 13, "end", "data/observation_model.stan");
    reader.add_event(577, 19, "restart", "model_estimate_infections");
    reader.add_event(712, 152, "end", "model_estimate_infections");
    return reader;
}
