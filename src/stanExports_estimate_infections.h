...
// Code generated by Stan version 2.25.0
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(272, 90, "end", "functions/rt.stan");
    reader.add_event(272, 5, "restart", "model_estimate_infections");
    reader.add_event(272, 5, "include", "functions/infections.stan");
    reader.add_event(272, 0, "start", "functions/infections.stan");
    reader.add_event(359, 87, "end", "functions/infections.stan");
    reader.add_event(359, 6, "restart", "model_estimate_infections");
    reader.add_event(359, 6, "include", "functions/observation_model.stan");
    reader.add_event(359, 0, "start", "functions/observation_model.stan");
    reader.add_event(468, 109, "end", "functions/observation_model.stan");
    reader.add_event(468, 7, "restart", "model_estimate_infections");
    reader.add_event(468, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(468, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(540, 72, "end", "functions/generated_quantities.stan");
    reader.add_event(540, 8, "restart", "model_estimate_infections");
    reader.add_event(544, 12, "include", "data/observations.stan");
    reader.add_event(544, 0, "start", "data/observations.stan");
    reader.add_event(550, 6, "end", "data/observations.stan");
    reader.add_event(550, 13, "restart", "model_estimate_infections");
    reader.add_event(550, 13, "include", "data/delays.stan");
    reader.add_event(550, 0, "start", "data/delays.stan");
    reader.add_event(556, 6, "end", "data/delays.stan");
    reader.add_event(556, 14, "restart", "model_estimate_infections");
    reader.add_event(556, 14, "include", "data/gaussian_process.stan");
    reader.add_event(556, 0, "start", "data/gaussian_process.stan");
    reader.add_event(566, 10, "end", "data/gaussian_process.stan");
    reader.add_event(566, 15, "restart", "model_estimate_infections");
    reader.add_event(566, 15, "include", "data/generation_time.stan");
    reader.add_event(566, 0, "start", "data/generation_time.stan");
    reader.add_event(571, 5, "end", "data/generation_time.stan");
    reader.add_event(571, 16, "restart", "model_estimate_infections");
    reader.add_event(571, 16, "include", "data/rt.stan");
    reader.add_event(571, 0, "start", "data/rt.stan");
    reader.add_event(581, 10, "end", "data/rt.stan");
    reader.add_event(581, 17, "restart", "model_estimate_infections");
    reader.add_event(581, 17, "include", "data/backcalc.stan");
    reader.add_event(581, 0, "start", "data/backcalc.stan");
    reader.add_event(583, 2, "end", "data/backcalc.stan");
    reader.add_event(583, 18, "restart", "model_estimate_infections");
    reader.add_event(583, 18, "include", "data/observation_model.stan");
    reader.add_event(583, 0, "start", "data/observation_model.stan");
    reader.add_event(596, 13, "end", "data/observation_model.stan");
    reader.add_event(596, 19, "restart", "model_estimate_infections");
    reader.add_event(719, 140, "end", "model_estimate_infections");
    return reader;
}
...
report_rng(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& reports,
    ...
    try {
        ...
        local_scalar_t__ large_phi(DUMMY_VAR__);
        (void) large_phi;  // dummy to suppress unused var warning
        stan::math::initialize(large_phi, DUMMY_VAR__);
        stan::math::fill(large_phi, DUMMY_VAR__);
        stan::math::assign(large_phi,1e4);
        ...
        if (as_bool(model_type)) {
            ...
            for (int s = 1; s <= t; ++s) {
                ...
                if (as_bool(logical_gt(sqrt_phi, large_phi))) {
                    current_statement_begin__ = 527;
                    stan::model::assign(sampled_reports, 
                                stan::model::cons_list(stan::model::index_uni(s), stan::model::nil_index_list()), 
                                poisson_rng((logical_gt(get_base1(reports, s, "reports", 1), large) ? stan::math::promote_scalar<local_scalar_t__>(large) : stan::math::promote_scalar<local_scalar_t__>(get_base1(reports, s, "reports", 1)) ), base_rng__), 
                                "assigning variable sampled_reports");
                } else {
                    current_statement_begin__ = 529;
                    stan::model::assign(sampled_reports, 
                                stan::model::cons_list(stan::model::index_uni(s), stan::model::nil_index_list()), 
                                neg_binomial_2_rng((logical_gt(get_base1(reports, s, "reports", 1), large) ? stan::math::promote_scalar<local_scalar_t__>(large) : stan::math::promote_scalar<local_scalar_t__>(get_base1(reports, s, "reports", 1)) ), sqrt_phi, base_rng__), 
                                "assigning variable sampled_reports");
                }
            }
        } else {
