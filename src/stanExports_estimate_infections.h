...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(333, 331, "end", "model_estimate_infections");
    return reader;
}
        ...
        try {
            ...
            for (int s = 1; s <= t; ++s) {
                ...
                stan::model::assign(imputed_infections, 
                            stan::model::cons_list(stan::model::index_uni(s), stan::model::nil_index_list()), 
                            poisson_rng((logical_gt(get_base1(infections, s, "infections", 1), 1e8) ? stan::math::promote_scalar<local_scalar_t__>(1e8) : stan::math::promote_scalar<local_scalar_t__>(get_base1(infections, s, "infections", 1)) ), base_rng__), 
