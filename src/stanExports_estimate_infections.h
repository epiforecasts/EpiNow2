...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(236, 54, "end", "functions/rt.stan");
    reader.add_event(236, 5, "restart", "model_estimate_infections");
    reader.add_event(236, 5, "include", "functions/infections.stan");
    reader.add_event(236, 0, "start", "functions/infections.stan");
    reader.add_event(323, 87, "end", "functions/infections.stan");
    reader.add_event(323, 6, "restart", "model_estimate_infections");
    reader.add_event(323, 6, "include", "functions/observation_model.stan");
    reader.add_event(323, 0, "start", "functions/observation_model.stan");
    reader.add_event(456, 133, "end", "functions/observation_model.stan");
    reader.add_event(456, 7, "restart", "model_estimate_infections");
    reader.add_event(456, 7, "include", "functions/generated_quantities.stan");
    reader.add_event(456, 0, "start", "functions/generated_quantities.stan");
    reader.add_event(502, 46, "end", "functions/generated_quantities.stan");
    reader.add_event(502, 8, "restart", "model_estimate_infections");
    reader.add_event(506, 12, "include", "data/observations.stan");
    reader.add_event(506, 0, "start", "data/observations.stan");
    reader.add_event(512, 6, "end", "data/observations.stan");
    reader.add_event(512, 13, "restart", "model_estimate_infections");
    reader.add_event(512, 13, "include", "data/delays.stan");
    reader.add_event(512, 0, "start", "data/delays.stan");
    reader.add_event(518, 6, "end", "data/delays.stan");
    reader.add_event(518, 14, "restart", "model_estimate_infections");
    reader.add_event(518, 14, "include", "data/gaussian_process.stan");
    reader.add_event(518, 0, "start", "data/gaussian_process.stan");
    reader.add_event(528, 10, "end", "data/gaussian_process.stan");
    reader.add_event(528, 15, "restart", "model_estimate_infections");
    reader.add_event(528, 15, "include", "data/generation_time.stan");
    reader.add_event(528, 0, "start", "data/generation_time.stan");
    reader.add_event(533, 5, "end", "data/generation_time.stan");
    reader.add_event(533, 16, "restart", "model_estimate_infections");
    reader.add_event(533, 16, "include", "data/rt.stan");
    reader.add_event(533, 0, "start", "data/rt.stan");
    reader.add_event(543, 10, "end", "data/rt.stan");
    reader.add_event(543, 17, "restart", "model_estimate_infections");
    reader.add_event(543, 17, "include", "data/backcalc.stan");
    reader.add_event(543, 0, "start", "data/backcalc.stan");
    reader.add_event(545, 2, "end", "data/backcalc.stan");
    reader.add_event(545, 18, "restart", "model_estimate_infections");
    reader.add_event(545, 18, "include", "data/observation_model.stan");
    reader.add_event(545, 0, "start", "data/observation_model.stan");
    reader.add_event(558, 13, "end", "data/observation_model.stan");
    reader.add_event(558, 19, "restart", "model_estimate_infections");
    reader.add_event(681, 140, "end", "model_estimate_infections");
    return reader;
}
