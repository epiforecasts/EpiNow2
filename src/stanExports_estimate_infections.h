...
convolve(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& cases,
         const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& rev_pmf,
         std::ostream* pstream__) {
        ...
        stan::model::assign(
            ...
            (stan::model::rvalue(
                 ...
                 stan::model::cons_list(stan::model::index_uni(s),
                                        stan::model::nil_index_list()),
                 "conv_cases") +
             dot_product(stan::model::rvalue(
                             cases,
                             stan::model::cons_list(
                                 stan::model::index_min_max(
                                     std::max(1, ((s - max_pmf) + 1)), s),
                                 stan::model::nil_index_list()),
                             "cases"),
                         tail(rev_pmf, std::min(max_pmf, s)))),
...
convolve_to_report(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& infections,
                   ...
                   const std::vector<int>& max_delay, const int& seeding_time,
                   std::ostream* pstream__) {
  ...
  try {
    {
      ...
      validate_non_negative_index("reports", "(t - seeding_time)",
                                  (t - seeding_time));
      Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> reports(
          (t - seeding_time));
        ...
        for (int s = 1; s <= delays; ++s) {
          {
            ...
            validate_non_negative_index(
                "pmf", "get_base1(max_delay, s, \"max_delay\", 1)",
                get_base1(max_delay, s, "max_delay", 1));
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> pmf(
                get_base1(max_delay, s, "max_delay", 1));
            stan::math::initialize(pmf, DUMMY_VAR__);
            stan::math::fill(pmf, DUMMY_VAR__);
            stan::math::assign(
                pmf, rep_vector(1e-5, get_base1(max_delay, s, "max_delay", 1)));
            current_statement_begin__ = 82;
            validate_non_negative_index(
                "delay_indexes", "get_base1(max_delay, s, \"max_delay\", 1)",
                get_base1(max_delay, s, "max_delay", 1));
            std::vector<int> delay_indexes(
                get_base1(max_delay, s, "max_delay", 1), int(0));
            ...
            stan::math::assign(
                pmf, add(pmf, discretised_lognormal_pmf(
                                  delay_indexes,
                                  get_base1(delay_mean, s, "delay_mean", 1),
                                  get_base1(delay_sd, s, "delay_sd", 1),
                                  get_base1(max_delay, s, "max_delay", 1),
                                  pstream__)));
            current_statement_begin__ = 88;
            stan::math::assign(unobs_reports,
                               convolve(unobs_reports, pmf, pstream__));
          }
        }
        current_statement_begin__ = 90;
        stan::math::assign(
            reports, stan::model::rvalue(
                         unobs_reports,
                         stan::model::cons_list(
...
struct convolve_to_report_functor__ {
  ...
  operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& infections,
             ...
             const std::vector<int>& max_delay, const int& seeding_time,
             std::ostream* pstream__) const {
    return convolve_to_report(infections, delay_mean, delay_sd, max_delay,
                              seeding_time, pstream__);
  }
};
template <typename T0__, typename T1__, typename T2__, typename T3__,
          typename T4__, typename T5__, typename T_lp__, typename T_lp_accum__>
void delays_lp(const std::vector<T0__>& delay_mean,
               ...
               const std::vector<T5__>& delay_sd_sd, const int& weight,
  ...
  try {
    {
      ...
      if (as_bool(delays)) {
        ...
        for (int s = 1; s <= delays; ++s) {
          ...
          lp_accum__.add(
              (normal_log(get_base1(delay_mean, s, "delay_mean", 1),
                          get_base1(delay_mean_mean, s, "delay_mean_mean", 1),
                          get_base1(delay_mean_sd, s, "delay_mean_sd", 1)) *
               weight));
          current_statement_begin__ = 103;
          lp_accum__.add(
              (normal_log(get_base1(delay_sd, s, "delay_sd", 1),
                          get_base1(delay_sd_mean, s, "delay_sd_mean", 1),
                          get_base1(delay_sd_sd, s, "delay_sd_sd", 1)) *
               weight));
        }
      }
    }
...
struct delays_lp_functor__ {
  ...
  void operator()(const std::vector<T0__>& delay_mean,
                  const std::vector<T1__>& delay_mean_mean,
                  const std::vector<T2__>& delay_mean_sd,
                  const std::vector<T3__>& delay_sd,
                  const std::vector<T4__>& delay_sd_mean,
                  ...
                  T_lp__& lp__, T_lp_accum__& lp_accum__,
                  std::ostream* pstream__) const {
    return delays_lp(delay_mean, delay_mean_mean, delay_mean_sd, delay_sd,
                     delay_sd_mean, delay_sd_sd, weight, lp__, lp_accum__,
                     pstream__);
  }
};
template <typename T0__>
typename boost::math::tools::promote_args<T0__>::type lambda(
    const T0__& L, const int& m, std::ostream* pstream__) {
  typedef
      typename boost::math::tools::promote_args<T0__>::type local_scalar_t__;
  typedef local_scalar_t__ fun_return_scalar_t__;
  const static bool propto__ = true;
...
struct lambda_functor__ {
  template <typename T0__>
  typename boost::math::tools::promote_args<T0__>::type operator()(
      const T0__& L, const int& m, std::ostream* pstream__) const {
  ...
  try {
    {
      ...
      stan::math::assign(
          fi, multiply((1 / stan::math::sqrt(L)),
                       stan::math::sin(multiply(
                           ((m * stan::math::pi()) / (2 * L)), add(x, L)))));
...
struct phi_functor__ {
  ...
  Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T2__>::type,
                Eigen::Dynamic, 1>
  operator()(const T0__& L, const int& m,
             const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& x,
             std::ostream* pstream__) const {
    return phi(L, m, x, pstream__);
  }
};
template <typename T0__, typename T1__, typename T2__>
typename boost::math::tools::promote_args<T0__, T1__, T2__>::type spd_se(
    const T0__& alpha, const T1__& rho, const T2__& w,
    std::ostream* pstream__) {
  typedef typename boost::math::tools::promote_args<T0__, T1__, T2__>::type
      local_scalar_t__;
  typedef local_scalar_t__ fun_return_scalar_t__;
  ...
  try {
    {
      ...
      stan::math::assign(
          S,
          (((pow(alpha, 2) * stan::math::sqrt((2 * stan::math::pi()))) * rho) *
...
struct spd_se_functor__ {
  template <typename T0__, typename T1__, typename T2__>
  typename boost::math::tools::promote_args<T0__, T1__, T2__>::type operator()(
      const T0__& alpha, const T1__& rho, const T2__& w,
      std::ostream* pstream__) const {
...
template <typename T0__, typename T1__, typename T2__>
typename boost::math::tools::promote_args<T0__, T1__, T2__>::type spd_matern(
    const T0__& alpha, const T1__& rho, const T2__& w,
    std::ostream* pstream__) {
  typedef typename boost::math::tools::promote_args<T0__, T1__, T2__>::type
      local_scalar_t__;
  ...
  try {
    {
      ...
      stan::math::assign(
          S,
          ((((4 * pow(alpha, 2)) * pow((stan::math::sqrt(3) / rho), 3)) * 1) /
...
int setup_noise(const int& ot_h, const int& t, const int& horizon,
  ...
  try {
    {
      ...
      stan::math::assign(noise_time,
                         (logical_gt(estimate_r, 0)
                              ? (logical_gt(stationary, 0) ? ot_h : (ot_h - 1))
                              : t));
      ...
      stan::math::assign(
          noise_terms,
          (logical_gt(future_fixed, 0) ? ((noise_time - horizon) + fixed_from)
                                       : noise_time));
...
struct setup_noise_functor__ {
  int operator()(const int& ot_h, const int& t, const int& horizon,
                 const int& estimate_r, const int& stationary,
                 const int& future_fixed, const int& fixed_from,
                 std::ostream* pstream__) const {
...
Eigen::Matrix<typename boost::math::tools::promote_args<T1__>::type,
              Eigen::Dynamic, Eigen::Dynamic>
setup_gp(const int& M, const T1__& L, const int& dimension,
         std::ostream* pstream__) {
  typedef
      typename boost::math::tools::promote_args<T1__>::type local_scalar_t__;
  typedef local_scalar_t__ fun_return_scalar_t__;
  const static bool propto__ = true;
  (void)propto__;
  local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
      ...
      for (int m = 1; m <= M; ++m) {
        ...
        stan::model::assign(
            ...
            stan::model::cons_list(
                ...
                stan::model::cons_list(stan::model::index_uni(m),
                                       stan::model::nil_index_list())),
...
Eigen::Matrix<typename boost::math::tools::promote_args<
                  T0__, T2__, T3__, T4__,
                  typename boost::math::tools::promote_args<T5__>::type>::type,
              Eigen::Dynamic, 1>
update_gp(const Eigen::Matrix<T0__, Eigen::Dynamic, Eigen::Dynamic>& PHI,
          const int& M, const T2__& L, const T3__& alpha, const T4__& rho,
          const Eigen::Matrix<T5__, Eigen::Dynamic, 1>& eta, const int& type,
          std::ostream* pstream__) {
  typedef typename boost::math::tools::promote_args<
      T0__, T2__, T3__, T4__,
      typename boost::math::tools::promote_args<T5__>::type>::type
  ...
  try {
    {
      ...
      if (as_bool(logical_eq(type, 0))) {
        ...
        for (int m = 1; m <= M; ++m) {
          ...
          stan::model::assign(
              ...
              stan::model::cons_list(stan::model::index_uni(m),
                                     stan::model::nil_index_list()),
              stan::math::sqrt(spd_se(alpha, unit_rho,
                                      stan::math::sqrt(lambda(L, m, pstream__)),
                                      pstream__)),
        ...
        for (int m = 1; m <= M; ++m) {
          ...
          stan::model::assign(
              ...
              stan::model::cons_list(stan::model::index_uni(m),
                                     stan::model::nil_index_list()),
              stan::math::sqrt(spd_matern(
                  alpha, unit_rho, stan::math::sqrt(lambda(L, m, pstream__)),
                  pstream__)),
              "assigning variable diagSPD");
        }
      }
      ...
      stan::math::assign(
          noise,
          add(noise, multiply(stan::model::rvalue(
                                  PHI,
                                  stan::model::cons_list(
                                      stan::model::index_omni(),
                                      stan::model::cons_list(
...
void gaussian_process_lp(const T0__& rho, const T1__& alpha,
                         const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& eta,
                         const T3__& ls_meanlog, const T4__& ls_sdlog,
                         const T5__& ls_min, const T6__& ls_max,
                         const T7__& alpha_sd, T_lp__& lp__,
                         T_lp_accum__& lp_accum__, std::ostream* pstream__) {
  typedef typename boost::math::tools::promote_args<
      T0__, T1__, T2__, T3__,
      typename boost::math::tools::promote_args<
          T4__, T5__, T6__, T7__, T_lp__>::type>::type local_scalar_t__;
  typedef local_scalar_t__ fun_return_scalar_t__;
  const static bool propto__ = true;
  (void)propto__;
  local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
...
struct gaussian_process_lp_functor__ {
  template <typename T0__, typename T1__, typename T2__, typename T3__,
            typename T4__, typename T5__, typename T6__, typename T7__,
            typename T_lp__, typename T_lp_accum__>
  void operator()(const T0__& rho, const T1__& alpha,
                  const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& eta,
                  const T3__& ls_meanlog, const T4__& ls_sdlog,
                  const T5__& ls_min, const T6__& ls_max, const T7__& alpha_sd,
                  T_lp__& lp__, T_lp_accum__& lp_accum__,
                  std::ostream* pstream__) const {
    return gaussian_process_lp(rho, alpha, eta, ls_meanlog, ls_sdlog, ls_min,
                               ls_max, alpha_sd, lp__, lp_accum__, pstream__);
  }
};
  ...
  try {
    {
      ...
      if (as_bool(gp_n)) {
        ...
        if (as_bool(stationary)) {
          ...
          stan::model::assign(
              gp,
              stan::model::cons_list(stan::model::index_min_max(1, gp_n),
                                     stan::model::nil_index_list()),
          ...
          stan::model::assign(
              gp,
              stan::model::cons_list(stan::model::index_min_max(2, (gp_n + 1)),
                                     stan::model::nil_index_list()),
              noise, "assigning variable gp");
...
struct update_Rt_functor__ {
  ...
  operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& input_R,
    ...
    return update_Rt(input_R, log_R, noise, bps, bp_effects, stationary,
                     pstream__);
  }
};
template <typename T0__, typename T1__, typename T2__, typename T3__,
          typename T4__, typename T7__, typename T8__, typename T9__,
          typename T10__, typename T_lp__, typename T_lp_accum__>
void rt_lp(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& log_R,
  ...
  typedef typename boost::math::tools::promote_args<
      ...
      typename boost::math::tools::promote_args<
          T4__, T7__, T8__, T9__,
          typename boost::math::tools::promote_args<T10__, T_lp__>::type>::
          type>::type local_scalar_t__;
  typedef local_scalar_t__ fun_return_scalar_t__;
  const static bool propto__ = true;
  (void)propto__;
  local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
  ...
  try {
    ...
    if (as_bool(logical_gt(bp_n, 0))) {
      ...
      lp_accum__.add(
          normal_log<propto__>(get_base1(bp_sd, 1, "bp_sd", 1), 0, 0.1));
      if (get_base1(bp_sd, 1, "bp_sd", 1) < 0)
        lp_accum__.add(-std::numeric_limits<double>::infinity());
      else
        lp_accum__.add(-normal_ccdf_log(0, 0, 0.1));
      current_statement_begin__ = 233;
      lp_accum__.add(
          normal_log<propto__>(bp_effects, 0, get_base1(bp_sd, 1, "bp_sd", 1)));
    }
    current_statement_begin__ = 236;
    lp_accum__.add(
        normal_log<propto__>(initial_infections, prior_infections, 0.2));
...
struct rt_lp_functor__ {
  template <typename T0__, typename T1__, typename T2__, typename T3__,
            typename T4__, typename T7__, typename T8__, typename T9__,
            typename T10__, typename T_lp__, typename T_lp_accum__>
  void operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& log_R,
                  const std::vector<T1__>& initial_infections,
                  const std::vector<T2__>& initial_growth,
                  ...
                  const T8__& r_logsd, const T9__& prior_infections,
                  const T10__& prior_growth, T_lp__& lp__,
                  T_lp_accum__& lp_accum__, std::ostream* pstream__) const {
    return rt_lp(log_R, initial_infections, initial_growth, bp_effects, bp_sd,
                 bp_n, seeding_time, r_logmean, r_logsd, prior_infections,
...
update_infectiousness(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& infections,
                      ...
                      const int& seeding_time, const int& max_gt,
  ...
  try {
    {
      ...
      stan::math::assign(inf_start,
                         std::max(1, ((index + seeding_time) - max_gt)));
      ...
      stan::math::assign(pmf_accessed,
                         std::min(max_gt, ((index + seeding_time) - 1)));
...
struct update_infectiousness_functor__ {
  template <typename T0__, typename T1__>
  typename boost::math::tools::promote_args<T0__, T1__>::type operator()(
      const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& infections,
      const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& gt_pmf,
      const int& seeding_time, const int& max_gt, const int& index,
      std::ostream* pstream__) const {
    return update_infectiousness(infections, gt_pmf, seeding_time, max_gt,
                                 index, pstream__);
  }
};
template <typename T0__, typename T2__, typename T3__, typename T5__,
          typename T6__>
Eigen::Matrix<typename boost::math::tools::promote_args<
                  T0__, T2__, T3__, T5__,
                  typename boost::math::tools::promote_args<T6__>::type>::type,
              Eigen::Dynamic, 1>
generate_infections(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& oR,
                    const int& uot, const std::vector<T2__>& gt_mean,
                    const std::vector<T3__>& gt_sd, const int& max_gt,
                    const std::vector<T5__>& initial_infections,
                    const std::vector<T6__>& initial_growth, const int& pop,
  ...
  try {
    {
      ...
      for (int i = 1; i <= max_gt; ++i) {
        ...
        stan::model::assign(
            ...
            stan::model::cons_list(stan::model::index_uni(i),
                                   stan::model::nil_index_list()),
            ((max_gt - i) + 1), "assigning variable gt_indexes");
      }
      current_statement_begin__ = 271;
      stan::math::assign(
          gt_pmf,
          add(gt_pmf, discretised_gamma_pmf(
                          gt_indexes, get_base1(gt_mean, 1, "gt_mean", 1),
                          get_base1(gt_sd, 1, "gt_sd", 1), max_gt, pstream__)));
      current_statement_begin__ = 273;
      stan::model::assign(infections,
                          stan::model::cons_list(stan::model::index_uni(1),
                                                 stan::model::nil_index_list()),
                          stan::math::exp(get_base1(initial_infections, 1,
        ...
        for (int s = 2; s <= uot; ++s) {
          ...
          stan::model::assign(
              ...
              stan::model::cons_list(stan::model::index_uni(s),
                                     stan::model::nil_index_list()),
              stan::math::exp(
                  (get_base1(initial_infections, 1, "initial_infections", 1) +
                   (get_base1(initial_growth, 1, "initial_growth", 1) *
                    (s - 1)))),
              "assigning variable infections");
        }
      }
      ...
      if (as_bool(pop)) {
        ...
        stan::model::assign(
            ...
            stan::model::cons_list(stan::model::index_uni(1),
                                   stan::model::nil_index_list()),
            sum(stan::model::rvalue(
                infections,
                stan::model::cons_list(stan::model::index_min_max(1, uot),
                                       stan::model::nil_index_list()),
                "infections")),
      ...
      for (int s = 1; s <= ot; ++s) {
        ...
        stan::model::assign(
            ...
            (stan::model::rvalue(
                 ...
                 stan::model::cons_list(stan::model::index_uni(s),
                                        stan::model::nil_index_list()),
                 "infectiousness") +
             update_infectiousness(infections, gt_pmf, uot, max_gt, s,
                                   pstream__)),
            "assigning variable infectiousness");
        current_statement_begin__ = 286;
        if (as_bool((primitive_value(pop) &&
                     primitive_value(logical_gt(s, nht))))) {
          current_statement_begin__ = 287;
          stan::math::assign(
              exp_adj_Rt,
              stan::math::exp(
                  ((-(get_base1(R, s, "R", 1)) *
                    get_base1(infectiousness, s, "infectiousness", 1)) /
                   (pop -
                    get_base1(cum_infections, nht, "cum_infections", 1)))));
          current_statement_begin__ = 288;
          stan::math::assign(
              exp_adj_Rt,
              (logical_gt(exp_adj_Rt, 1)
                   ? stan::math::promote_scalar<local_scalar_t__>(1)
                   : stan::math::promote_scalar<local_scalar_t__>(exp_adj_Rt)));
          current_statement_begin__ = 289;
          stan::model::assign(
              infections,
              stan::model::cons_list(stan::model::index_uni((s + uot)),
                                     stan::model::nil_index_list()),
              ((pop - get_base1(cum_infections, s, "cum_infections", 1)) *
               (1 - exp_adj_Rt)),
              "assigning variable infections");
        } else {
        ...
        if (as_bool(
                (primitive_value(pop) && primitive_value(logical_lt(s, ot))))) {
          current_statement_begin__ = 294;
          stan::model::assign(
              cum_infections,
              stan::model::cons_list(stan::model::index_uni((s + 1)),
                                     stan::model::nil_index_list()),
              (get_base1(cum_infections, s, "cum_infections", 1) +
               get_base1(infections, (s + uot), "infections", 1)),
              "assigning variable cum_infections");
        }
      }
...
struct generate_infections_functor__ {
  ...
  Eigen::Matrix<
      typename boost::math::tools::promote_args<
          ...
          typename boost::math::tools::promote_args<T6__>::type>::type,
      Eigen::Dynamic, 1>
  operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& oR, const int& uot,
             const std::vector<T2__>& gt_mean, const std::vector<T3__>& gt_sd,
             const int& max_gt, const std::vector<T5__>& initial_infections,
             const std::vector<T6__>& initial_growth, const int& pop,
             const int& ht, std::ostream* pstream__) const {
    return generate_infections(oR, uot, gt_mean, gt_sd, max_gt,
                               initial_infections, initial_growth, pop, ht,
                               pstream__);
  }
};
template <typename T0__, typename T1__>
...
deconvolve_infections(
    const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& shifted_cases,
    const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& noise, const int& fixed,
      ...
      if (as_bool(logical_negation(fixed))) {
        {
          ...
          if (as_bool(logical_eq(prior, 1))) {
            ...
            stan::math::assign(
                infections,
                add(infections, elt_multiply(shifted_cases, exp_noise)));
            ...
            stan::model::assign(
                ...
                stan::model::cons_list(stan::model::index_uni(1),
                                       stan::model::nil_index_list()),
                (get_base1(infections, 1, "infections", 1) +
                 (get_base1(shifted_cases, 1, "shifted_cases", 1) *
                  get_base1(exp_noise, 1, "exp_noise", 1))),
                "assigning variable infections");
            ...
            for (int i = 2; i <= t; ++i) {
              ...
              stan::model::assign(
                  ...
                  stan::model::cons_list(stan::model::index_uni(i),
                                         stan::model::nil_index_list()),
                  (get_base1(infections, (i - 1), "infections", 1) *
                   get_base1(exp_noise, i, "exp_noise", 1)),
                  "assigning variable infections");
            }
          }
        }
...
struct deconvolve_infections_functor__ {
  ...
  operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& shifted_cases,
             ...
             const int& fixed, const int& prior,
             std::ostream* pstream__) const {
...
template <typename T0__, typename T1__, typename T2__, typename T3__,
          typename T4__, typename T5__, typename T_lp__, typename T_lp_accum__>
void generation_time_lp(const std::vector<T0__>& gt_mean,
                        const T1__& gt_mean_mean, const T2__& gt_mean_sd,
                        const std::vector<T3__>& gt_sd, const T4__& gt_sd_mean,
                        const T5__& gt_sd_sd, const int& weight, T_lp__& lp__,
                        T_lp_accum__& lp_accum__, std::ostream* pstream__) {
  typedef typename boost::math::tools::promote_args<
      T0__, T1__, T2__, T3__,
      typename boost::math::tools::promote_args<T4__, T5__, T_lp__>::type>::type
  ...
  try {
    ...
    lp_accum__.add((normal_log(get_base1(gt_mean, 1, "gt_mean", 1),
                               gt_mean_mean, gt_mean_sd) *
                    weight));
    current_statement_begin__ = 325;
    lp_accum__.add(
        (normal_log(get_base1(gt_sd, 1, "gt_sd", 1), gt_sd_mean, gt_sd_sd) *
         weight));
  } catch (const std::exception& e) {
    stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    // Next line prevents compiler griping about no return
...
struct generation_time_lp_functor__ {
  template <typename T0__, typename T1__, typename T2__, typename T3__,
            typename T4__, typename T5__, typename T_lp__,
            typename T_lp_accum__>
  void operator()(const std::vector<T0__>& gt_mean, const T1__& gt_mean_mean,
                  const T2__& gt_mean_sd, const std::vector<T3__>& gt_sd,
                  const T4__& gt_sd_mean, const T5__& gt_sd_sd,
                  const int& weight, T_lp__& lp__, T_lp_accum__& lp_accum__,
                  std::ostream* pstream__) const {
    return generation_time_lp(gt_mean, gt_mean_mean, gt_mean_sd, gt_sd,
                              gt_sd_mean, gt_sd_sd, weight, lp__, lp_accum__,
                              pstream__);
  }
};
template <typename T0__, typename T2__>
...
Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T2__, T3__>::type,
              Eigen::Dynamic, 1>
calculate_Rt(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& infections,
             const int& seeding_time, const T2__& gt_mean, const T3__& gt_sd,
             const int& max_gt, const int& smooth, std::ostream* pstream__) {
  typedef typename boost::math::tools::promote_args<T0__, T2__, T3__>::type
      local_scalar_t__;
  typedef local_scalar_t__ fun_return_scalar_t__;
  const static bool propto__ = true;
  (void)propto__;
  ...
  try {
    {
      ...
      stan::math::assign(
          gt_pmf,
          discretised_gamma_pmf(gt_indexes, gt_mean, gt_sd, max_gt, pstream__));
      ...
      for (int s = 1; s <= ot; ++s) {
        ...
        stan::model::assign(
            ...
            (stan::model::rvalue(
                 ...
                 stan::model::cons_list(stan::model::index_uni(s),
                                        stan::model::nil_index_list()),
                 "infectiousness") +
             update_infectiousness(infections, gt_pmf, seeding_time, max_gt, s,
                                   pstream__)),
            "assigning variable infectiousness");
        ...
        stan::model::assign(
            ...
            stan::model::cons_list(stan::model::index_uni(s),
                                   stan::model::nil_index_list()),
            (get_base1(infections, (s + seeding_time), "infections", 1) /
             get_base1(infectiousness, s, "infectiousness", 1)),
        ...
        for (int s = 1; s <= ot; ++s) {
          {
            ...
            stan::model::assign(
                ...
                stan::model::cons_list(stan::model::index_uni(s),
                                       stan::model::nil_index_list()),
                (get_base1(sR, s, "sR", 1) / window), "assigning variable sR");
          }
        }
      } else {
...
struct calculate_Rt_functor__ {
  ...
  operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& infections,
             const int& seeding_time, const T2__& gt_mean, const T3__& gt_sd,
             const int& max_gt, const int& smooth,
             std::ostream* pstream__) const {
    return calculate_Rt(infections, seeding_time, gt_mean, gt_sd, max_gt,
                        smooth, pstream__);
  }
};
template <typename T0__, typename T1__, typename T2__>
...
R_to_growth(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& R,
            const T1__& gt_mean, const T2__& gt_sd, std::ostream* pstream__) {
  typedef typename boost::math::tools::promote_args<T0__, T1__, T2__>::type
      local_scalar_t__;
  typedef local_scalar_t__ fun_return_scalar_t__;
  const static bool propto__ = true;
...
struct R_to_growth_functor__ {
  ...
  operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& R,
             const T1__& gt_mean, const T2__& gt_sd,
             std::ostream* pstream__) const {
 ...
 public:
  ...
  void ctor_body(stan::io::var_context& context__, unsigned int random_seed__,
    ...
    try {
      ...
      context__.validate_dims("data initialization", "delays", "int",
                              context__.to_vec());
      delays = int(0);
      ...
      context__.validate_dims("data initialization", "delay_mean_mean",
                              "double", context__.to_vec(delays));
      ...
      context__.validate_dims("data initialization", "gt_mean_sd", "double",
                              context__.to_vec());
      gt_mean_sd = double(0);
      ...
      context__.validate_dims("data initialization", "gt_mean_mean", "double",
                              context__.to_vec());
      ...
      context__.validate_dims("data initialization", "gt_sd_mean", "double",
                              context__.to_vec());
      gt_sd_mean = double(0);
      ...
      context__.validate_dims("data initialization", "gt_sd_sd", "double",
                              context__.to_vec());
      gt_sd_sd = double(0);
      ...
      context__.validate_dims("data initialization", "max_gt", "int",
                              context__.to_vec());
      max_gt = int(0);
      ...
      context__.validate_dims("data initialization", "truncation", "int",
                              context__.to_vec());
      truncation = int(0);
      ...
      context__.validate_dims("data initialization", "trunc_mean_mean",
                              "double", context__.to_vec(truncation));
      ...
      context__.validate_dims("data initialization", "trunc_mean_sd", "double",
                              context__.to_vec(truncation));
      ...
      context__.validate_dims("data initialization", "trunc_sd_mean", "double",
                              context__.to_vec(truncation));
      ...
      context__.validate_dims("data initialization", "trunc_sd_sd", "double",
                              context__.to_vec(truncation));
      ...
      context__.validate_dims("data initialization", "max_truncation", "int",
                              context__.to_vec(truncation));
      ...
      context__.validate_dims("data initialization", "obs_scale_mean", "double",
                              context__.to_vec());
      ...
      noise_terms = int(0);
      stan::math::fill(noise_terms, std::numeric_limits<int>::min());
      stan::math::assign(noise_terms,
                         setup_noise(ot_h, t, horizon, estimate_r, stationary,
                                     future_fixed, fixed_from, pstream__));
      current_statement_begin__ = 571;
      validate_non_negative_index("PHI", "noise_terms", noise_terms);
      validate_non_negative_index("PHI", "M", M);
      PHI =
          Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(noise_terms, M);
      stan::math::fill(PHI, DUMMY_VAR__);
      ...
      stan::math::assign(
          r_logmean,
          stan::math::log((pow(r_mean, 2) /
                           stan::math::sqrt((pow(r_sd, 2) + pow(r_mean, 2))))));
      current_statement_begin__ = 574;
      r_logsd = double(0);
      stan::math::fill(r_logsd, DUMMY_VAR__);
      stan::math::assign(r_logsd, stan::math::sqrt(stan::math::log(
                                      (1 + (pow(r_sd, 2) / pow(r_mean, 2))))));
      ...
      validate_non_negative_index(
          "initial_growth",
          "((primitive_value(estimate_r) && "
          "primitive_value(logical_gt(seeding_time, 1))) ? 1 : 0 )",
          ((primitive_value(estimate_r) &&
            primitive_value(logical_gt(seeding_time, 1)))
               ? 1
               : 0));
      num_params_r__ += (1 * ((primitive_value(estimate_r) &&
                               primitive_value(logical_gt(seeding_time, 1)))
                                  ? 1
                                  : 0));
      ...
      validate_non_negative_index("bp_sd", "(logical_gt(bp_n, 0) ? 1 : 0 )",
                                  (logical_gt(bp_n, 0) ? 1 : 0));
      ...
      validate_non_negative_index("day_of_week_simplex",
                                  "(week_effect ? 7 : 1 )",
                                  (week_effect ? 7 : 1));
  ...
  void transform_inits(const stan::io::var_context& context__,
    ...
    if (!(context__.contains_r("alpha")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable alpha missing")),
          current_statement_begin__, prog_reader__());
    ...
    if (!(context__.contains_r("eta")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable eta missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("eta");
    pos__ = 0U;
    validate_non_negative_index("eta", "(fixed ? 0 : M )", (fixed ? 0 : M));
    context__.validate_dims("parameter initialization", "eta", "vector_d",
                            context__.to_vec((fixed ? 0 : M)));
    ...
    try {
      ...
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Error transforming variable eta: ") +
                             e.what()),
          current_statement_begin__, prog_reader__());
    }
    current_statement_begin__ = 583;
    if (!(context__.contains_r("log_R")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable log_R missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("log_R");
    pos__ = 0U;
    validate_non_negative_index("log_R", "estimate_r", estimate_r);
    context__.validate_dims("parameter initialization", "log_R", "vector_d",
                            context__.to_vec(estimate_r));
    ...
    for (size_t i_0__ = 0; i_0__ < initial_infections_i_0_max__; ++i_0__) {
      try {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string(
                    "Error transforming variable initial_infections: ") +
                e.what()),
            current_statement_begin__, prog_reader__());
      }
    }
    ...
    if (!(context__.contains_r("initial_growth")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable initial_growth missing")),
          current_statement_begin__, prog_reader__());
    ...
    context__.validate_dims(
        "parameter initialization", "initial_growth", "double",
        context__.to_vec(((primitive_value(estimate_r) &&
                           primitive_value(logical_gt(seeding_time, 1)))
                              ? 1
                              : 0)));
    std::vector<double> initial_growth(
        ((primitive_value(estimate_r) &&
          primitive_value(logical_gt(seeding_time, 1)))
             ...
             : 0),
        double(0));
    size_t initial_growth_k_0_max__ =
        ((primitive_value(estimate_r) &&
          primitive_value(logical_gt(seeding_time, 1)))
             ? 1
             : 0);
    ...
    size_t initial_growth_i_0_max__ =
        ((primitive_value(estimate_r) &&
          primitive_value(logical_gt(seeding_time, 1)))
             ? 1
             : 0);
    ...
    if (!(context__.contains_r("gt_mean")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable gt_mean missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("gt_mean");
    pos__ = 0U;
    validate_non_negative_index("gt_mean", "estimate_r", estimate_r);
    context__.validate_dims("parameter initialization", "gt_mean", "double",
                            context__.to_vec(estimate_r));
    ...
    for (size_t i_0__ = 0; i_0__ < gt_mean_i_0_max__; ++i_0__) {
      try {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error transforming variable gt_mean: ") +
                e.what()),
            current_statement_begin__, prog_reader__());
      }
    }
    ...
    if (!(context__.contains_r("gt_sd")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable gt_sd missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("gt_sd");
    pos__ = 0U;
    validate_non_negative_index("gt_sd", "estimate_r", estimate_r);
    context__.validate_dims("parameter initialization", "gt_sd", "double",
                            context__.to_vec(estimate_r));
    ...
    if (!(context__.contains_r("bp_sd")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable bp_sd missing")),
          current_statement_begin__, prog_reader__());
    ...
    context__.validate_dims("parameter initialization", "bp_sd", "double",
                            context__.to_vec((logical_gt(bp_n, 0) ? 1 : 0)));
    ...
    if (!(context__.contains_r("bp_effects")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable bp_effects missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("bp_effects");
    pos__ = 0U;
    validate_non_negative_index("bp_effects", "bp_n", bp_n);
    context__.validate_dims("parameter initialization", "bp_effects", "double",
                            context__.to_vec(bp_n));
    ...
    for (size_t i_0__ = 0; i_0__ < bp_effects_i_0_max__; ++i_0__) {
      try {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error transforming variable bp_effects: ") +
                e.what()),
            current_statement_begin__, prog_reader__());
      }
    }
    ...
    if (!(context__.contains_r("delay_mean")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable delay_mean missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("delay_mean");
    pos__ = 0U;
    validate_non_negative_index("delay_mean", "delays", delays);
    context__.validate_dims("parameter initialization", "delay_mean", "double",
                            context__.to_vec(delays));
    ...
    for (size_t i_0__ = 0; i_0__ < delay_mean_i_0_max__; ++i_0__) {
      try {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error transforming variable delay_mean: ") +
                e.what()),
            current_statement_begin__, prog_reader__());
      }
    }
    ...
    if (!(context__.contains_r("delay_sd")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable delay_sd missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("delay_sd");
    pos__ = 0U;
    validate_non_negative_index("delay_sd", "delays", delays);
    context__.validate_dims("parameter initialization", "delay_sd", "double",
                            context__.to_vec(delays));
    ...
    for (size_t i_0__ = 0; i_0__ < delay_sd_i_0_max__; ++i_0__) {
      try {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error transforming variable delay_sd: ") +
                e.what()),
            current_statement_begin__, prog_reader__());
      }
    }
    ...
    if (!(context__.contains_r("day_of_week_simplex")))
      stan::lang::rethrow_located(std::runtime_error(std::string(
                                      "Variable day_of_week_simplex missing")),
                                  current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("day_of_week_simplex");
    pos__ = 0U;
    validate_non_negative_index("day_of_week_simplex", "(week_effect ? 7 : 1 )",
                                (week_effect ? 7 : 1));
    context__.validate_dims("parameter initialization", "day_of_week_simplex",
                            "vector_d",
                            context__.to_vec((week_effect ? 7 : 1)));
    Eigen::Matrix<double, Eigen::Dynamic, 1> day_of_week_simplex(
        (week_effect ? 7 : 1));
    ...
    if (!(context__.contains_r("frac_obs")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable frac_obs missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("frac_obs");
    pos__ = 0U;
    validate_non_negative_index("frac_obs", "obs_scale", obs_scale);
    context__.validate_dims("parameter initialization", "frac_obs", "double",
                            context__.to_vec(obs_scale));
    ...
    for (size_t i_0__ = 0; i_0__ < frac_obs_i_0_max__; ++i_0__) {
      try {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error transforming variable frac_obs: ") +
                e.what()),
            current_statement_begin__, prog_reader__());
      }
    }
    ...
    if (!(context__.contains_r("truncation_mean")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable truncation_mean missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("truncation_mean");
    pos__ = 0U;
    validate_non_negative_index("truncation_mean", "truncation", truncation);
    context__.validate_dims("parameter initialization", "truncation_mean",
                            "double", context__.to_vec(truncation));
    ...
    for (size_t i_0__ = 0; i_0__ < truncation_mean_i_0_max__; ++i_0__) {
      try {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error transforming variable truncation_mean: ") +
                e.what()),
            current_statement_begin__, prog_reader__());
      }
    }
    ...
    if (!(context__.contains_r("truncation_sd")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable truncation_sd missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("truncation_sd");
    pos__ = 0U;
    validate_non_negative_index("truncation_sd", "truncation", truncation);
    context__.validate_dims("parameter initialization", "truncation_sd",
                            "double", context__.to_vec(truncation));
    ...
    for (size_t i_0__ = 0; i_0__ < truncation_sd_i_0_max__; ++i_0__) {
      try {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error transforming variable truncation_sd: ") +
                e.what()),
            current_statement_begin__, prog_reader__());
      }
    }
    ...
    if (!(context__.contains_r("rep_phi")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable rep_phi missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("rep_phi");
    pos__ = 0U;
    validate_non_negative_index("rep_phi", "model_type", model_type);
    context__.validate_dims("parameter initialization", "rep_phi", "double",
                            context__.to_vec(model_type));
    ...
    for (size_t i_0__ = 0; i_0__ < rep_phi_i_0_max__; ++i_0__) {
      try {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error transforming variable rep_phi: ") +
                e.what()),
            current_statement_begin__, prog_reader__());
      }
    }
  ...
  T__ log_prob(std::vector<T__>& params_r__, std::vector<int>& params_i__,
    ...
    try {
      ...
      size_t initial_growth_d_0_max__ =
          ((primitive_value(estimate_r) &&
            primitive_value(logical_gt(seeding_time, 1)))
               ? 1
               : 0);
      ...
      if (jacobian__)
        day_of_week_simplex =
            in__.simplex_constrain((week_effect ? 7 : 1), lp__);
      else
      ...
      validate_non_negative_index("noise", "(fixed ? 0 : noise_terms )",
                                  (fixed ? 0 : noise_terms));
      Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> noise(
          (fixed ? 0 : noise_terms));
      stan::math::initialize(noise, DUMMY_VAR__);
      stan::math::fill(noise, DUMMY_VAR__);
      current_statement_begin__ = 602;
      validate_non_negative_index("R",
                                  "(logical_gt(estimate_r, 0) ? ot_h : 0 )",
                                  (logical_gt(estimate_r, 0) ? ot_h : 0));
      ...
      if (as_bool(logical_negation(fixed))) {
        ...
        stan::math::assign(
            noise,
            update_gp(PHI, M, L, get_base1(alpha, 1, "alpha", 1),
                      get_base1(rho, 1, "rho", 1), eta, gp_type, pstream__));
      }
      current_statement_begin__ = 611;
      if (as_bool(estimate_r)) {
        current_statement_begin__ = 613;
        stan::math::assign(
            R, update_Rt(R, get_base1(log_R, estimate_r, "log_R", 1), noise,
                         breakpoints, bp_effects, stationary, pstream__));
        current_statement_begin__ = 614;
        stan::math::assign(
            infections,
            generate_infections(R, seeding_time, gt_mean, gt_sd, max_gt,
                                initial_infections, initial_growth, pop,
                                future_time, pstream__));
      } else {
        current_statement_begin__ = 619;
        stan::math::assign(infections,
                           deconvolve_infections(shifted_cases, noise, fixed,
                                                 backcalc_prior, pstream__));
      }
      current_statement_begin__ = 622;
      stan::math::assign(
          reports, convolve_to_report(infections, delay_mean, delay_sd,
                                      max_delay, seeding_time, pstream__));
      current_statement_begin__ = 624;
      if (as_bool(week_effect)) {
        current_statement_begin__ = 625;
        stan::math::assign(reports,
                           day_of_week_effect(reports, day_of_week,
                                              day_of_week_simplex, pstream__));
      }
      current_statement_begin__ = 628;
      if (as_bool(obs_scale)) {
        current_statement_begin__ = 629;
        stan::math::assign(
            reports, scale_obs(reports, get_base1(frac_obs, 1, "frac_obs", 1),
                               pstream__));
      }
      ...
      stan::math::assign(
          ...
          truncate(stan::model::rvalue(
                       reports,
                       stan::model::cons_list(stan::model::index_min_max(1, ot),
                                              stan::model::nil_index_list()),
                       "reports"),
                   truncation_mean, truncation_sd, max_truncation, 0,
                   pstream__));
      ...
      for (size_t j_1__ = 0; j_1__ < noise_j_1_max__; ++j_1__) {
        if (stan::math::is_uninitialized(noise(j_1__))) {
          ...
          msg__ << "Undefined transformed parameter: noise"
                << "(" << j_1__ << ")";
          stan::lang::rethrow_located(
              std::runtime_error(
                  std::string("Error initializing variable noise: ") +
                  msg__.str()),
              current_statement_begin__, prog_reader__());
        }
      }
      ...
      for (size_t j_1__ = 0; j_1__ < R_j_1_max__; ++j_1__) {
        if (stan::math::is_uninitialized(R(j_1__))) {
          std::stringstream msg__;
          msg__ << "Undefined transformed parameter: R"
                << "(" << j_1__ << ")";
          stan::lang::rethrow_located(
              std::runtime_error(
                  std::string("Error initializing variable R: ") + msg__.str()),
              current_statement_begin__, prog_reader__());
        }
      }
      ...
      for (size_t j_1__ = 0; j_1__ < infections_j_1_max__; ++j_1__) {
        if (stan::math::is_uninitialized(infections(j_1__))) {
          std::stringstream msg__;
          msg__ << "Undefined transformed parameter: infections"
                << "(" << j_1__ << ")";
          stan::lang::rethrow_located(
              std::runtime_error(
                  std::string("Error initializing variable infections: ") +
                  msg__.str()),
              current_statement_begin__, prog_reader__());
        }
      }
      ...
      for (size_t j_1__ = 0; j_1__ < reports_j_1_max__; ++j_1__) {
        if (stan::math::is_uninitialized(reports(j_1__))) {
          std::stringstream msg__;
          msg__ << "Undefined transformed parameter: reports"
                << "(" << j_1__ << ")";
          stan::lang::rethrow_located(
              std::runtime_error(
                  std::string("Error initializing variable reports: ") +
                  msg__.str()),
              current_statement_begin__, prog_reader__());
        }
      }
      ...
      for (size_t j_1__ = 0; j_1__ < obs_reports_j_1_max__; ++j_1__) {
        if (stan::math::is_uninitialized(obs_reports(j_1__))) {
          std::stringstream msg__;
          msg__ << "Undefined transformed parameter: obs_reports"
                << "(" << j_1__ << ")";
          stan::lang::rethrow_located(
              std::runtime_error(
                  std::string("Error initializing variable obs_reports: ") +
                  msg__.str()),
              current_statement_begin__, prog_reader__());
        }
      }
      ...
      if (as_bool(logical_negation(fixed))) {
        ...
        gaussian_process_lp(get_base1(rho, 1, "rho", 1),
                            get_base1(alpha, 1, "alpha", 1), eta, ls_meanlog,
                            ls_sdlog, ls_min, ls_max, alpha_sd, lp__,
                            lp_accum__, pstream__);
      }
      current_statement_begin__ = 642;
      delays_lp(delay_mean, delay_mean_mean, delay_mean_sd, delay_sd,
                delay_sd_mean, delay_sd_sd, t, lp__, lp_accum__, pstream__);
      current_statement_begin__ = 644;
      truncation_lp(truncation_mean, truncation_sd, trunc_mean_mean,
                    trunc_mean_sd, trunc_sd_mean, trunc_sd_sd, lp__, lp_accum__,
                    pstream__);
      current_statement_begin__ = 646;
      if (as_bool(estimate_r)) {
        current_statement_begin__ = 648;
        rt_lp(log_R, initial_infections, initial_growth, bp_effects, bp_sd,
              bp_n, seeding_time, r_logmean, r_logsd, prior_infections,
              prior_growth, lp__, lp_accum__, pstream__);
        current_statement_begin__ = 651;
        generation_time_lp(gt_mean, gt_mean_mean, gt_mean_sd, gt_sd, gt_sd_mean,
                           gt_sd_sd, ot, lp__, lp_accum__, pstream__);
      }
      current_statement_begin__ = 654;
      if (as_bool(obs_scale)) {
        current_statement_begin__ = 655;
        lp_accum__.add(
            normal_log<propto__>(get_base1(frac_obs, 1, "frac_obs", 1),
                                 obs_scale_mean, obs_scale_sd));
        if (get_base1(frac_obs, 1, "frac_obs", 1) < 0)
          lp_accum__.add(-std::numeric_limits<double>::infinity());
        else
          lp_accum__.add(-normal_ccdf_log(0, obs_scale_mean, obs_scale_sd));
      }
      current_statement_begin__ = 658;
      report_lp(cases, obs_reports, rep_phi, 1, model_type, obs_weight, lp__,
                lp_accum__, pstream__);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, current_statement_begin__,
                                  prog_reader__());
  ...
  void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
    ...
    dimss__.push_back(dims__);
    dims__.resize(0);
    dims__.push_back(((primitive_value(estimate_r) &&
                       primitive_value(logical_gt(seeding_time, 1)))
                          ? 1
                          : 0));
    dimss__.push_back(dims__);
  ...
  void write_array(RNG& base_rng__, std::vector<double>& params_r__,
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> eta =
        in__.vector_constrain((fixed ? 0 : M));
    size_t eta_j_1_max__ = (fixed ? 0 : M);
    for (size_t j_1__ = 0; j_1__ < eta_j_1_max__; ++j_1__) {
      vars__.push_back(eta(j_1__));
    }
    Eigen::Matrix<double, Eigen::Dynamic, 1> log_R =
        in__.vector_constrain(estimate_r);
    size_t log_R_j_1_max__ = estimate_r;
    for (size_t j_1__ = 0; j_1__ < log_R_j_1_max__; ++j_1__) {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> day_of_week_simplex =
        in__.simplex_constrain((week_effect ? 7 : 1));
    size_t day_of_week_simplex_j_1_max__ = (week_effect ? 7 : 1);
    for (size_t j_1__ = 0; j_1__ < day_of_week_simplex_j_1_max__; ++j_1__) {
    ...
    try {
      ...
      validate_non_negative_index("gen_R",
                                  "(logical_gt(estimate_r, 0) ? 0 : ot_h )",
                                  (logical_gt(estimate_r, 0) ? 0 : ot_h));
      Eigen::Matrix<double, Eigen::Dynamic, 1> gen_R(
          (logical_gt(estimate_r, 0) ? 0 : ot_h));
      ...
      if (as_bool(estimate_r)) {
        ...
        stan::math::assign(
            r, R_to_growth(R, get_base1(gt_mean, 1, "gt_mean", 1),
                           get_base1(gt_sd, 1, "gt_sd", 1), pstream__));
      } else {
        {
          ...
          stan::math::assign(gt_mean_sample,
                             normal_rng(gt_mean_mean, gt_mean_sd, base_rng__));
          ...
          stan::math::assign(gt_sd_sample,
                             normal_rng(gt_sd_mean, gt_sd_sd, base_rng__));
          current_statement_begin__ = 674;
          stan::math::assign(
              gen_R,
              calculate_Rt(infections, seeding_time, gt_mean_sample,
                           gt_mean_sample, max_gt, rt_half_window, pstream__));
          current_statement_begin__ = 677;
          stan::math::assign(
              r, R_to_growth(gen_R, gt_mean_sample, gt_sd_sample, pstream__));
        }
      }
  ...
  std::string model_name() const { return "model_estimate_infections"; }
...
typedef model_estimate_infections_namespace::model_estimate_infections
    stan_model;
#ifndef USING_R
