...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(435, 6, "end", "data/observations.stan");
    reader.add_event(435, 13, "restart", "model_estimate_infections");
    reader.add_event(435, 13, "include", "data/delays.stan");
    reader.add_event(435, 0, "start", "data/delays.stan");
    reader.add_event(441, 6, "end", "data/delays.stan");
    reader.add_event(441, 14, "restart", "model_estimate_infections");
    reader.add_event(441, 14, "include", "data/gaussian_process.stan");
    reader.add_event(441, 0, "start", "data/gaussian_process.stan");
    reader.add_event(451, 10, "end", "data/gaussian_process.stan");
    reader.add_event(451, 15, "restart", "model_estimate_infections");
    reader.add_event(451, 15, "include", "data/generation_time.stan");
    reader.add_event(451, 0, "start", "data/generation_time.stan");
    reader.add_event(456, 5, "end", "data/generation_time.stan");
    reader.add_event(456, 16, "restart", "model_estimate_infections");
    reader.add_event(456, 16, "include", "data/rt.stan");
    reader.add_event(456, 0, "start", "data/rt.stan");
    reader.add_event(466, 10, "end", "data/rt.stan");
    reader.add_event(466, 17, "restart", "model_estimate_infections");
    reader.add_event(466, 17, "include", "data/observation_model.stan");
    reader.add_event(466, 0, "start", "data/observation_model.stan");
    reader.add_event(473, 7, "end", "data/observation_model.stan");
    reader.add_event(473, 18, "restart", "model_estimate_infections");
    reader.add_event(593, 136, "end", "model_estimate_infections");
    return reader;
}
