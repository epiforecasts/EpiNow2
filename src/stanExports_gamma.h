...
class model_gamma : public stan::model::model_base_crtp<model_gamma> {
 private:
  int N;
  vector_d low;
  vector_d up;
 ...
 public:
  model_gamma(stan::io::var_context& context__, std::ostream* pstream__ = 0)
      : model_base_crtp(0) {
    ctor_body(context__, 0, pstream__);
  }
  model_gamma(stan::io::var_context& context__, unsigned int random_seed__,
  ...
  void transform_inits(const stan::io::var_context& context__,
    ...
    if (!(context__.contains_r("alpha_raw")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable alpha_raw missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("alpha_raw");
    pos__ = 0U;
    context__.validate_dims("parameter initialization", "alpha_raw", "double",
                            context__.to_vec());
    double alpha_raw(0);
    ...
    try {
      ...
      stan::lang::rethrow_located(
          std::runtime_error(
              std::string("Error transforming variable alpha_raw: ") +
              e.what()),
          current_statement_begin__, prog_reader__());
    }
    current_statement_begin__ = 18;
    if (!(context__.contains_r("beta_raw")))
      stan::lang::rethrow_located(
          std::runtime_error(std::string("Variable beta_raw missing")),
          current_statement_begin__, prog_reader__());
    vals_r__ = context__.vals_r("beta_raw");
    pos__ = 0U;
    context__.validate_dims("parameter initialization", "beta_raw", "double",
                            context__.to_vec());
    double beta_raw(0);
  ...
  T__ log_prob(std::vector<T__>& params_r__, std::vector<int>& params_i__,
    ...
    try {
      ...
      if (stan::math::is_uninitialized(alpha)) {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error initializing variable alpha: ") +
                msg__.str()),
            current_statement_begin__, prog_reader__());
      }
      ...
      if (stan::math::is_uninitialized(beta)) {
        ...
        stan::lang::rethrow_located(
            std::runtime_error(
                std::string("Error initializing variable beta: ") +
                msg__.str()),
            current_statement_begin__, prog_reader__());
      }
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        lp_accum__.add(stan::math::log(
            (gamma_cdf(get_base1(up, i, "up", 1), alpha, beta) -
             gamma_cdf(get_base1(low, i, "low", 1), alpha, beta))));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, current_statement_begin__,
                                  prog_reader__());
  ...
  std::string model_name() const { return "model_gamma"; }
